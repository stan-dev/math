...
//                 }
                ...
                //             } else {
                //                 unstash 'MathSetup'
                //                 bat "echo CXX=${CLANG_CXX} -Werror > make/local"
...
//                 stage('Pull docker image l1') {
//                     agent { label 'triqs' }
//                     steps {
//                         script {
//                             sh "docker pull stanorg/ci:gpu"
//                         }
//                     }
//                 }
//
//                 stage('Pull docker image l2') {
//                     agent { label 'v100' }
//                     steps {
//                         script {
//                             sh "docker pull stanorg/ci:gpu"
...
//                         script {
//                             //sh "apt-get update -y"
//                             //sh "apt-get install ubuntu-drivers-common -y"
//                             //sh "ubuntu-drivers devices"
//                             //sh "sudo apt install nvidia-driver-460 nvidia-cuda-toolkit clinfo"
//                             sh "clinfo"
//
//                             //unstash 'MathSetup'
//                             //sh "echo CXX=${CLANG_CXX} -Werror > make/local"
