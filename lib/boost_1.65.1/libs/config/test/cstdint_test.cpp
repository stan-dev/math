...
//  Revision History
//   11 Sep 01  Adapted to work with macros defined in native stdint.h (John
//   Maddock) 12 Nov 00  Adapted to merged <boost/cstdint.hpp> 23 Sep 00  Added
//   INTXX_C constant macro support + int64_t support (John Maddock). 28 Jun 00
//   Initial version

//
// There are two ways to test this: in version 1, we include cstdint.hpp as the
// first include, which means we get decide whether __STDC_CONSTANT_MACROS is
// defined. In version two we include stdint.h with __STDC_CONSTANT_MACROS *NOT*
// defined first, and check that we still end up with compatible definitions for
// the INT#_C macros.
//
// This is version 1.
//
...
// We can't suppress this warning on the command line as not all GCC versions
// support -Wno-type-limits :
