...
const char* module_docstring
    = "The boost.mpi module contains Python wrappers for Boost.MPI.\n"
      ...
      "all collectives can operate on any serializable or picklable data "
      "type.\n"
      "\n"
      "IMPORTANT MODULE DATA\n"
      "  any_source       This constant may be used for the source parameter "
      "of\n"
      ...
      "\n"
      "  collectives_tag  Returns the reserved tag value used by the "
      "Boost.MPI\n"
      "                   implementation for collective operations. Although\n"
      "                   users are not permitted to use this tag to send or\n"
      "                   receive messages with this tag, it may be useful "
      "when\n"
      "                   monitoring communication patterns.\n"
      "\n"
      "  host_rank        If there is a host process, this is the rank of "
      "that\n"
      "                   that process. Otherwise, this value will be None. "
      "MPI\n"
      "                   does not define the meaning of a \"host\" process: \n"
      "                   consult the documentation for your MPI "
      "implementation.\n"
      "\n"
      "  io_rank          The rank of a process that can perform input/output\n"
      "                   via the standard facilities. If every process can\n"
      "                   perform I/O using the standard facilities, this "
      "value\n"
      ...
      "                   parameter of send/receive operations. This value "
      "will\n"
      ...
      "                   of the name is unspecified, but may be documented "
      "by\n"
      "                   the underlying MPI implementation.\n"
      "\n"
      "  rank             The rank of this process in the \"world\" "
      "communicator.\n"
      "\n"
      "  size             The number of processes in the \"world\" "
      "communicator.\n"
      "                   that process. Otherwise, this value will be None. "
      "MPI\n"
      "                   does not define the meaning of a \"host\" process: \n"
      ...
      "                   communicators will be derived. This is the "
      "equivalent\n"
      "                   of MPI_COMM_WORLD.\n"
      "\n"
      "TRANSMITTING USER-DEFINED DATA\n"
      "  Boost.MPI can transmit user-defined data in several different ways.\n"
      "  Most importantly, it can transmit arbitrary Python objects by "
      "pickling\n"
      ...
      "  interface. Any C++ type that provides (de-)serialization routines "
      "that\n"
      "  meet the requirements of the Boost.Serialization library is eligible\n"
      "  for this optimization, but the type must be registered in advance. "
      "To\n"
      ...
      "scan,\n"
      "  broadcast, etc.) for any type of data that can be transmitted with "
      "the\n"
      "  point-to-point communication operations. For the MPI collectives "
      "that\n"
      "  require a user-specified operation (e.g., reduce and scan), the\n"
      "  operation can be an arbitrary Python function. For instance, one "
      "could\n"
      ...
      "    broadcast     Broadcast data from one process to all other "
      "processes.\n"
      ...
      "    scatter       Scatter the values stored at the root to all "
      "processes.\n"
      "\n"
      "SKELETON/CONTENT MECHANISM\n"
      "  Boost.MPI provides a skeleton/content mechanism that allows the\n"
      "  transfer of large data structures to be split into two separate "
      "stages,\n"
      "  with the `skeleton' (or, `shape') of the data structure sent first "
      "and\n"
      "  the content (or, `data') of the data structure sent later, "
      "potentially\n"
      ...
      "  which stores a newly-created instance of your data structure with "
      "the\n"
      ...
      "  that the receiver also specifies get_content(my_data_structure) in "
      "its\n"
      "  call to receive:\n\n"
      "    if mpi.rank == 0:\n"
      ...
      "  Boost.MPI is a C++ library whose facilities have been exposed to "
      "Python\n"
      "  via the Boost.Python library. Since the Boost.MPI Python bindings "
      "are\n"
      "  build directly on top of the C++ library, and nearly every feature "
      "of\n"
      "  C++ library is available in Python, hybrid C++/Python programs using\n"
      "  Boost.MPI can interact, e.g., sending a value from Python but "
      "receiving\n"
      "  that value in C++ (or vice versa). However, doing so requires some\n"
      "  care. Because Python objects are dynamically typed, Boost.MPI "
      "transfers\n"
      "  type information along with the serialized form of the object, so "
      "that\n"
      "  the object can be received even when its type is not known. This\n"
      "  mechanism differs from its C++ counterpart, where the static types "
      "of\n"
...
const char* nonblocking_test_any_docstring
    = "Tests if any of the given requests have been completed, but does not "
      "wait\n"
      "for completion. It provides functionality equivalent to MPI_Testany.\n"
      "\n"
      "requests must be a RequestList instance.\n"
      "\n"
      "Returns a triple (value, status, index) like wait_any or None if no "
      "request\n"
      "is complete.\n";
...
const char* nonblocking_wait_all_docstring
    = "Waits until all of the given requests have been completed. It provides\n"
      ...
      "its arguments. The calls occur in the order given by the `requests' "
      "list.\n";
...
const char* nonblocking_test_some_docstring
    = "Tests to see if any of the given requests has completed. It completes\n"
      "all of the requests it can, partitioning the input sequence into "
      "pending\n"
...
const char* broadcast_docstring
    = "broadcast is a collective algorithm that transfers a value from an\n"
      ...
      "root. broadcast() returns the same broadcasted value to every "
      "process.\n";
...
const char* communicator_recv_docstring
    = "This routine blocks until it receives a message from the process\n"
      ...
      "\n"
      "When receiving the content of a data type that has been sent "
      "separately\n"
...
const char* communicator_irecv_docstring
    = "This routine initiates a non-blocking receive from the process\n"
      ...
      "that has been sent separately from its skeleton, user code must "
      "provide\n"
...
const char* get_content_docstring
    = "The get_content function retrieves the content for its object "
      "parameter,\n"
