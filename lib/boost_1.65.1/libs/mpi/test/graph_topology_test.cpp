...
int test_main(int argc, char* argv[]) {
  ...
  sorted_erdos_renyi_iterator<minstd_rand, Graph> first(gen, world.size(),
                                                        prob),
      last;
  ...
  iterator_property_map<int*, GraphVertexIndexMap> graph_alt_index(
      &graph_alt_index_vec[0], get(vertex_index, graph));
