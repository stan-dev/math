...
struct life_support {
  PyObject_HEAD PyObject* patient;
};

extern "C" {
static void life_support_dealloc(PyObject* self) {
  Py_XDECREF(((life_support*)self)->patient);
  self->ob_type->tp_free(self);
}

static PyObject* life_support_call(PyObject* self, PyObject* arg,
                                   PyObject* /*kw*/) {
...
PyTypeObject life_support_type = {
    ...
    0,  /* tp_clear */
    0,  /* tp_richcompare */
    0,  // offsetof(PyLife_SupportObject, func_weakreflist), /*
        // tp_weaklistoffset */
    0,  /* tp_iter */
    0,  /* tp_iternext */
    0,  /* tp_methods */
