...
BOOST_ARCHIVE_DECL
unsigned int archive_exception::append(unsigned int l, const char* a) {
...
BOOST_ARCHIVE_DECL
archive_exception::archive_exception(exception_code c, const char* e1,
                                     const char* e2) BOOST_NOEXCEPT : code(c) {
...
BOOST_ARCHIVE_DECL
archive_exception::archive_exception(archive_exception const& oth)
    BOOST_NOEXCEPT : std::exception(oth),
                     code(oth.code) {
...
BOOST_ARCHIVE_DECL const char* archive_exception::what() const
    BOOST_NOEXCEPT_OR_NOTHROW {
  return m_buffer;
}

BOOST_ARCHIVE_DECL
archive_exception::archive_exception() BOOST_NOEXCEPT : code(no_exception) {}
