...
struct type_compare {
  bool operator()(const extended_type_info_typeid_0 *lhs,
                  const extended_type_info_typeid_0 *rhs) const {
...
BOOST_SERIALIZATION_DECL bool extended_type_info_typeid_0::is_less_than(
...
BOOST_SERIALIZATION_DECL bool extended_type_info_typeid_0::is_equal(
    const boost::serialization::extended_type_info &rhs) const {
  return
      // note: std::type_info == operator returns an int !!!
      // the following permits conversion to bool without a warning.
      !(*m_ti != *(static_cast<const extended_type_info_typeid_0 &>(rhs).m_ti));
}

BOOST_SERIALIZATION_DECL
extended_type_info_typeid_0::extended_type_info_typeid_0(const char *key)
    : extended_type_info(EXTENDED_TYPE_INFO_TYPE_KEY, key), m_ti(NULL) {}

BOOST_SERIALIZATION_DECL
extended_type_info_typeid_0::~extended_type_info_typeid_0() {}

BOOST_SERIALIZATION_DECL void extended_type_info_typeid_0::type_register(
...
class extended_type_info_typeid_arg : public extended_type_info_typeid_0 {
 ...
 public:
  ...
  ~extended_type_info_typeid_arg() { m_ti = NULL; }
};
