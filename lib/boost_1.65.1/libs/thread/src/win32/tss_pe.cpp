...
extern "C" {
PIMAGE_TLS_CALLBACK __crt_xl_tls_callback__ __attribute__((section(".CRT$XLB")))
= on_tls_callback;
}
#else
extern "C" {

void (*after_ctors)() __attribute__((section(".ctors")))
= boost::on_process_enter;
void (*before_dtors)() __attribute__((section(".dtors")))
= boost::on_thread_exit;
void (*after_dtors)() __attribute__((section(".dtors.zzz")))
...
// _pRawDllMainOrig can be defined by including
// boost/thread/win32/mfc_thread_init.hpp into your dll; it ensures that
// MFC-Dll-initialization will be done properly The following code is adapted
// from the MFC-Dll-init code
/*
...
extern BOOL(WINAPI* const _pDefaultRawDllMainOrig)(HANDLE, DWORD, LPVOID)
    = NULL;
#if defined(_M_IX86)
#pragma comment(linker, \
                "/alternatename:__pRawDllMainOrig=__pDefaultRawDllMainOrig")
#elif defined(_M_X64) || defined(_M_ARM)
#pragma comment(linker, \
                "/alternatename:_pRawDllMainOrig=_pDefaultRawDllMainOrig")
