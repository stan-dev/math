...
TEST(D2sTest, SmallIntegers) {
  ASSERT_STREQ("9.007199254740991E15", d2s(9007199254740991.0)); // 2^53-1
  ASSERT_STREQ("9.007199254740992E15", d2s(9007199254740992.0)); // 2^53

  ASSERT_STREQ("1E0", d2s(1.0e+0));
  ASSERT_STREQ("1.2E1", d2s(1.2e+1));
  ASSERT_STREQ("1.23E2", d2s(1.23e+2));
  ASSERT_STREQ("1.234E3", d2s(1.234e+3));
  ASSERT_STREQ("1.2345E4", d2s(1.2345e+4));
  ASSERT_STREQ("1.23456E5", d2s(1.23456e+5));
  ASSERT_STREQ("1.234567E6", d2s(1.234567e+6));
  ASSERT_STREQ("1.2345678E7", d2s(1.2345678e+7));
  ASSERT_STREQ("1.23456789E8", d2s(1.23456789e+8));
  ASSERT_STREQ("1.23456789E9", d2s(1.23456789e+9));
  ASSERT_STREQ("1.234567895E9", d2s(1.234567895e+9));
  ASSERT_STREQ("1.2345678901E10", d2s(1.2345678901e+10));
  ASSERT_STREQ("1.23456789012E11", d2s(1.23456789012e+11));
  ASSERT_STREQ("1.234567890123E12", d2s(1.234567890123e+12));
  ASSERT_STREQ("1.2345678901234E13", d2s(1.2345678901234e+13));
  ASSERT_STREQ("1.23456789012345E14", d2s(1.23456789012345e+14));
  ASSERT_STREQ("1.234567890123456E15", d2s(1.234567890123456e+15));

  // 10^i
  ASSERT_STREQ("1E0", d2s(1.0e+0));
  ASSERT_STREQ("1E1", d2s(1.0e+1));
  ASSERT_STREQ("1E2", d2s(1.0e+2));
  ASSERT_STREQ("1E3", d2s(1.0e+3));
  ASSERT_STREQ("1E4", d2s(1.0e+4));
  ASSERT_STREQ("1E5", d2s(1.0e+5));
  ASSERT_STREQ("1E6", d2s(1.0e+6));
  ASSERT_STREQ("1E7", d2s(1.0e+7));
  ASSERT_STREQ("1E8", d2s(1.0e+8));
  ASSERT_STREQ("1E9", d2s(1.0e+9));
  ASSERT_STREQ("1E10", d2s(1.0e+10));
  ASSERT_STREQ("1E11", d2s(1.0e+11));
  ASSERT_STREQ("1E12", d2s(1.0e+12));
  ASSERT_STREQ("1E13", d2s(1.0e+13));
  ASSERT_STREQ("1E14", d2s(1.0e+14));
  ASSERT_STREQ("1E15", d2s(1.0e+15));

  // 10^15 + 10^i
  ASSERT_STREQ("1.000000000000001E15", d2s(1.0e+15 + 1.0e+0));
  ASSERT_STREQ("1.00000000000001E15", d2s(1.0e+15 + 1.0e+1));
  ASSERT_STREQ("1.0000000000001E15", d2s(1.0e+15 + 1.0e+2));
  ASSERT_STREQ("1.000000000001E15", d2s(1.0e+15 + 1.0e+3));
  ASSERT_STREQ("1.00000000001E15", d2s(1.0e+15 + 1.0e+4));
  ASSERT_STREQ("1.0000000001E15", d2s(1.0e+15 + 1.0e+5));
  ASSERT_STREQ("1.000000001E15", d2s(1.0e+15 + 1.0e+6));
  ASSERT_STREQ("1.00000001E15", d2s(1.0e+15 + 1.0e+7));
  ASSERT_STREQ("1.0000001E15", d2s(1.0e+15 + 1.0e+8));
  ASSERT_STREQ("1.000001E15", d2s(1.0e+15 + 1.0e+9));
  ASSERT_STREQ("1.00001E15", d2s(1.0e+15 + 1.0e+10));
  ASSERT_STREQ("1.0001E15", d2s(1.0e+15 + 1.0e+11));
  ASSERT_STREQ("1.001E15", d2s(1.0e+15 + 1.0e+12));
  ASSERT_STREQ("1.01E15", d2s(1.0e+15 + 1.0e+13));
  ASSERT_STREQ("1.1E15", d2s(1.0e+15 + 1.0e+14));

  // Largest power of 2 <= 10^(i+1)
  ASSERT_STREQ("8E0", d2s(8.0));
  ASSERT_STREQ("6.4E1", d2s(64.0));
  ASSERT_STREQ("5.12E2", d2s(512.0));
  ASSERT_STREQ("8.192E3", d2s(8192.0));
  ASSERT_STREQ("6.5536E4", d2s(65536.0));
  ASSERT_STREQ("5.24288E5", d2s(524288.0));
  ASSERT_STREQ("8.388608E6", d2s(8388608.0));
  ASSERT_STREQ("6.7108864E7", d2s(67108864.0));
  ASSERT_STREQ("5.36870912E8", d2s(536870912.0));
  ASSERT_STREQ("8.589934592E9", d2s(8589934592.0));
  ASSERT_STREQ("6.8719476736E10", d2s(68719476736.0));
  ASSERT_STREQ("5.49755813888E11", d2s(549755813888.0));
  ASSERT_STREQ("8.796093022208E12", d2s(8796093022208.0));
  ASSERT_STREQ("7.0368744177664E13", d2s(70368744177664.0));
  ASSERT_STREQ("5.62949953421312E14", d2s(562949953421312.0));
  ASSERT_STREQ("9.007199254740992E15", d2s(9007199254740992.0));

  // 1000 * (Largest power of 2 <= 10^(i+1))
  ASSERT_STREQ("8E3", d2s(8.0e+3));
  ASSERT_STREQ("6.4E4", d2s(64.0e+3));
  ASSERT_STREQ("5.12E5", d2s(512.0e+3));
  ASSERT_STREQ("8.192E6", d2s(8192.0e+3));
  ASSERT_STREQ("6.5536E7", d2s(65536.0e+3));
  ASSERT_STREQ("5.24288E8", d2s(524288.0e+3));
  ASSERT_STREQ("8.388608E9", d2s(8388608.0e+3));
  ASSERT_STREQ("6.7108864E10", d2s(67108864.0e+3));
  ASSERT_STREQ("5.36870912E11", d2s(536870912.0e+3));
  ASSERT_STREQ("8.589934592E12", d2s(8589934592.0e+3));
  ASSERT_STREQ("6.8719476736E13", d2s(68719476736.0e+3));
  ASSERT_STREQ("5.49755813888E14", d2s(549755813888.0e+3));
  ASSERT_STREQ("8.796093022208E15", d2s(8796093022208.0e+3));
}
