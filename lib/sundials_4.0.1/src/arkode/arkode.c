...
void arkPrintMem(ARKodeMem ark_mem, FILE *outfile)
{
  ...
  STAN_SUNDIALS_FPRINTF(outfile, "ark_itol = %i\n", ark_mem->itol);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_ritol = %i\n", ark_mem->ritol);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_dense_q = %i\n", ark_mem->dense_q);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_mxhnil = %i\n", ark_mem->mxhnil);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_mxstep = %li\n", ark_mem->mxstep);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_lrw1 = %li\n", (long int) ark_mem->lrw1);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_liw1 = %li\n", (long int) ark_mem->liw1);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_lrw = %li\n", (long int) ark_mem->lrw);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_liw = %li\n", (long int) ark_mem->liw);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_user_efun = %i\n", ark_mem->user_efun);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tstopset = %i\n", ark_mem->tstopset);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tstop = %" RSYM"\n", ark_mem->tstop);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_report = %i\n", ark_mem->report);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_VabstolMallocDone = %i\n", ark_mem->VabstolMallocDone);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_MallocDone = %i\n", ark_mem->MallocDone);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_resized = %i\n", ark_mem->resized);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_firststage = %i\n", ark_mem->firststage);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_uround = %" RSYM"\n", ark_mem->uround);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_reltol = %" RSYM"\n", ark_mem->reltol);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_Sabstol = %" RSYM"\n", ark_mem->Sabstol);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_fixedstep = %i\n", ark_mem->fixedstep);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tolsf = %" RSYM"\n", ark_mem->tolsf);

  /* output counters */
  STAN_SUNDIALS_FPRINTF(outfile, "ark_nhnil = %i\n", ark_mem->nhnil);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_nst = %li\n", ark_mem->nst);

  /* output time-stepping values */
  STAN_SUNDIALS_FPRINTF(outfile, "ark_hin = %" RSYM"\n", ark_mem->hin);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_h = %" RSYM"\n", ark_mem->h);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_hprime = %" RSYM"\n", ark_mem->hprime);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_next_h = %" RSYM"\n", ark_mem->next_h);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_eta = %" RSYM"\n", ark_mem->eta);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tcur = %" RSYM"\n", ark_mem->tcur);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tretlast = %" RSYM"\n", ark_mem->tretlast);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_hmin = %" RSYM"\n", ark_mem->hmin);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_hmax_inv = %" RSYM"\n", ark_mem->hmax_inv);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_h0u = %" RSYM"\n", ark_mem->h0u);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_tn = %" RSYM"\n", ark_mem->tn);
  STAN_SUNDIALS_FPRINTF(outfile, "ark_hold = %" RSYM"\n", ark_mem->hold);
