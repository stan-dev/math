...
void ARKodeButcherTable_Write(ARKodeButcherTable B, FILE *outfile)
{
  int i, j;
  if (B == NULL) return;
  STAN_SUNDIALS_FPRINTF(outfile, "  A = \n");
  for (i=0; i<B->stages; i++) {
    STAN_SUNDIALS_FPRINTF(outfile, "      ");
    for (j=0; j<B->stages; j++)
      STAN_SUNDIALS_FPRINTF(outfile, "%"RSYM"  ", B->A[i][j]);
    STAN_SUNDIALS_FPRINTF(outfile, "\n");
  }
  STAN_SUNDIALS_FPRINTF(outfile, "  c = ");
  for (i=0; i<B->stages; i++)
    STAN_SUNDIALS_FPRINTF(outfile, "%"RSYM"  ", B->c[i]);
  STAN_SUNDIALS_FPRINTF(outfile, "\n");
  STAN_SUNDIALS_FPRINTF(outfile, "  b = ");
  for (i=0; i<B->stages; i++)
    STAN_SUNDIALS_FPRINTF(outfile, "%"RSYM"  ", B->b[i]);
  STAN_SUNDIALS_FPRINTF(outfile, "\n");
  STAN_SUNDIALS_FPRINTF(outfile, "  d = ");
  for (i=0; i<B->stages; i++)
    STAN_SUNDIALS_FPRINTF(outfile, "%"RSYM"  ", B->d[i]);
  STAN_SUNDIALS_FPRINTF(outfile, "\n");
}
...
int ARKodeButcherTable_CheckOrder(ARKodeButcherTable B, int *q, int *p, FILE *outfile)
{
  ...
  /* check method order */
  if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"ARKodeButcherTable_CheckOrder:\n");
  ...
  if (__rowsum(A, c, s)) {
    ...
    (*q) = -1;
    if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails row sum condition\n");
  }
  /*    order 1 condition */
  if ((*q) == 0) {
    if (__order1(b, s)) {
      ...
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 1 condition\n");
    }
  }
  /*    order 2 condition */
  if ((*q) == 1) {
    if (__order2(b, c, s)) {
      ...
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 2 condition\n");
    }
  }
  /*    order 3 conditions */
  if ((*q) == 2) {
    ...
    if (!__order3a(b, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 3 condition A\n");
    }
    if (!__order3b(b, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 3 condition B\n");
    }
    if (alltrue)  (*q) = 3;
  }
  /*    order 4 conditions */
  if ((*q) == 3) {
    ...
    if (!__order4a(b, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 condition A\n");
    }
    if (!__order4b(b, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 condition B\n");
    }
    if (!__order4c(b, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 condition C\n");
    }
    if (!__order4d(b, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 condition D\n");
    }
    if (alltrue)  (*q) = 4;
  }
  /*    order 5 conditions */
  if ((*q) == 4) {
    ...
    if (!__order5a(b, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition A\n");
    }
    if (!__order5b(b, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition B\n");
    }
    if (!__order5c(b, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition C\n");
    }
    if (!__order5d(b, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition D\n");
    }
    if (!__order5e(b, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition E\n");
    }
    if (!__order5f(b, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition F\n");
    }
    if (!__order5g(b, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition G\n");
    }
    if (!__order5h(b, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition H\n");
    }
    if (!__order5i(b, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 condition I\n");
    }
    if (alltrue)  (*q) = 5;
  }
  /*    order 6 conditions */
  if ((*q) == 5) {
    ...
    if (!__order6a(b, c, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition A\n");
    }
    if (!__order6b(b, c, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition B\n");
    }
    if (!__order6c(b, c, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition C\n");
    }
    if (!__order6d(b, c, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition D\n");
    }
    if (!__order6e(b, c, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition E\n");
    }
    if (!__order6f(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition F\n");
    }
    if (!__order6g(b, c, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition G\n");
    }
    if (!__order6h(b, c, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition H\n");
    }
    if (!__order6i(b, c, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition I\n");
    }
    if (!__order6j(b, c, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition J\n");
    }
    if (!__order6k(b, A, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition K\n");
    }
    if (!__order6l(b, A, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition L\n");
    }
    if (!__order6m(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition M\n");
    }
    if (!__order6n(b, A, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition N\n");
    }
    if (!__order6o(b, A, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition O\n");
    }
    if (!__order6p(b, A, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition P\n");
    }
    if (!__order6q(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition Q\n");
    }
    if (!__order6r(b, A, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition R\n");
    }
    if (!__order6s(b, A, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 condition S\n");
    }
    if (alltrue)  (*q) = 6;
  }
  /*    higher order conditions (via simplifying assumptions) */
  if ((*q) == 6) {
    if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method order >= 6; reverting to simplifying assumptions\n");
    q_SA = __ButcherSimplifyingAssumptions(A, b, c, s);
    (*q) = SUNMAX((*q), q_SA);
    if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method order = %i\n", (*q));
  }

  /* check embedding order */
  if (d) {
    if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"\n");
    b = d;
    ...
    if (__rowsum(A, c, s)) {
      ...
      (*p) = -1;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails row sum condition\n");
    }
    /*    order 1 condition */
    if ((*p) == 0) {
      if (__order1(b, s)) {
        ...
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 1 condition\n");
      }
    }
    /*    order 2 condition */
    if ((*p) == 1) {
      if (__order2(b, c, s)) {
        ...
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 2 condition\n");
      }
    }
    /*    order 3 conditions */
    if ((*p) == 2) {
      ...
      if (!__order3a(b, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 3 condition A\n");
      }
      if (!__order3b(b, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 3 condition B\n");
      }
      if (alltrue)  (*p) = 3;
    }
    /*    order 4 conditions */
    if ((*p) == 3) {
      ...
      if (!__order4a(b, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 condition A\n");
      }
      if (!__order4b(b, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 condition B\n");
      }
      if (!__order4c(b, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 condition C\n");
      }
      if (!__order4d(b, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 condition D\n");
      }
      if (alltrue)  (*p) = 4;
    }
    /*    order 5 conditions */
    if ((*p) == 4) {
      ...
      if (!__order5a(b, c, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition A\n");
      }
      if (!__order5b(b, c, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition B\n");
      }
      if (!__order5c(b, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition C\n");
      }
      if (!__order5d(b, c, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition D\n");
      }
      if (!__order5e(b, A, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition E\n");
      }
      if (!__order5f(b, c, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition F\n");
      }
      if (!__order5g(b, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition G\n");
      }
      if (!__order5h(b, A, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition H\n");
      }
      if (!__order5i(b, A, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 condition I\n");
      }
      if (alltrue)  (*p) = 5;
    }
    /*    order 6 conditions */
    if ((*p) == 5) {
      ...
      if (!__order6a(b, c, c, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition A\n");
      }
      if (!__order6b(b, c, c, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition B\n");
      }
      if (!__order6c(b, c, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition C\n");
      }
      if (!__order6d(b, c, c, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition D\n");
      }
      if (!__order6e(b, c, c, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition E\n");
      }
      if (!__order6f(b, A, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition F\n");
      }
      if (!__order6g(b, c, A, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition G\n");
      }
      if (!__order6h(b, c, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition H\n");
      }
      if (!__order6i(b, c, A, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition I\n");
      }
      if (!__order6j(b, c, A, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition J\n");
      }
      if (!__order6k(b, A, c, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition K\n");
      }
      if (!__order6l(b, A, c, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition L\n");
      }
      if (!__order6m(b, A, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition M\n");
      }
      if (!__order6n(b, A, c, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition N\n");
      }
      if (!__order6o(b, A, c, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition O\n");
      }
      if (!__order6p(b, A, A, c, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition P\n");
      }
      if (!__order6q(b, A, A, c, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition Q\n");
      }
      if (!__order6r(b, A, A, A, c, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition R\n");
      }
      if (!__order6s(b, A, A, A, A, c, s)) {
        alltrue = SUNFALSE;
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 condition S\n");
      }
      if (alltrue)  (*p) = 6;
    }
    /*    higher order conditions (via simplifying assumptions) */
    if ((*p) == 6) {
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding order >= 6; reverting to simplifying assumptions\n");
      p_SA = __ButcherSimplifyingAssumptions(A, b, c, s);
      (*p) = SUNMAX((*p), p_SA);
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding order = %i\n", (*p));
    }
  }
                                     ...
                                     int *q, int *p, FILE *outfile)
{
  ...
  /* check method order */
  if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"ARKodeButcherTable_CheckARKOrder:\n");
  ...
  if (__rowsum(A[0], c[0], s) && __rowsum(A[1], c[1], s)) {
    ...
    (*q) = -1;
    if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails row sum conditions\n");
  }
  /*    order 1 conditions */
  if ((*q) == 0) {
    if (__order1(b[0], s) && __order1(b[1], s)) {
      ...
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 1 conditions\n");
    }
  }
  /*    order 2 conditions */
  if ((*q) == 1) {
    ...
    if (alltrue) {
      ...
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 2 conditions\n");
    }
  }
  /*    order 3 conditions */
  if ((*q) == 2) {
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 3 conditions A\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          alltrue = (alltrue && __order3b(b[i], A[j], c[k], s));
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 3 conditions B\n");
    if (alltrue)  (*q) = 3;
  }
  /*    order 4 conditions */
  if ((*q) == 3) {
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 conditions A\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
            alltrue = (alltrue && __order4b(b[i], c[j], A[k], c[l], s));
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 conditions B\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
            alltrue = (alltrue && __order4c(b[i], A[j], c[k], c[l], s));
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 conditions C\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
            alltrue = (alltrue && __order4d(b[i], A[j], A[k], c[l], s));
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 4 conditions D\n");
    if (alltrue)  (*q) = 4;
  }
  /*    order 5 conditions */
  if ((*q) == 4) {
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions A\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions B\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions C\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions D\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions E\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions F\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions G\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions H\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 5 conditions I\n");
    if (alltrue)  (*q) = 5;
  }
  /*    order 6 conditions */
  if ((*q) == 5) {
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions A\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions B\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions C\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions D\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions E\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions F\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions G\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions H\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions I\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions J\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions K\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions L\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions M\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions N\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions O\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions P\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions Q\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions R\n");
    for (i=0; i<2; i++)
      for (j=0; j<2; j++)
        for (k=0; k<2; k++)
          for (l=0; l<2; l++)
    ...
    if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  method fails order 6 conditions S\n");
    if (alltrue)  (*q) = 6;
  }
  ...
  if (d[0] && d[1]) {
    ...
    if (__rowsum(A[0], c[0], s) && __rowsum(A[1], c[1], s)) {
      ...
      (*p) = -1;
      if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails row sum conditions\n");
    }
    /*    order 1 conditions */
    if ((*p) == 0) {
      if (__order1(d[0], s) && __order1(d[1], s)) {
        ...
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 1 conditions\n");
      }
    }
    /*    order 2 conditions */
    if ((*p) == 1) {
      ...
      if (alltrue) {
        ...
        if (outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 2 conditions\n");
      }
    }
    /*    order 3 conditions */
    if ((*p) == 2) {
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 3 conditions A\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            alltrue = (alltrue && __order3b(d[i], A[j], c[k], s));
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 3 conditions B\n");
      if (alltrue)  (*p) = 3;
    }
    /*    order 4 conditions */
    if ((*p) == 3) {
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 conditions A\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
              alltrue = (alltrue && __order4b(d[i], c[j], A[k], c[l], s));
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 conditions B\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
              alltrue = (alltrue && __order4c(d[i], A[j], c[k], c[l], s));
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 conditions C\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
              alltrue = (alltrue && __order4d(d[i], A[j], A[k], c[l], s));
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 4 conditions D\n");
      if (alltrue)  (*p) = 4;
    }
    /*    order 5 conditions */
    if ((*p) == 4) {
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions A\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions B\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions C\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions D\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions E\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions F\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions G\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions H\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 5 conditions I\n");
      if (alltrue)  (*p) = 5;
    }
    /*    order 6 conditions */
    if ((*p) == 5) {
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions A\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions B\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions C\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions D\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions E\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions F\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions G\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions H\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions I\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions J\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions K\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions L\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions M\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions N\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions O\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions P\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions Q\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions R\n");
      for (i=0; i<2; i++)
        for (j=0; j<2; j++)
          for (k=0; k<2; k++)
            for (l=0; l<2; l++)
      ...
      if ( (!alltrue) && outfile)  STAN_SUNDIALS_FPRINTF(outfile,"  embedding fails order 6 conditions S\n");
      if (alltrue)  (*p) = 6;
    }
  }
