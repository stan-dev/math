...
SWIGEXPORT N_Vector _wrap_FN_VNew_OpenMP(int64_t const *farg1, int const *farg2) {
  N_Vector fresult ;
  sunindextype arg1 ;
  int arg2 ;
  N_Vector result;
  ...
  arg2 = (int)(*farg2);
  result = (N_Vector)N_VNew_OpenMP(arg1,arg2);
  fresult = result;
  return fresult;
}


SWIGEXPORT N_Vector _wrap_FN_VNewEmpty_OpenMP(int64_t const *farg1, int const *farg2) {
  N_Vector fresult ;
  sunindextype arg1 ;
  int arg2 ;
  N_Vector result;
  ...
  arg1 = (sunindextype)(*farg1);
  arg2 = (int)(*farg2);
  result = (N_Vector)N_VNewEmpty_OpenMP(arg1,arg2);
  fresult = result;
  return fresult;
}


SWIGEXPORT N_Vector _wrap_FN_VMake_OpenMP(int64_t const *farg1, double *farg2, int const *farg3) {
  N_Vector fresult ;
  sunindextype arg1 ;
  ...
  arg2 = (realtype *)(farg2);
  arg3 = (int)(*farg3);
  result = (N_Vector)N_VMake_OpenMP(arg1,arg2,arg3);
  fresult = result;
  return fresult;
}
