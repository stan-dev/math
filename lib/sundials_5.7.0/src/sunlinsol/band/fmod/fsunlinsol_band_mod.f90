...
function swigc_FSUNBandLinearSolver(farg1, farg2) &
bind(C, name="_wrap_FSUNBandLinearSolver") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
farg1 = c_loc(y)
farg2 = c_loc(a)
fresult = swigc_FSUNLinSol_Band(farg1, farg2)
...
farg1 = c_loc(y)
farg2 = c_loc(a)
fresult = swigc_FSUNBandLinearSolver(farg1, farg2)
call c_f_pointer(fresult, swig_result)
end function
