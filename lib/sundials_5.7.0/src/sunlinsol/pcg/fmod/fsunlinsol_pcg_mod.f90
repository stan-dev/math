...
interface
function swigc_FSUNLinSol_PCG(farg1, farg2, farg3) &
...
function swigc_FSUNPCG(farg1, farg2, farg3) &
bind(C, name="_wrap_FSUNPCG") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
integer(C_INT), intent(in) :: farg2
...
function swigc_FSUNPCGSetPrecType(farg1, farg2) &
bind(C, name="_wrap_FSUNPCGSetPrecType") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
integer(C_INT), intent(in) :: farg2
...
function swigc_FSUNPCGSetMaxl(farg1, farg2) &
bind(C, name="_wrap_FSUNPCGSetMaxl") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
integer(C_INT), intent(in) :: farg2
...
farg2 = pretype
farg3 = maxl
fresult = swigc_FSUNLinSol_PCG(farg1, farg2, farg3)
...
farg2 = pretype
farg3 = maxl
fresult = swigc_FSUNPCG(farg1, farg2, farg3)
call c_f_pointer(fresult, swig_result)
end function
...
farg1 = c_loc(s)
farg2 = pretype
fresult = swigc_FSUNPCGSetPrecType(farg1, farg2)
swig_result = fresult
end function
...
farg1 = c_loc(s)
farg2 = maxl
fresult = swigc_FSUNPCGSetMaxl(farg1, farg2)
swig_result = fresult
end function
