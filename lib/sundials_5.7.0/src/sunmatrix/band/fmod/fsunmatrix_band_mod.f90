...
interface
function swigc_FSUNBandMatrix(farg1, farg2, farg3) &
...
function swigc_FSUNBandMatrixStorage(farg1, farg2, farg3, farg4) &
...
farg2 = mu
farg3 = ml
fresult = swigc_FSUNBandMatrix(farg1, farg2, farg3)
...
farg3 = ml
farg4 = smu
fresult = swigc_FSUNBandMatrixStorage(farg1, farg2, farg3, farg4)
call c_f_pointer(fresult, swig_result)
end function
