...
SWIGEXPORT SUNNonlinearSolver _wrap_FSUNNonlinSol_Newton(N_Vector farg1) {
  SUNNonlinearSolver fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  SUNNonlinearSolver result;
  
  arg1 = (N_Vector)(farg1);
  result = (SUNNonlinearSolver)SUNNonlinSol_Newton(arg1);
  fresult = result;
  return fresult;
}


SWIGEXPORT SUNNonlinearSolver _wrap_FSUNNonlinSol_NewtonSens(int const *farg1, N_Vector farg2) {
  SUNNonlinearSolver fresult ;
  int arg1 ;
  ...
  arg1 = (int)(*farg1);
  arg2 = (N_Vector)(farg2);
  result = (SUNNonlinearSolver)SUNNonlinSol_NewtonSens(arg1,arg2);
  fresult = result;
  return fresult;
}
