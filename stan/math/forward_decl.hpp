...
template <typename VecVar, require_std_vector_vt<stan::is_var, VecVar> *,
          typename... Pargs>
inline size_t count_vars_impl(size_t count, VecVar &&x, Pargs &&...args);

template <typename VecContainer,
          require_std_vector_st<stan::is_var, VecContainer> *,
          require_std_vector_vt<stan::is_container, VecContainer> *,
          typename... Pargs>
inline size_t count_vars_impl(size_t count, VecContainer &&x, Pargs &&...args);

template <typename EigT, require_eigen_vt<stan::is_var, EigT> *,
          typename... Pargs>
inline size_t count_vars_impl(size_t count, EigT &&x, Pargs &&...args);

template <typename... Pargs>
inline size_t count_vars_impl(size_t count, const stan::math::var &x,
                              Pargs &&...args);
...
template <typename T1, typename T2, typename T3, typename T4,
          require_all_matrix_t<T1, T2, T3> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_all_matrix_t<T2, T3> *, require_stan_scalar_t<T1> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_all_matrix_t<T1, T3> *, require_stan_scalar_t<T2> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_matrix_t<T3> *, require_all_stan_scalar_t<T1, T2> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_all_matrix_t<T1, T2> *, require_stan_scalar_t<T3> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_matrix_t<T2> *, require_all_stan_scalar_t<T1, T3> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);

template <typename T1, typename T2, typename T3, typename T4,
          require_matrix_t<T1> *, require_all_stan_scalar_t<T2, T3> *>
inline auto fma_reverse_pass(T1 &arena_x, T2 &arena_y, T3 &arena_z, T4 &ret);
...
template <typename T1, typename T2,
          require_all_kernel_expressions_and_none_scalar_t<T1, T2> *>
inline void update_adjoints(var_value<T1> &x, const T2 &y,
                            const stan::math::vari &z);
...
template <typename Scalar1, typename Scalar2, require_var_t<Scalar1> *,
          require_not_var_matrix_t<Scalar1> *, require_arithmetic_t<Scalar2> *>
inline void update_adjoints(Scalar1 x, Scalar2 y,
                            const stan::math::vari &z) noexcept;

template <typename Scalar1, typename Scalar2, require_var_t<Scalar1> *,
          require_not_var_matrix_t<Scalar1> *, require_arithmetic_t<Scalar2> *>
inline void update_adjoints(Scalar1 x, Scalar2 y,
                            const stan::math::var &z) noexcept;

template <typename Matrix1, typename Matrix2, require_rev_matrix_t<Matrix1> *,
          require_st_arithmetic<Matrix2> *>
inline void update_adjoints(Matrix1 &x, const Matrix2 &y,
                            const stan::math::vari &z);
...
inline constexpr void update_adjoints(Arith &&, Alt &&,
                                      const stan::math::vari &) noexcept;

template <typename Arith, typename Alt, require_st_arithmetic<Arith> *>
inline constexpr void update_adjoints(Arith &&, Alt &&,
                                      const stan::math::var &) noexcept;

template <typename StdVec1, typename Vec2, require_std_vector_t<StdVec1> *,
          require_st_arithmetic<Vec2> *>
inline void update_adjoints(StdVec1 &x, const Vec2 &y,
                            const stan::math::vari &z);
...
template <typename Mat1, typename Mat2, require_all_matrix_t<Mat1, Mat2> *,
          require_any_var_matrix_t<Mat1, Mat2> *>
inline auto quad_form_impl(const Mat1 &A, const Mat2 &B, bool symmetric);

inline stan::math::var calc_variance(size_t size, const stan::math::var *dtrs);
...
template <typename VarVec, require_std_vector_vt<stan::is_var, VarVec> *,
          typename... Pargs>
...
inline auto deep_copy_vars(const stan::math::var &arg);
...
template <typename Arith, typename VarMat, require_st_arithmetic<Arith> *,
...
template <typename Var, typename VarMat, require_rev_matrix_t<VarMat> *,
          require_var_vt<std::is_arithmetic, Var> *>
...
template <typename T, require_not_same_t<T, arena_t<T>> *,
          require_not_container_t<T> *, require_not_matrix_cl_t<T> *>
inline arena_t<T> to_arena(T &&a);

template <typename T, require_same_t<T, arena_t<T>> *,
          require_not_matrix_cl_t<T> *, require_not_std_vector_t<T> *>
...
template <bool Condition, typename T,
          require_not_t<std::bool_constant<Condition>> *>
inline T to_arena_if(T &&a);

template <bool Condition, typename T,
          require_t<std::bool_constant<Condition>> *>
...
template <typename Mat1, typename Mat2,
          require_all_matrix_st<stan::is_var_or_arithmetic, Mat1, Mat2> *,
          require_any_matrix_st<stan::is_var, Mat1, Mat2> *>
...
template <typename EigMat, require_eigen_vt<stan::is_autodiff, EigMat> *>
inline void zero_adjoints(EigMat &x);

template <typename StdVec, require_std_vector_st<stan::is_autodiff, StdVec> *>
...
template <typename Mat1, typename Mat2, require_any_var_matrix_t<Mat1, Mat2> *,
          require_all_matrix_t<Mat1, Mat2> *>
inline auto atan2(const Mat1 &a, const Mat2 &b);

template <typename Scalar, typename VarMat, require_var_matrix_t<VarMat> *,
          require_stan_scalar_t<Scalar> *>
inline auto atan2(const Scalar &a, const VarMat &b);

template <typename VarMat, typename Scalar, require_var_matrix_t<VarMat> *,
          require_stan_scalar_t<Scalar> *>
...
template <typename Scal, typename RowVec, require_stan_scalar_t<Scal> *,
...
template <typename Scal, typename ColVec, require_stan_scalar_t<Scal> *,
...
template <typename EigMat, require_eigen_vt<stan::is_var, EigMat> *>
...
template <typename T1, typename T2, require_all_vector_t<T1, T2> *,
          ...
          require_all_not_std_vector_t<T1, T2> *, require_any_st_var<T1, T2> *>
inline stan::math::var dot_product(const T1 &v1, const T2 &v2);

template <typename Mat1, typename Mat2, require_all_eigen_t<Mat1, Mat2> *,
          require_any_eigen_vt<stan::is_var, Mat1, Mat2> *>
...
template <typename T, require_eigen_vector_vt<stan::is_var, T> *>
inline stan::math::var dot_self(const T &v);

template <typename T, require_var_matrix_t<T> *>
inline stan::math::var dot_self(const T &v);

template <typename Mat, require_eigen_vt<stan::is_var, Mat> *>
...
template <int Options, typename MatrixVar, typename Vec1, typename Vec2,
          require_eigen_dense_base_vt<stan::is_var, MatrixVar> *,
          require_all_std_vector_vt<std::is_integral, Vec1, Vec2> *>
...
template <typename T1, typename T2, require_all_matrix_t<T1, T2> *,
          require_return_type_t<stan::is_var, T1, T2> *,
...
template <typename T1, typename T2, require_not_matrix_t<T1> *,
          require_matrix_t<T2> *, require_return_type_t<stan::is_var, T1, T2> *,
          require_not_row_and_col_vector_t<T1, T2> *>
inline auto multiply(const T1 &a, T2 &&B);

template <typename T1, typename T2, require_matrix_t<T1> *,
          require_not_matrix_t<T2> *, require_any_st_var<T1, T2> *,
...
template <typename V, require_eigen_vector_vt<stan::is_complex, V> *,
...
template <typename M, require_eigen_dense_dynamic_vt<stan::is_complex, M> *,
...
template <typename Scal1, typename Scal2,
          require_any_var_t<base_type_t<Scal1>, base_type_t<Scal2>> *,
...
template <typename Mat1, typename Scal1,
          ...
          require_all_matrix_st<stan::is_var, Mat1> *,
...
template <typename T1, typename T2, require_any_container_t<T1, T2> *,
          require_all_not_matrix_st<stan::is_var, T1, T2> *,
          require_any_var_t<base_type_t<T1>, base_type_t<T2>> *>
...
template <typename Ta, typename Tz, require_all_stan_scalar_t<Ta, Tz> *,
...
template <typename Ta, typename Tb, typename Tz, bool grad_a, bool grad_b,
          bool grad_z, require_all_matrix_t<Ta, Tb> *,
          require_return_type_t<stan::is_var, Ta, Tb, Tz> *>
...
template <typename T, require_eigen_st<stan::is_var, T> *>
auto log_softmax(const T &x);

template <typename T, require_var_matrix_t<T> *>
inline auto log_softmax(const T &x);

template <typename T, require_std_vector_st<stan::is_var, T> *>
inline auto log_softmax(const T &x);
...
template <typename EigMat1, typename EigMat2,
          require_eigen_matrix_base_vt<stan::is_var, EigMat1> *,
...
template <typename EigMat1, typename EigMat2,
          ...
          require_eigen_matrix_base_vt<stan::is_var, EigMat2> *>
inline Eigen::Matrix<var, EigMat1::RowsAtCompileTime,
                     EigMat2::ColsAtCompileTime>
mdivide_left_spd(const EigMat1 &A, const EigMat2 &b);
...
template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_all_eigen_vt<stan::is_var, T1, T2> *>
...
template <Eigen::UpLoType TriView, typename T1, typename T2,
          ...
          require_eigen_vt<stan::is_var, T2> *>
inline Eigen::Matrix<var, T1::RowsAtCompileTime, T2::ColsAtCompileTime>
mdivide_left_tri(const T1 &A, const T2 &b);

template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_eigen_vt<stan::is_var, T1> *,
          require_eigen_vt<std::is_arithmetic, T2> *>
inline Eigen::Matrix<var, T1::RowsAtCompileTime, T2::ColsAtCompileTime>
mdivide_left_tri(const T1 &A, const T2 &b);

template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_all_matrix_t<T1, T2> *, require_any_var_matrix_t<T1, T2> *>
...
template <typename Var1, typename Var2, require_all_st_var<Var1, Var2> *,
...
template <typename Var, typename Arith, require_st_arithmetic<Arith> *,
          require_all_not_std_vector_t<Var, Arith> *, require_st_var<Var> *>
...
template <typename T, require_eigen_vt<stan::is_var, T> *>
inline var_value<
...
template <typename EigVecVar, typename EigVecArith,
          require_eigen_vector_vt<stan::is_var, EigVecVar> *,
...
template <typename Td, typename Ta, typename Tb, require_not_col_vector_t<Td> *,
          require_all_matrix_t<Td, Ta, Tb> *, require_any_st_var<Td, Ta, Tb> *>
inline stan::math::var trace_gen_inv_quad_form_ldlt(const Td &D,
                                                    LDLT_factor<Ta> &A,
                                                    const Tb &B);

template <typename Td, typename Ta, typename Tb, require_col_vector_t<Td> *,
          require_all_matrix_t<Ta, Tb> *, require_any_st_var<Td, Ta, Tb> *>
inline stan::math::var trace_gen_inv_quad_form_ldlt(const Td &D,
...
template <typename F, typename T, typename... T_Args,
          require_eigen_vector_t<T> *, require_any_st_var<T_Args...> *>
...
template <typename T1, typename T2, typename F,
          require_any_var_matrix_t<T1, T2> *, require_all_matrix_t<T1, T2> *>
...
template <typename T1, typename T2, typename F,
          require_any_std_vector_vt<stan::is_std_vector, T1, T2> *,
...
template <typename T, typename... Types, require_eigen_vt<stan::is_var, T> *,
          require_any_var_matrix_t<T, Types...> *>
inline auto identity_constrain(T &&x, Types &&...);
...
template <typename T, typename L, require_matrix_t<T> *,
          require_stan_scalar_t<L> *, require_any_st_var<T, L> *>
inline auto lb_constrain(const T &x, const L &lb);
...
template <typename T, typename U, require_matrix_t<T> *,
          require_stan_scalar_t<U> *, require_any_st_var<T, U> *>
inline auto ub_constrain(const T &x, const U &ub);
...
template <typename T, typename L, typename U, require_all_matrix_t<T, L> *,
          require_stan_scalar_t<U> *, require_var_t<return_type_t<T, L, U>> *>
inline auto lub_constrain(const T &x, const L &lb, const U &ub);
...
template <typename T, typename L, typename U, require_all_matrix_t<T, U> *,
          require_stan_scalar_t<L> *, require_var_t<return_type_t<T, L, U>> *>
inline auto lub_constrain(const T &x, const L &lb, const U &ub);
...
template <typename T, typename L, typename U, require_all_matrix_t<T, L, U> *,
          require_var_t<return_type_t<T, L, U>> *>
inline auto lub_constrain(const T &x, const L &lb, const U &ub);
...
template <typename T, require_eigen_col_vector_vt<stan::is_var, T> *>
...
template <typename T, require_eigen_vt<stan::is_fvar, T> *>
...
template <typename EigMat, require_eigen_vt<stan::is_fvar, EigMat> *>
...
template <typename T1, typename T2,
          require_any_fvar_t<base_type_t<T1>, base_type_t<T2>> *,
...
template <typename Ta, typename Tz, typename FvarT,
          require_all_stan_scalar_t<Ta, Tz> *, require_any_fvar_t<Ta, Tz> *>
...
template <typename Ta, typename Tb, typename Tz, typename FvarT, bool grad_a,
          bool grad_b, bool grad_z, require_all_vector_t<Ta, Tb> *,
...
template <typename Mat1, typename Mat2,
          require_all_eigen_vt<stan::is_fvar, Mat1, Mat2> *,
          require_vt_same<Mat1, Mat2> *,
          require_not_eigen_row_and_col_t<Mat1, Mat2> *>
inline auto multiply(const Mat1 &m1, const Mat2 &m2);

template <typename Mat1, typename Mat2, require_eigen_vt<stan::is_fvar, Mat1> *,
...
template <typename Mat1, typename Mat2,
          ...
          require_eigen_vt<stan::is_fvar, Mat2> *,
          require_not_eigen_row_and_col_t<Mat1, Mat2> *>
inline auto multiply(const Mat1 &m1, const Mat2 &m2);
...
template <typename T, require_eigen_t<T> *,
          require_not_eigen_vt<stan::is_fvar, T> *>
...
template <typename ColVec, require_eigen_col_vector_vt<stan::is_fvar, ColVec> *>
inline auto softmax(const ColVec &alpha);

template <typename T, require_vector_st<stan::is_fvar, T> *>
inline auto log_softmax(const T &x);
...
template <typename T, require_container_st<stan::is_fvar, T> *>
inline auto log_sum_exp(const T &x);
...
template <typename T1, typename T2,
          require_all_eigen_vt<stan::is_fvar, T1, T2> *,
          require_vt_same<T1, T2> *>
inline Eigen::Matrix<value_type_t<T1>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left(const T1 &A, const T2 &b);

template <typename T1, typename T2, require_eigen_vt<std::is_arithmetic, T1> *,
          require_eigen_vt<stan::is_fvar, T2> *>
inline Eigen::Matrix<value_type_t<T2>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left(const T1 &A, const T2 &b);

template <typename T1, typename T2, require_eigen_vt<stan::is_fvar, T1> *,
          require_eigen_vt<std::is_arithmetic, T2> *>
inline Eigen::Matrix<value_type_t<T1>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left(const T1 &A, const T2 &b);
...
template <typename T, typename EigMat,
          require_eigen_vt<std::is_arithmetic, T> *,
          require_eigen_vt<stan::is_fvar, EigMat> *>
...
template <typename T1, typename T2, require_eigen_t<T1> *,
          require_vt_same<double, T1> *, require_eigen_vt<stan::is_fvar, T2> *>
inline Eigen::Matrix<value_type_t<T2>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left_tri_low(const T1 &A, const T2 &b);

template <typename T1, typename T2, require_eigen_vt<stan::is_fvar, T1> *,
          require_eigen_t<T2> *, require_vt_same<double, T2> *>
inline Eigen::Matrix<value_type_t<T1>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left_tri_low(const T1 &A, const T2 &b);

template <typename EigMat1, typename EigMat2,
          require_all_eigen_vt<stan::is_fvar, EigMat1, EigMat2> *,
...
template <typename EigMat1, typename EigMat2,
          require_eigen_vt<stan::is_fvar, EigMat1> *,
...
template <typename EigMat1, typename EigMat2,
          ...
          require_eigen_vt<stan::is_fvar, EigMat2> *>
...
template <typename Container, require_eigen_vt<stan::is_fvar, Container> *>
...
template <typename EigMat, require_eigen_col_vector_vt<stan::is_fvar, EigMat> *>
inline auto unit_vector_constrain(const EigMat &y);

template <typename EigMat, typename T,
          require_eigen_vt<stan::is_fvar, EigMat> *, require_stan_scalar_t<T> *>
