...
template <bool propto, typename T, typename... T_pack>
...
template <typename F, typename T, typename Enable>
...
// ./stan/math/rev/core/arena_matrix.hpp:12
...
template <typename ContainerOperands,
...
template <typename Op1, typename Op2, typename Op3,
          typename Op4, typename Op5, typename Op6,
          typename Op7, typename Op8,
...
template <typename T, require_eigen_vt<std::is_arithmetic, T>*>
inline value_type_t<T> sum(const T& m);

// ./stan/math/prim/fun/sum.hpp:58
template <typename T, require_eigen_vt<is_complex, T>*>
inline value_type_t<T> sum(const T& m);

// ./stan/math/prim/meta/possibly_sum.hpp:17
template <typename CondSum, typename T, require_t<CondSum>*>
inline auto possibly_sum(T&& x);

// ./stan/math/prim/meta/possibly_sum.hpp:29
template <typename CondSum, typename T1, require_not_t<CondSum>*>
...
template <typename T, require_integral_t<T>*>
inline bool is_nan(T x);

// ./stan/math/prim/fun/is_nan.hpp:33
template <typename T, require_floating_point_t<T>*>
inline bool is_nan(T x);
...
template <typename U, typename V, require_all_stan_scalar_t<U, V>*>
...
template <typename T, require_eigen_col_vector_t<T>*>
inline T&& as_column_vector_or_scalar(T&& a);

// ./stan/math/prim/fun/as_column_vector_or_scalar.hpp:57
template <typename T, require_eigen_row_vector_t<T>*,
          require_not_eigen_col_vector_t<T>*>
...
template <
    typename Container, require_not_stan_scalar_t<Container>*,
    require_not_container_st<std::is_arithmetic, Container>*,
    require_not_var_matrix_t<Container>*,
    require_not_nonscalar_prim_or_rev_kernel_expression_t<Container>*>
inline auto square(const Container& x);

// ./stan/math/prim/fun/square.hpp:66
template <typename Container,
          require_container_st<std::is_arithmetic, Container>*>
inline auto square(const Container& x);
...
template <typename U, typename V, require_stan_scalar_t<V>*>
inline complex_return_t<U, V> operator*(const std::complex<U>& x, const V& y);

// ./stan/math/prim/core/operator_multiplication.hpp:69
template <typename U, typename V, require_stan_scalar_t<U>*>
inline complex_return_t<U, V> operator*(const U& x, const std::complex<V>& y);
...
template <bool Cond, typename T, std::enable_if_t<!Cond>*>
...
template <typename U, typename V, require_any_autodiff_t<U, V>*>
...
template <typename T1, typename T2, require_all_not_matrix_t<T1, T2>*,
...
template <
    ...
    require_any_not_stan_scalar_t<T1, T2>*>
inline void check_matching_dims(const char* function, const char* name1,
                                const T1& y1, const char* name2, const T2& y2);

// ./stan/math/prim/err/check_matching_dims.hpp:112
template <typename T1, typename T2, require_any_matrix_t<T1, T2>*,
          require_any_stan_scalar_t<T1, T2>*>
inline void check_matching_dims(const char* function, const char* name1,
                                const T1& y1, const char* name2, const T2& y2);

// ./stan/math/prim/err/check_matching_dims.hpp:137
template <bool check_compile, typename Mat1, typename Mat2,
          require_all_eigen_t<Mat1, Mat2>*>
inline void check_matching_dims(const char* function, const char* name1,
...
template <typename T, require_eigen_array_t<T>*>
inline T as_array_or_scalar(T&& v);

// ./stan/math/prim/fun/as_array_or_scalar.hpp:54
template <typename T, require_eigen_t<T>*,
          require_not_eigen_array_t<T>*>
inline auto as_array_or_scalar(T&& v);

// ./stan/math/prim/fun/as_array_or_scalar.hpp:67
template <typename T, require_std_vector_t<T>*,
          require_not_std_vector_t<value_type_t<T>>*>
inline auto as_array_or_scalar(T&& v);

// ./stan/math/prim/fun/as_array_or_scalar.hpp:83
template <typename T, require_std_vector_vt<is_std_vector, T>*,
          require_std_vector_vt<is_stan_scalar, value_type_t<T>>*>
inline auto as_array_or_scalar(T&& v);

// ./stan/math/prim/fun/constants.hpp:19
static constexpr double e();

// ./stan/math/prim/fun/constants.hpp:26
static constexpr double egamma();

// ./stan/math/prim/fun/constants.hpp:35
static constexpr double pi();

// ./stan/math/prim/fun/constants.hpp:198
static constexpr inline double positive_infinity();

// ./stan/math/prim/fun/constants.hpp:205
static constexpr inline double negative_infinity();

// ./stan/math/prim/fun/constants.hpp:212
static constexpr inline double not_a_number();

// ./stan/math/prim/fun/constants.hpp:220
static constexpr inline double machine_precision();

// ./stan/math/prim/fun/constants.hpp:227
static constexpr inline double log10();

// ./stan/math/prim/fun/constants.hpp:234
...
template <typename VarMat1, typename VarMat2,
          require_all_rev_matrix_t<VarMat1, VarMat2>*>
...
template <typename Var, typename EigMat,
          require_var_vt<std::is_arithmetic, Var>*,
          require_eigen_vt<std::is_arithmetic, EigMat>*>
...
template <typename T1, typename T2,
          require_any_var_vt<std::is_arithmetic, T1, T2>*,
          require_any_arithmetic_t<T1, T2>*>
inline auto add(const T1& a, const T2& b);

// ./stan/math/rev/core/operator_addition.hpp:260
template <typename T1, typename T2,
          require_all_var_vt<std::is_arithmetic, T1, T2>*>
inline auto add(const T1& a, const T2& b);

// ./stan/math/rev/core/operator_addition.hpp:275
template <typename VarMat1, typename VarMat2,
          require_any_var_matrix_t<VarMat1, VarMat2>*>
...
template <typename EigMat, require_eigen_dense_base_t<EigMat>*,
          require_not_st_arithmetic<EigMat>*>
inline auto value_of(EigMat&& M);

// ./stan/math/prim/fun/value_of.hpp:80
template <typename EigMat, require_eigen_sparse_base_t<EigMat>*,
          require_not_st_arithmetic<EigMat>*>
inline auto value_of(EigMat&& M);

// ./stan/math/prim/fun/value_of.hpp:96
template <typename EigMat, require_eigen_sparse_base_t<EigMat>*,
          require_st_arithmetic<EigMat>*>
inline auto value_of(EigMat&& M);
...
template <typename T, require_container_t<T>*>
...
template <typename T, require_not_arena_t<T>*,
          require_not_container_t<T>*,
          require_not_matrix_cl_t<T>*>
inline arena_t<T> to_arena(T&& a);

// ./stan/math/rev/fun/to_arena.hpp:46
template <typename T, require_arena_t<T>*,
          require_not_matrix_cl_t<T>*,
...
template <bool Condition, typename T, std::enable_if_t<!Condition>*>
...
template <typename Scalar, typename Mat, require_matrix_t<Mat>*,
          require_stan_scalar_t<Scalar>*,
          require_all_st_var_or_arithmetic<Scalar, Mat>*,
          require_any_st_var<Scalar, Mat>*>
...
template <typename Mat1, typename Mat2,
          require_all_matrix_st<is_var_or_arithmetic, Mat1, Mat2>*,
          require_any_matrix_st<is_var, Mat1, Mat2>*>
...
template <typename T_y, typename T_high,
          require_all_stan_scalar_t<T_y, T_high>*, typename... Idxs>
...
template <
    typename T_y, typename T_high, require_stan_scalar_t<T_y>*,
    require_vector_t<T_high>*,
    require_not_std_vector_vt<is_container_or_var_matrix, T_high>*,
    typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);
...
template <typename T_y, typename T_high, require_stan_scalar_t<T_y>*,
          require_dense_dynamic_t<T_high>*, typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);

// ./stan/math/prim/err/check_less_or_equal.hpp:151
template <typename T_y, typename T_high, require_vector_t<T_y>*,
          require_not_std_vector_vt<is_container_or_var_matrix, T_y>*,
          require_stan_scalar_t<T_high>*, typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);
...
template <typename T_y, typename T_high,
          require_all_vector_t<T_y, T_high>*,
...
template <typename T_y, typename T_high,
          require_all_dense_dynamic_t<T_y, T_high>*, typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);
...
template <typename T_y, typename T_high,
          require_std_vector_vt<is_container_or_var_matrix, T_y>*,
          require_not_std_vector_t<T_high>*, typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);
...
template <typename T_y, typename T_high,
          ...
          require_std_vector_vt<is_container_or_var_matrix, T_high>*,
          typename... Idxs>
inline void check_less_or_equal(const char* function, const char* name,
                                const T_y& y, const T_high& high,
                                Idxs... idxs);
...
template <typename T1, typename T2, typename F,
          require_all_stan_scalar_t<T1, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:54
template <typename T1, typename T2, typename F,
          require_all_eigen_t<T1, T2>*>
inline auto apply_scalar_binary(T1&& x, T2&& y, F&& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:77
template <typename T1, typename T2, typename F,
          require_eigen_vector_vt<is_stan_scalar, T1>*,
          require_std_vector_vt<std::is_integral, T2>*>
inline auto apply_scalar_binary(T1&& x, T2&& y, F&& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:104
template <typename T1, typename T2, typename F,
          require_std_vector_vt<std::is_integral, T1>*,
          require_eigen_vector_vt<is_stan_scalar, T2>*>
inline auto apply_scalar_binary(T1&& x, T2&& y, F&& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:131
template <typename T1, typename T2, typename F,
          require_eigen_matrix_dynamic_vt<is_stan_scalar, T1>*,
          require_std_vector_vt<is_std_vector, T2>*,
          require_std_vector_st<std::is_integral, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:164
template <typename T1, typename T2, typename F,
          require_std_vector_vt<is_std_vector, T1>*,
          require_std_vector_st<std::is_integral, T1>*,
          require_eigen_matrix_dynamic_vt<is_stan_scalar, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:200
template <typename T1, typename T2, typename F, require_eigen_t<T1>*,
          require_stan_scalar_t<T2>*>
inline auto apply_scalar_binary(T1&& x, T2&& y, F&& f);

// ./stan/math/prim/functor/apply_scalar_binary.hpp:226
template <typename T1, typename T2, typename F,
          require_stan_scalar_t<T1>*, require_eigen_t<T2>*>
inline auto apply_scalar_binary(T1&& x, T2&& y, F&& f);
...
template <typename T1, typename T2, typename F,
          require_std_vector_vt<is_stan_scalar, T1>*,
          require_stan_scalar_t<T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);
...
template <typename T1, typename T2, typename F,
          require_std_vector_vt<is_container_or_var_matrix, T1>*,
          require_stan_scalar_t<T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);
...
template <typename T1, typename T2, typename F,
          require_stan_scalar_t<T1>*,
          require_std_vector_vt<is_container_or_var_matrix, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);
...
template <typename T1, typename T2, require_any_container_t<T1, T2>*,
          require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
              T1, T2>*>
...
template <typename EigMat, require_matrix_t<EigMat>*>
...
template <typename T_y, typename T_low,
          require_all_stan_scalar_t<T_y, T_low>*, typename... Idxs>
...
template <
    typename T_y, typename T_low, require_stan_scalar_t<T_y>*,
    require_vector_t<T_low>*,
    require_not_std_vector_vt<is_container_or_var_matrix, T_low>*,
    typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);

// ./stan/math/prim/err/check_greater.hpp:106
template <typename T_y, typename T_low, require_stan_scalar_t<T_y>*,
          require_dense_dynamic_t<T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);

// ./stan/math/prim/err/check_greater.hpp:146
template <typename T_y, typename T_low, require_vector_t<T_y>*,
          require_not_std_vector_vt<is_container_or_var_matrix, T_y>*,
          require_stan_scalar_t<T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);

// ./stan/math/prim/err/check_greater.hpp:184
template <typename T_y, typename T_low, require_dense_dynamic_t<T_y>*,
          require_stan_scalar_t<T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);
...
template <typename T_y, typename T_low,
          require_all_vector_t<T_y, T_low>*,
          require_all_not_std_vector_vt<is_container_or_var_matrix, T_y,
                                        T_low>*,
          typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
...
template <typename T_y, typename T_low,
          require_all_dense_dynamic_t<T_y, T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);
...
template <typename T_y, typename T_low,
          require_std_vector_vt<is_container_or_var_matrix, T_y>*,
          require_not_std_vector_t<T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);
...
template <typename T_y, typename T_low,
          require_not_std_vector_t<T_y>*,
          require_std_vector_vt<is_container_or_var_matrix, T_low>*,
          typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);
...
template <typename T_y, typename T_low,
          require_any_std_vector_vt<is_container_or_var_matrix, T_y,
                                    T_low>*,
          require_all_std_vector_t<T_y, T_low>*, typename... Idxs>
inline void check_greater(const char* function, const char* name, const T_y& y,
                          const T_low& low, Idxs... idxs);
...
template <typename T_y, require_vector_t<T_y>*,
          require_not_std_vector_t<T_y>*>
void check_ordered(const char* function, const char* name, const T_y& y);

// ./stan/math/prim/err/check_ordered.hpp:60
template <typename T_y, require_std_vector_vt<is_stan_scalar, T_y>*>
void check_ordered(const char* function, const char* name, const T_y& y);

// ./stan/math/prim/err/check_ordered.hpp:90
template <typename T_y, require_std_vector_t<T_y>*,
          require_not_vt_stan_scalar<T_y>*>
void check_ordered(const char* function, const char* name, const T_y& y);

// ./stan/math/prim/err/check_sorted.hpp:25
template <typename EigVec, require_eigen_vector_t<EigVec>*>
...
template <typename T_y, require_matrix_t<T_y>*>
...
template <
    typename T,
    require_any_t<is_vector<T>, is_prim_or_rev_kernel_expression<T>>*>
...
template <typename T_omega, typename T_Gamma, typename T_rho,
          require_all_eigen_t<T_omega, T_Gamma>*,
          require_eigen_col_vector_t<T_rho>*>
...
template <typename EigMat, require_eigen_matrix_dynamic_t<EigMat>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_matrix_t<EigMat1, EigMat2>*>
...
template <typename StdVec,
          require_std_vector_st<is_autodiff, StdVec>*>
...
template <typename Vec1, typename Vec2,
          require_all_eigen_vector_t<Vec1, Vec2> *,
          require_not_var_t<return_type_t<Vec1, Vec2>> *>
inline auto dot_product(const Vec1 &v1, const Vec2 &v2);

// ./stan/math/prim/fun/dot_product.hpp:36
template <typename Scalar1, typename Scalar2,
          require_all_stan_scalar_t<Scalar1, Scalar2> *,
          require_all_not_var_t<Scalar1, Scalar2> *>
...
template <typename Mat1, typename Mat2,
          require_all_eigen_vt<is_fvar, Mat1, Mat2>*,
          require_vt_same<Mat1, Mat2>*,
          require_not_eigen_row_and_col_t<Mat1, Mat2>*>
inline auto multiply(const Mat1& m1, const Mat2& m2);

// ./stan/math/fwd/fun/multiply.hpp:23
template <typename Mat1, typename Mat2,
          require_eigen_vt<is_fvar, Mat1>*,
          require_eigen_vt<std::is_floating_point, Mat2>*,
          require_not_eigen_row_and_col_t<Mat1, Mat2>*>
inline auto multiply(const Mat1& m1, const Mat2& m2);

// ./stan/math/fwd/fun/multiply.hpp:42
template <typename Mat1, typename Mat2,
          require_eigen_vt<std::is_floating_point, Mat1>*,
          require_eigen_vt<is_fvar, Mat2>*,
          require_not_eigen_row_and_col_t<Mat1, Mat2>*>
inline auto multiply(const Mat1& m1, const Mat2& m2);
...
template <
    typename T, require_not_container_st<std::is_arithmetic, T>*,
...
template <typename Container, require_not_var_matrix_t<Container>*,
          require_container_st<std::is_arithmetic, Container>*>
inline auto inv_sqrt(const Container& x);
...
template <typename Scal1, typename Scal2,
          require_all_stan_scalar_t<Scal1, Scal2>*>
...
template <typename EigMat,
          require_eigen_col_vector_vt<is_fvar, EigMat>*>
...
template <typename EigMat, typename T,
          require_eigen_vt<is_fvar, EigMat>*,
          require_stan_scalar_t<T>*>
...
template <typename T, require_not_var_matrix_t<T>*,
...
template <typename T1, typename T2, require_any_container_t<T1, T2>*,
          require_all_not_var_matrix_t<T1, T2>*>
...
template <typename Eig, require_eigen_vt<is_complex, Eig>*>
inline auto conj(const Eig& z);

// ./stan/math/prim/fun/conj.hpp:41
template <typename StdVec, require_std_vector_st<is_complex, StdVec>*>
...
template <typename T1, typename T2, typename T3,
          require_all_arithmetic_t<T1, T2, T3>*>
inline double fma(T1 x, T2 y, T3 z);

// ./stan/math/prim/fun/fma.hpp:31
template <typename T1, typename T2, typename T3,
          require_any_matrix_t<T1, T2, T3>*,
          require_not_var_t<return_type_t<T1, T2, T3>>*>
inline auto fma(T1&& x, T2&& y, T3&& z);

// ./stan/math/fwd/fun/fma.hpp:58
template <typename T1, typename T2, typename T3,
          require_all_stan_scalar_t<T1, T2, T3>*>
...
template <typename T_a, typename T_b,
          require_all_arithmetic_t<T_a, T_b>*>
...
template <typename T1, typename T2, require_any_container_t<T1, T2>*,
          require_all_not_matrix_st<is_var, T1, T2>*>
inline auto pow(const T1& a, const T2& b);

// ./stan/math/prim/fun/hypergeometric_pFq.hpp:28
template <typename Ta, typename Tb, typename Tz,
          require_all_eigen_st<std::is_arithmetic, Ta, Tb>*,
          require_arithmetic_t<Tz>*>
...
template <typename Ta1, typename Ta2, typename Tb, typename Tz,
          typename ScalarT ,
          typename OptT ,
          require_all_arithmetic_t<Ta1, Ta2, Tb, Tz>*>
...
template <typename F, typename T1, typename T2, typename T3,
          require_any_container_t<T1, T2>*,
          require_stan_scalar_t<T3>*>
inline auto apply_scalar_ternary(const F& f, const T1& x, const T2& y,
                                 const T3& z);

// ./stan/math/prim/functor/apply_scalar_ternary.hpp:184
template <typename F, typename T1, typename T2, typename T3,
          require_all_container_t<T1, T3>*,
          require_stan_scalar_t<T2>*>
inline auto apply_scalar_ternary(const F& f, const T1& x, const T2& y,
                                 const T3& z);
...
template <typename T1, typename T2, typename T3,
          require_any_container_t<T1, T2, T3>*,
          require_all_not_var_matrix_t<T1, T2, T3>*>
...
template <typename V, typename T, require_arithmetic_t<T>*>
inline std::complex<fvar<V>> pow(const std::complex<fvar<V>>& x,
...
template <typename T, typename V, require_arithmetic_t<T>*>
...
template <typename Ta, typename Tz, require_all_arithmetic_t<Ta, Tz>*>
...
template <typename Ta, typename Tz, typename FvarT ,
          require_all_stan_scalar_t<Ta, Tz>*,
          require_any_fvar_t<Ta, Tz>*>
...
template <typename Ta1, typename Ta2, typename Tb, typename Tz,
          ...
          require_any_fvar_t<Ta1, Ta2, Tb, Tz>*>
inline return_type_t<Ta1, Ta1, Tb, Tz> hypergeometric_2F1(const Ta1& a1,
                                                          const Ta2& a2,
                                                          const Tb& b,
                                                          const Tz& z);
...
template <typename ScalarA, typename ScalarB,
          require_all_stan_scalar_t<ScalarA, ScalarB>*,
          require_all_not_var_t<ScalarA, ScalarB>*>
inline return_type_t<ScalarA, ScalarB> add(const ScalarA& a, const ScalarB& b);

// ./stan/math/prim/fun/add.hpp:40
template <typename Mat1, typename Mat2,
          require_all_eigen_t<Mat1, Mat2>*,
          require_all_not_st_var<Mat1, Mat2>*>
inline auto add(const Mat1& m1, const Mat2& m2);

// ./stan/math/prim/fun/add.hpp:57
template <typename Mat, typename Scal, require_eigen_t<Mat>*,
          require_stan_scalar_t<Scal>*,
          require_all_not_st_var<Mat, Scal>*>
inline auto add(const Mat& m, const Scal c);

// ./stan/math/prim/fun/add.hpp:73
template <typename Scal, typename Mat, require_stan_scalar_t<Scal>*,
          require_eigen_t<Mat>*,
          require_all_not_st_var<Scal, Mat>*>
...
template <typename T_true, typename T_false,
          typename ReturnT ,
          require_all_stan_scalar_t<T_true, T_false>*>
...
template <
    ...
    typename T_return ,
    typename T_true_plain ,
    typename T_false_plain ,
    require_all_container_t<T_true, T_false>*,
    require_all_same_t<T_true_plain, T_false_plain>*>
...
template <typename T_bool, typename T_true, typename T_false,
          require_eigen_array_vt<std::is_integral, T_bool>*,
          require_all_stan_scalar_t<T_true, T_false>*>
...
template <typename T_bool, typename T_true, typename T_false,
          ...
          require_any_eigen_array_t<T_true, T_false>*>
inline auto select(const T_bool c, const T_true y_true, const T_false y_false);
...
template <typename Ta, typename Tb, typename Tz,
          ...
          bool grad_b ,
          bool grad_z ,
          require_all_vector_t<Ta, Tb>*,
          require_fvar_t<FvarT>*>
...
template <typename T1, typename T2, require_all_eigen_t<T1, T2>*>
...
template <typename Mat, typename Scal, require_stan_scalar_t<Scal>*,
          require_eigen_t<Mat>*,
          require_all_not_st_var<Scal, Mat>*,
          require_all_not_complex_t<Scal, value_type_t<Mat>>*>
inline auto multiply(const Mat& m, Scal c);

// ./stan/math/prim/fun/multiply.hpp:43
template <typename Mat, typename Scal,
          require_any_complex_t<value_type_t<Mat>, Scal>*,
          require_eigen_t<Mat>*, require_not_eigen_t<Scal>*>
inline auto multiply(const Mat& m, Scal c);
...
template <typename Mat1, typename Mat2,
          require_all_eigen_vt<std::is_arithmetic, Mat1, Mat2>*,
          require_not_eigen_row_and_col_t<Mat1, Mat2>*>
inline auto multiply(const Mat1& m1, const Mat2& m2);
...
template <typename Mat1, typename Mat2,
          require_all_eigen_t<Mat1, Mat2>*,
          require_t<is_complex<return_type_t<Mat1, Mat2>>>*,
          require_not_eigen_row_and_col_t<Mat1, Mat2>*>
inline auto multiply(const Mat1& m1, const Mat2& m2);

// ./stan/math/prim/fun/multiply.hpp:147
template <typename RowVec, typename ColVec,
          require_not_var_t<return_type_t<RowVec, ColVec>>*,
          require_eigen_row_and_col_t<RowVec, ColVec>*>
...
template <typename T1, require_arithmetic_t<T1>*>
...
template <typename T1, typename T2, require_all_not_st_var<T1, T2>*,
          require_all_stan_scalar_t<T1, T2>*>
...
template <typename T_theta, typename T_lambda1, typename T_lambda2,
          require_all_arithmetic_t<T_theta, T_lambda1, T_lambda2>*>
...
template <typename T_theta, typename T_lam,
          require_any_vector_t<T_theta, T_lam>*>
...
template <typename ColVec,
          require_eigen_col_vector_vt<std::is_arithmetic, ColVec>*>
inline plain_type_t<ColVec> softmax(const ColVec& v);

// ./stan/math/fwd/fun/softmax.hpp:14
template <typename ColVec,
          require_eigen_col_vector_vt<is_fvar, ColVec>*>
inline auto softmax(const ColVec& alpha);

// ./stan/math/prim/fun/log_softmax.hpp:42
template <typename Container, require_st_arithmetic<Container>*,
          require_container_t<Container>*>
...
template <typename T1, typename T2,
          require_all_eigen_vt<std::is_arithmetic, T1, T2>*>
...
template <typename T1, typename T2,
          require_all_eigen_vt<is_fvar, T1, T2>*,
          require_vt_same<T1, T2>*>
...
template <typename T1, typename T2,
          require_eigen_vt<std::is_arithmetic, T1>*,
          require_eigen_vt<is_fvar, T2>*>
inline Eigen::Matrix<value_type_t<T2>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left(const T1& A, const T2& b);

// ./stan/math/fwd/fun/mdivide_left.hpp:74
template <typename T1, typename T2, require_eigen_vt<is_fvar, T1>*,
          require_eigen_vt<std::is_arithmetic, T2>*>
inline Eigen::Matrix<value_type_t<T1>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left(const T1& A, const T2& b);
...
template <typename T1, typename T2, require_eigen_t<T1>*,
          require_vt_same<double, T1>*,
          require_eigen_vt<is_fvar, T2>*>
inline Eigen::Matrix<value_type_t<T2>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left_tri_low(const T1& A, const T2& b);
...
template <typename EigMat1, typename EigMat2,
          ...
          require_all_not_vt_fvar<EigMat1, EigMat2>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_vt<is_fvar, EigMat1, EigMat2>*,
          require_vt_same<EigMat1, EigMat2>*>
...
template <typename EigMat1, typename EigMat2,
          require_eigen_vt<is_fvar, EigMat1>*,
          require_eigen_vt<std::is_arithmetic, EigMat2>*>
inline Eigen::Matrix<value_type_t<EigMat1>, EigMat1::RowsAtCompileTime,
                     EigMat2::ColsAtCompileTime>
mdivide_right(const EigMat1& A, const EigMat2& b);
...
template <typename EigMat1, typename EigMat2,
          require_eigen_vt<std::is_arithmetic, EigMat1>*,
          require_eigen_vt<is_fvar, EigMat2>*>
...
template <typename Container, require_std_vector_t<Container>*>
...
template <typename T1, typename T2, require_any_container_t<T1, T2>*,
          require_all_not_var_and_matrix_types<T1, T2>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>*,
          require_not_eigen_col_vector_t<EigMat2>*,
          require_any_vt_fvar<EigMat1, EigMat2>*>
...
template <typename EigMat, typename ColVec, require_eigen_t<EigMat>*,
          require_eigen_col_vector_t<ColVec>*,
          require_any_vt_fvar<EigMat, ColVec>*>
...
template <typename F, typename T_a, typename T_b, typename... Args,
          require_any_st_fvar<T_a, T_b, Args...> *>
...
template <typename F, typename T_a, typename T_b, typename T_theta,
          require_any_fvar_t<T_a, T_b, T_theta> *>
...
template <typename T_CPCs, require_eigen_vector_t<T_CPCs>*>
...
template <typename T1, typename T2, require_all_vector_t<T1, T2>*,
          require_not_complex_t<return_type_t<T1, T2>>*,
          require_all_not_std_vector_t<T1, T2>*,
          require_any_st_var<T1, T2>*>
...
template <typename T_CPCs, typename T_sds,
          require_all_eigen_vector_t<T_CPCs, T_sds>*,
          require_vt_same<T_CPCs, T_sds>*>
...
template <bool Jacobian = false, typename T, typename... Types,
          require_all_not_var_matrix_t<T, Types...>*>
...
template <typename T, typename... Types,
          require_eigen_vt<std::is_arithmetic, T>*,
          require_any_var_matrix_t<T, Types...>*>
inline auto identity_constrain(T&& x, Types&&... /* args */);

// ./stan/math/rev/constraint/identity_constrain.hpp:29
template <typename T, typename... Types, require_eigen_vt<is_var, T>*,
          require_any_var_matrix_t<T, Types...>*>
inline auto identity_constrain(T&& x, Types&&... /* args */);

// ./stan/math/rev/constraint/identity_constrain.hpp:35
template <typename T, typename... Types, require_var_matrix_t<T>*,
          require_any_var_matrix_t<T, Types...>*>
inline auto identity_constrain(T&& x, Types&&... /* args */);
...
template <typename T, typename L, require_all_stan_scalar_t<T, L>*,
          require_all_not_st_var<T, L>*>
...
template <typename T, typename L, require_eigen_t<T>*,
          require_stan_scalar_t<L>*,
          require_all_not_st_var<T, L>*>
...
template <typename T, typename L, require_all_eigen_t<T, L>*,
          require_all_not_st_var<T, L>*>
inline auto lb_constrain(T&& x, L&& lb);
...
template <typename T, typename L, require_not_std_vector_t<L>*>
...
template <typename T, typename L, require_matrix_t<T>*,
          require_stan_scalar_t<L>*,
          require_any_st_var<T, L>*>
inline auto lb_constrain(const T& x, const L& lb);
...
template <typename T, typename L, require_all_matrix_t<T, L>*,
          require_any_st_var<T, L>*>
inline auto lb_constrain(const T& x, const L& lb);
...
template <typename T, typename U, require_all_stan_scalar_t<T, U>*,
          require_all_not_st_var<T, U>*>
...
template <typename T, typename U, require_eigen_t<T>*,
...
template <typename T, typename U, require_all_eigen_t<T, U>*,
          require_all_not_st_var<T, U>*>
inline auto ub_constrain(const T& x, const U& ub);
...
template <typename T, typename U, require_not_std_vector_t<U>*>
...
template <typename T, typename L, typename U,
          require_all_stan_scalar_t<T, L, U>*,
          require_not_var_t<return_type_t<T, L, U>>*>
...
template <typename T, typename L, typename U, require_eigen_t<T>*,
          require_all_stan_scalar_t<L, U>*,
          require_not_var_t<return_type_t<T, L, U>>*>
...
template <typename T, typename L, typename U,
          require_all_not_std_vector_t<L, U>*>
...
template <typename T, typename U, require_matrix_t<T>*,
          require_stan_scalar_t<U>*,
          require_any_st_var<T, U>*>
inline auto ub_constrain(const T& x, const U& ub);
...
template <typename T, typename U, require_all_matrix_t<T, U>*,
          require_any_st_var<T, U>*>
inline auto ub_constrain(const T& x, const U& ub);
...
template <typename T, typename L, typename U,
          require_all_stan_scalar_t<T, L, U>*,
          require_var_t<return_type_t<T, L, U>>*>
inline auto lub_constrain(const T& x, const L& lb, const U& ub);
...
template <typename T, typename L, typename U, require_matrix_t<T>*,
          require_all_stan_scalar_t<L, U>*,
          require_var_t<return_type_t<T, L, U>>*>
inline auto lub_constrain(const T& x, const L& lb, const U& ub);
...
template <typename Vec, require_eigen_col_vector_t<Vec>*,
          require_not_st_var<Vec>*>
...
template <bool Jacobian, typename Vec, require_not_std_vector_t<Vec>*>
inline plain_type_t<Vec> sum_to_zero_constrain(const Vec& y,
...
template <typename T_m, typename T_a, require_eigen_t<T_m>*,
...
template <typename ContainerT,
          require_eigen_st<std::is_integral, ContainerT>*>
...
template <typename T_n, typename T_k,
          require_all_stan_scalar_t<T_n, T_k>*>
...
template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_all_eigen_t<T1, T2> *,
          require_all_not_eigen_vt<is_var, T1, T2> *>
inline auto mdivide_left_tri(const T1 &A, const T2 &b);

// ./stan/math/prim/fun/mdivide_left_tri.hpp:53
template <Eigen::UpLoType TriView, typename T, require_eigen_t<T> *>
...
template <typename EigMat, require_eigen_t<EigMat>*,
          require_not_eigen_vt<is_var, EigMat>*>
inline Eigen::Matrix<value_type_t<EigMat>, EigMat::RowsAtCompileTime,
                     EigMat::ColsAtCompileTime>
...
template <typename Mat1, typename Mat2,
          require_all_eigen_t<Mat1, Mat2>*,
          require_all_not_eigen_vt<is_var, Mat1, Mat2>*>
...
template <typename M, require_eigen_dense_dynamic_t<M>*>
...
template <typename Scal1, typename Scal2,
          require_all_stan_scalar_t<Scal1, Scal2>*,
          require_all_not_var_t<Scal1, Scal2>*>
...
template <typename EigVec1, typename EigVec2,
          require_all_eigen_vector_t<EigVec1, EigVec2>*,
          require_all_not_eigen_vt<is_var, EigVec1, EigVec2>*>
...
template <typename T, require_eigen_dense_base_t<T>*>
...
template <typename T1, typename T2,
          require_all_not_rev_matrix_t<T1, T2>*>
...
template <typename EigCplxMat,
          require_eigen_matrix_dynamic_vt<is_complex, EigCplxMat>*>
...
template <typename Mat, typename Scal, require_matrix_t<Mat>*,
          require_stan_scalar_t<Scal>*>
...
template <typename T_U, typename T_CPCs, require_eigen_t<T_U>*,
          require_eigen_vector_t<T_CPCs>*,
          require_vt_same<T_U, T_CPCs>*>
...
template <typename T_Sigma, typename T_CPCs, typename T_sds,
          ...
          require_all_eigen_vector_t<T_CPCs, T_sds>*,
          require_all_vt_same<T_Sigma, T_CPCs, T_sds>*>
bool factor_cov_matrix(const T_Sigma& Sigma, T_CPCs&& CPCs, T_sds&& sds);

// ./stan/math/prim/fun/fft.hpp:33
template <typename V, require_eigen_vector_vt<is_complex, V>*,
          require_not_var_t<base_type_t<value_type_t<V>>>*>
...
template <typename M, require_eigen_dense_dynamic_vt<is_complex, M>*,
          require_not_var_t<base_type_t<value_type_t<M>>>*>
...
template <typename EigMat, typename S, require_eigen_t<EigMat>*,
          require_stan_scalar_t<S>*>
inline void fill(EigMat& x, const S& y);

// ./stan/math/prim/fun/fill.hpp:56
template <typename Vec, typename S, require_std_vector_t<Vec>*>
...
template <typename EigMat, require_eigen_t<EigMat>*,
          require_not_eigen_vector_t<EigMat>*>
...
template <typename T, require_vector_t<T>*>
...
template <typename T, typename V, require_all_stan_scalar_t<T, V>*,
          require_convertible_t<V, T>*>
...
template <typename Vector, require_vector_t<Vector>*>
...
template <typename T, require_not_rev_matrix_t<T>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>*,
          require_all_st_same<double, EigMat1, EigMat2>*>
...
template <typename ScalarT, require_stan_scalar_t<ScalarT>*>
int64_t size_mvt(const ScalarT& /* unused */);

// ./stan/math/prim/fun/size_mvt.hpp:29
template <typename MatrixT, require_matrix_t<MatrixT>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>*,
          require_all_not_vt_var<EigMat1, EigMat2>*>
inline Eigen::Matrix<return_type_t<EigMat1, EigMat2>,
                     EigMat1::RowsAtCompileTime, EigMat2::ColsAtCompileTime>
...
template <typename T1, typename T2, require_all_eigen_t<T1, T2>*,
          require_all_not_eigen_vt<is_fvar, T1, T2>*>
inline Eigen::Matrix<return_type_t<T1, T2>, T1::RowsAtCompileTime,
                     T2::ColsAtCompileTime>
mdivide_left_tri_low(const T1& A, const T2& b);
...
template <typename T, require_not_std_vector_t<T>*>
...
template <typename T_theta, typename T_scalar ,
          require_eigen_vector_t<T_theta>*>
...
template <typename T_y, typename T_theta, require_vt_integral<T_y>*>
...
template <typename PromotionScalar, typename UnPromotedType,
          require_constructible_t<PromotionScalar, UnPromotedType>*,
          require_not_same_t<PromotionScalar, UnPromotedType>*,
          require_all_not_tuple_t<PromotionScalar, UnPromotedType>*>
...
template <
    ...
    require_same_t<PromotionScalar, scalar_type_t<UnPromotedType>>*>
...
template <typename T_ret, typename In, require_std_vector_t<T_ret>*>
...
template <typename Ret, typename T,
          require_eigen_matrix_dynamic_vt<is_stan_scalar, Ret>*,
          require_stan_scalar_t<T>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_vt<std::is_arithmetic, EigMat1, EigMat2>*>
inline Eigen::Matrix<double, Eigen::Dynamic, EigMat2::ColsAtCompileTime>
...
template <typename T, require_eigen_t<T>*>
inline Eigen::Matrix<value_type_t<T>, Eigen::Dynamic, Eigen::Dynamic>
symmetrize_from_upper_tri(const T& m);
...
template <typename T, typename S,
          require_all_not_container_t<T, S>*>
...
template <typename T1, typename T2, require_any_container_t<T1, T2>*,
          require_all_st_stan_scalar<T1, T2>*>
...
template <typename Container,
          require_std_vector_st<std::is_arithmetic, Container>*>
inline auto to_int(const Container& x);

// ./stan/math/prim/fun/to_matrix.hpp:21
template <typename EigMat, require_eigen_dense_dynamic_t<EigMat>*>
...
template <typename EigMat1, typename T2, typename EigMat3,
          ...
          require_all_not_st_var<EigMat1, T2, EigMat3>*>
...
template <typename EigVec, typename T, typename EigMat,
          ...
          require_all_not_st_var<EigVec, T, EigMat>*>
...
template <typename TD, typename TA, typename TB,
          require_all_eigen_t<TD, TA, TB>*,
          require_all_not_vt_var<TD, TA, TB>*,
          require_any_not_vt_arithmetic<TD, TA, TB>*>
...
template <typename T, typename EigMat2,
          require_all_not_st_var<T, EigMat2>*>
...
template <typename EigVec, require_eigen_col_vector_t<EigVec>*>
inline Eigen::Matrix<value_type_t<EigVec>, Eigen::Dynamic, Eigen::Dynamic>
...
template <typename T, typename L, require_not_std_vector_t<T>*,
          require_stan_scalar_t<L>*>
...
template <typename T, typename U, require_not_std_vector_t<T>*,
          require_stan_scalar_t<U>*>
...
template <typename T, typename M, typename S,
          require_all_not_std_vector_t<M, S>*>
...
template <typename Vec, require_col_vector_t<Vec>*>
...
template <typename Mat, require_eigen_matrix_dynamic_t<Mat>*,
          require_not_st_var<Mat>*>
...
template <bool Jacobian, typename Mat, require_not_std_vector_t<Mat>*>
inline plain_type_t<Mat> stochastic_column_constrain(const Mat& y,
...
template <typename Mat1, typename Mat2,
          require_any_var_matrix_t<Mat1, Mat2>*,
          require_all_matrix_t<Mat1, Mat2>*>
...
template <typename T, require_var_row_vector_t<T>*,
          require_not_var_col_vector_t<T>*>
inline auto as_column_vector_or_scalar(T&& a);
...
template <typename T1, typename T2, require_st_integral<T1>*,
          require_eigen_t<T2>*>
...
template <typename StdVec, typename Mat, require_eigen_t<Mat>*,
          require_st_integral<StdVec>*>
...
template <typename Mat1, typename Mat2,
          require_all_eigen_t<Mat1, Mat2>*,
          require_any_eigen_vt<is_var, Mat1, Mat2>*>
inline Eigen::Matrix<return_type_t<Mat1, Mat2>, 1, Mat1::ColsAtCompileTime>
columns_dot_product(const Mat1& v1, const Mat2& v2);
...
template <typename T_x, typename T_sigma, require_st_arithmetic<T_x>*,
          require_stan_scalar_t<T_sigma>*>
...
template <typename T_x,
          require_arithmetic_t<typename scalar_type<T_x>::type>*>
...
template <int Options = Eigen::ColMajor, typename VarMatrix, typename Vec1,
          typename Vec2, require_var_t<VarMatrix>*,
          require_eigen_dense_base_t<value_type_t<VarMatrix>>*,
          require_all_std_vector_vt<std::is_integral, Vec1, Vec2>*>
...
template <int Options = Eigen::ColMajor, typename MatrixVar, typename Vec1,
          typename Vec2,
          require_eigen_dense_base_vt<is_var, MatrixVar>*,
          require_all_std_vector_vt<std::is_integral, Vec1, Vec2>*>
...
template <int Options = Eigen::ColMajor, typename Mat, typename Vec1,
          typename Vec2,
          require_eigen_dense_base_vt<std::is_arithmetic, Mat>*,
          require_all_std_vector_vt<std::is_integral, Vec1, Vec2>*>
...
template <typename T1, typename T2, require_vector_t<T1>*,
          require_matrix_t<T2>*,
          require_any_st_var<T1, T2>*>
auto diag_pre_multiply(const T1& m1, const T2& m2);

// ./stan/math/rev/fun/diag_post_multiply.hpp:23
template <typename T1, typename T2, require_matrix_t<T1>*,
          require_vector_t<T2>*,
          require_any_st_var<T1, T2>*>
auto diag_post_multiply(const T1& m1, const T2& m2);
...
template <typename Mat1, typename Mat2,
          require_all_matrix_t<Mat1, Mat2>*,
          require_any_rev_matrix_t<Mat1, Mat2>*>
auto elt_divide(const Mat1& m1, const Mat2& m2);
...
template <typename T1, typename T2, require_all_matrix_t<T1, T2>*,
          require_return_type_t<is_var, T1, T2>*,
          require_not_row_and_col_vector_t<T1, T2>*>
inline auto multiply(T1&& A, T2&& B);

// ./stan/math/rev/fun/multiply.hpp:87
template <typename T1, typename T2, require_all_matrix_t<T1, T2>*,
          require_return_type_t<is_var, T1, T2>*,
          require_row_and_col_vector_t<T1, T2>*>
inline var multiply(const T1& A, const T2& B);

// ./stan/math/rev/fun/multiply.hpp:136
template <typename T1, typename T2, require_not_matrix_t<T1>*,
          require_matrix_t<T2>*,
          require_return_type_t<is_var, T1, T2>*,
          require_not_row_and_col_vector_t<T1, T2>*>
...
template <typename T1, typename T2, require_matrix_t<T1>*,
          require_not_matrix_t<T2>*,
          require_any_st_var<T1, T2>*,
          require_not_complex_t<value_type_t<T1>>*,
          require_not_complex_t<value_type_t<T2>>*,
          require_not_row_and_col_vector_t<T1, T2>*>
inline auto multiply(T1&& A, T2&& B);
...
template <typename V, require_eigen_vector_vt<is_complex, V>*,
          require_var_t<base_type_t<value_type_t<V>>>*>
...
template <typename M, require_eigen_dense_dynamic_vt<is_complex, M>*,
          require_var_t<base_type_t<value_type_t<M>>>*>
...
template <typename VarMat, typename S, require_var_matrix_t<VarMat>*,
          require_var_t<S>*>
inline void fill(VarMat& x, const S& y);

// ./stan/math/rev/fun/fill.hpp:46
template <typename VarMat, typename S, require_var_matrix_t<VarMat>*,
          require_arithmetic_t<S>*>
inline void fill(VarMat& x, const S& y);
...
template <typename T1, typename T2, typename T3,
          require_any_matrix_t<T1, T2, T3>*,
          require_var_t<return_type_t<T1, T2, T3>>*>
...
template <typename Ta, typename Tb, typename Tz,
          ...
          bool grad_b ,
          bool grad_z ,
          require_all_matrix_t<Ta, Tb>*,
          require_return_type_t<is_var, Ta, Tb, Tz>*>
...
template <typename T1, typename T2, require_all_matrix_t<T1, T2>*,
          require_any_var_matrix_t<T1, T2>*>
inline auto lmultiply(const T1& a, const T2& b);

// ./stan/math/rev/fun/lmultiply.hpp:150
template <typename T1, typename T2, require_var_matrix_t<T1>*,
          require_stan_scalar_t<T2>*>
inline auto lmultiply(const T1& a, const T2& b);

// ./stan/math/rev/fun/lmultiply.hpp:196
template <typename T1, typename T2, require_stan_scalar_t<T1>*,
          require_var_matrix_t<T2>*>
inline auto lmultiply(const T1& a, const T2& b);
...
template <typename T_theta, typename T_lambda1, typename T_lambda2,
          require_any_var_t<T_theta, T_lambda1, T_lambda2>*>
...
template <typename Ta, typename Tb, require_all_eigen_t<Ta, Tb>*,
          require_any_st_autodiff<Ta, Tb>*>
...
template <
    ...
    require_all_eigen_matrix_base_vt<is_var, EigMat1, EigMat2> *>
...
template <typename EigMat1, typename EigMat2,
          require_eigen_matrix_base_vt<is_var, EigMat1> *,
          require_eigen_matrix_base_vt<std::is_arithmetic, EigMat2> *>
inline Eigen::Matrix<var, EigMat1::RowsAtCompileTime,
                     EigMat2::ColsAtCompileTime>
mdivide_left_spd(const EigMat1 &A, const EigMat2 &b);
...
template <typename EigMat1, typename EigMat2,
          require_eigen_matrix_base_vt<std::is_arithmetic, EigMat1> *,
          require_eigen_matrix_base_vt<is_var, EigMat2> *>
inline Eigen::Matrix<var, EigMat1::RowsAtCompileTime,
                     EigMat2::ColsAtCompileTime>
mdivide_left_spd(const EigMat1 &A, const EigMat2 &b);
...
template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_all_eigen_vt<is_var, T1, T2> *>
...
template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_eigen_vt<std::is_arithmetic, T1> *,
          require_eigen_vt<is_var, T2> *>
inline Eigen::Matrix<var, T1::RowsAtCompileTime, T2::ColsAtCompileTime>
mdivide_left_tri(const T1 &A, const T2 &b);

// ./stan/math/rev/fun/mdivide_left_tri.hpp:296
template <Eigen::UpLoType TriView, typename T1, typename T2,
          require_eigen_vt<is_var, T1> *,
          require_eigen_vt<std::is_arithmetic, T2> *>
inline Eigen::Matrix<var, T1::RowsAtCompileTime, T2::ColsAtCompileTime>
mdivide_left_tri(const T1 &A, const T2 &b);
...
template <typename Var1, typename Var2,
          require_all_st_var<Var1, Var2>*,
          require_all_not_std_vector_t<Var1, Var2>*>
inline auto owens_t(const Var1& h, const Var2& a);

// ./stan/math/rev/fun/owens_t.hpp:65
template <typename Var, typename Arith, require_st_arithmetic<Arith>*,
          require_all_not_std_vector_t<Var, Arith>*,
          require_st_var<Var>*>
inline auto owens_t(const Var& h, const Arith& a);

// ./stan/math/rev/fun/owens_t.hpp:97
template <typename Arith, typename Var, require_st_arithmetic<Arith>*,
          require_all_not_std_vector_t<Var, Arith>*,
          require_st_var<Var>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>*,
          require_not_eigen_col_vector_t<EigMat2>*,
          require_any_vt_var<EigMat1, EigMat2>*>
...
template <typename T1, typename T2, require_var_vector_t<T1>*,
          require_stan_scalar_t<T2>*>
...
template <typename T_CPCs, typename T_sds,
          require_any_var_vector_t<T_CPCs, T_sds>*,
          require_vt_same<T_CPCs, T_sds>*>
...
template <typename T_CPCs, typename T_sds,
          require_all_var_vector_t<T_CPCs, T_sds>*>
...
template <typename Ret, typename T, require_var_matrix_t<Ret>*,
          require_var_t<T>*>
inline auto rep_matrix(const T& x, int m, int n);

// ./stan/math/rev/fun/rep_matrix.hpp:43
template <typename Ret, typename Vec, require_var_matrix_t<Ret>*,
          require_var_matrix_t<Vec>*>
inline auto rep_matrix(const Vec& x, int n);

// ./stan/math/rev/fun/rep_row_vector.hpp:20
template <typename T_ret, require_var_matrix_t<T_ret>*,
          require_eigen_row_vector_t<value_type_t<T_ret>>*>
inline auto rep_row_vector(var x, int n);

// ./stan/math/rev/fun/rep_vector.hpp:20
template <typename T_ret, require_var_matrix_t<T_ret>*,
          require_eigen_col_vector_t<value_type_t<T_ret>>*>
...
template <
    ...
    require_all_eigen_vector_vt<is_var, EigVecVar1, EigVecVar2>*>
...
template <typename EigVecVar, typename EigVecArith,
          require_eigen_vector_vt<is_var, EigVecVar>*,
          require_eigen_vector_vt<std::is_arithmetic, EigVecArith>*>
...
template <typename T1, typename T2, require_all_vector_t<T1, T2>*,
          require_any_var_vector_t<T1, T2>*>
...
template <typename Td, typename Ta, typename Tb,
          ...
          require_all_matrix_t<Td, Ta, Tb>*,
          require_any_st_var<Td, Ta, Tb>*>
...
template <typename Td, typename Ta, typename Tb,
          require_any_var_matrix_t<Td, Ta, Tb>*,
          require_all_matrix_t<Td, Ta, Tb>*>
...
template <typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>*,
          require_any_st_var<EigMat1, EigMat2>*>
inline return_type_t<EigMat1, EigMat2> trace_quad_form(const EigMat1& A,
                                                       const EigMat2& B);
...
template <typename F, typename T_y0, typename T_t0, typename T_ts,
          typename... Args, require_eigen_vector_t<T_y0>*>
...
template <typename ReduceFunction, typename Vec,
          require_vector_like_t<Vec>*, typename... Args>
...
template <typename F, typename T1, typename T2,
          require_all_eigen_vector_t<T1, T2>*>
...
template <typename T1, typename T2, typename F,
          require_any_var_matrix_t<T1, T2>*,
          require_any_std_vector_vt<std::is_integral, T1, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);

// ./stan/math/rev/functor/apply_scalar_binary.hpp:70
template <typename T1, typename T2, typename F,
          require_any_std_vector_vt<is_std_vector, T1, T2>*,
          require_any_std_vector_st<std::is_integral, T1, T2>*,
          require_any_var_matrix_t<T1, T2>*>
inline auto apply_scalar_binary(const T1& x, const T2& y, const F& f);
...
template <typename F, typename EigVec, typename InputIt,
          require_eigen_vector_vt<std::is_arithmetic, EigVec>*>
...
template <typename F, typename T_a, typename T_b, typename... Args,
          require_any_st_var<T_a, T_b, Args...> *>
inline return_type_t<T_a, T_b, Args...> integrate_1d_impl(
    const F &f, const T_a &a, const T_b &b, double relative_tolerance,
    std::ostream *msgs, const Args &... args);
...
template <typename F, typename T_a, typename T_b, typename T_theta,
          require_any_var_t<T_a, T_b, T_theta>*>
inline return_type_t<T_a, T_b, T_theta> integrate_1d(
    const F &f, const T_a &a, const T_b &b, const std::vector<T_theta> &theta,
    const std::vector<double> &x_r, const std::vector<int> &x_i,
...
template <typename F, typename T_yy, typename T_yp, typename... T_Args,
          require_all_eigen_col_vector_t<T_yy, T_yp>*>
...
template <typename F, typename T_y0, typename T_t0, typename T_ts,
          typename... T_Args, require_eigen_col_vector_t<T_y0>*>
...
template <typename F, typename T_y0, typename T_t0, typename T_ts,
          ...
          require_all_eigen_col_vector_t<T_y0, T_abs_tol_fwd,
                                         T_abs_tol_bwd>*,
          require_any_not_st_arithmetic<T_y0, T_t0, T_ts, T_Args...>*>
...
template <typename F, typename T_y0, typename T_t0, typename T_ts,
          ...
          require_all_eigen_col_vector_t<T_y0, T_abs_tol_fwd,
                                         T_abs_tol_bwd>*,
          require_all_st_arithmetic<T_y0, T_t0, T_ts, T_Args...>*>
...
template <bool propto, typename T_n, typename T_N, typename T_x,
          typename T_alpha, typename T_beta, require_matrix_t<T_x>*>
...
template <bool propto, typename T_y, typename T_x, typename T_alpha,
          typename T_beta, require_matrix_t<T_x>*,
          require_col_vector_t<T_alpha>*,
          require_matrix_t<T_beta>*>
...
template <bool propto, typename T_prob, require_col_vector_t<T_prob>*>
...
template <typename T_n, typename T_prob, require_st_integral<T_n>*,
...
template <bool propto, typename T_y, typename T_F, typename T_G, typename T_V,
          ...
          require_all_eigen_matrix_dynamic_t<T_y, T_F, T_G, T_V, T_W,
                                             T_C0>*,
          require_eigen_col_vector_t<T_m0>*>
...
template <
    ...
    typename T_W, typename T_m0, typename T_C0,
    require_all_eigen_matrix_dynamic_t<T_y, T_F, T_G, T_W, T_C0>*,
    require_all_eigen_col_vector_t<T_V, T_m0>*>
inline return_type_t<T_y, T_F, T_G, T_V, T_W, T_m0, T_C0> gaussian_dlm_obs_lpdf(
    const T_y& y, const T_F& F, const T_G& G, const T_V& V, const T_W& W,
    const T_m0& m0, const T_C0& C0);
...
template <bool propto, typename T_y, typename T_dof, typename T_scale,
          ...
          require_all_matrix_t<T_y, T_scale>*>
...
template <bool propto, typename T_y, typename T_loc, typename T_scale,
          typename T_shape, require_eigen_matrix_dynamic_t<T_y>*,
          require_all_eigen_col_vector_t<T_loc, T_scale>*>
...
template <bool propto, typename T_y, typename T_loc, typename T_scale,
          typename T_shape, require_eigen_matrix_dynamic_t<T_y>*,
          require_all_stan_scalar_t<T_loc, T_scale>*>
return_type_t<T_y, T_loc, T_scale, T_shape> lkj_cov_lpdf(const T_y& y,
                                                         const T_loc& mu,
                                                         const T_scale& sigma,
                                                         const T_shape& eta);
...
template <bool propto, typename T_y, typename T_Mu, typename T_Sigma,
          typename T_D,
          require_all_matrix_t<T_y, T_Mu, T_Sigma, T_D>*>
...
template <bool propto, typename T_y, typename T_covar, typename T_w,
          require_all_eigen_matrix_dynamic_t<T_y, T_covar>*,
          require_eigen_col_vector_t<T_w>*>
...
template <bool propto, typename T_y, typename T_covar, typename T_w,
          require_all_matrix_t<T_y, T_covar>*,
          require_col_vector_t<T_w>*>
...
template <bool propto, typename T_y, typename T_loc, typename T_covar,
          require_any_not_vector_vt<is_stan_scalar, T_y, T_loc>*,
          require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
              T_y, T_loc, T_covar>*>
...
template <bool propto, typename T_y, typename T_loc, typename T_covar,
          require_all_vector_vt<is_stan_scalar, T_y, T_loc>*,
          require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
              T_y, T_loc, T_covar>*>
return_type_t<T_y, T_loc, T_covar> multi_normal_cholesky_lpdf(
    const T_y& y, const T_loc& mu, const T_covar& L);
...
template <
    ...
    require_any_not_vector_vt<is_stan_scalar, T_y, T_dof, T_loc>*,
    require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
        T_y, T_loc, T_covar>*>
...
template <bool propto, typename T_y, typename T_dof, typename T_loc,
          typename T_covar,
          require_all_vector_vt<is_stan_scalar, T_y, T_dof, T_loc>*,
          require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
              T_y, T_dof, T_loc, T_covar>*>
return_type_t<T_y, T_dof, T_loc, T_covar> multi_student_t_cholesky_lpdf(
    const T_y& y, const T_dof& nu, const T_loc& mu, const T_covar& L);
...
template <bool propto, typename T_beta, typename T_prob ,
...
template <typename T_beta, require_eigen_col_vector_t<T_beta>*>
...
template <bool propto, typename T_n, typename T_log_location,
          typename T_precision,
          require_all_not_nonscalar_prim_or_rev_kernel_expression_t<
              T_n, T_log_location, T_precision>*>
...
template <bool propto, typename T_y, typename T_x, typename T_alpha,
          typename T_beta, typename T_scale, require_matrix_t<T_x>*>
...
template <bool propto, typename T_y, typename T_x, typename T_beta,
          typename T_cuts, require_matrix_t<T_x>*,
          require_all_col_vector_t<T_beta, T_cuts>*>
...
template <typename T_theta, typename RNG,
          require_eigen_vt<std::is_arithmetic, T_theta>*>
...
template <typename T_y, typename T_loc, typename T_scale, typename T_skewness>
inline return_type_t<T_y, T_loc, T_scale, T_skewness>
skew_double_exponential_cdf_log(const T_y& y, const T_loc& mu,
                                const T_scale& sigma, const T_skewness& tau);
