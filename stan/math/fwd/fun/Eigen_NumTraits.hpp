 ...
 */
template <typename T, typename BinaryOp>
struct ScalarBinaryOpTraits<int, stan::math::complex<stan::math::fvar<T>>, BinaryOp> {
  using ReturnType = stan::math::complex<stan::math::fvar<T>>;
};
 ...
 */
template <typename T, typename BinaryOp>
struct ScalarBinaryOpTraits<stan::math::complex<stan::math::fvar<T>>, int, BinaryOp> {
  using ReturnType = stan::math::complex<stan::math::fvar<T>>;
};
...
struct ScalarBinaryOpTraits<stan::math::complex<double>,
                            stan::math::complex<stan::math::fvar<T>>, BinaryOp> {
  using ReturnType = stan::math::complex<stan::math::fvar<T>>;
};
