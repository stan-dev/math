...
template <typename T1, typename T2, enable_if_all_not_same<T2, T2>* = nullptr, enable_if_fvar<T2>* = nullptr>
...
template <typename T1, typename T2, enable_if_not_same<T1, T2>* = nullptr, enable_if_not_arithmetic<T2>* = nullptr>
