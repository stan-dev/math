#ifndef STAN_MATH_GPU_KERNELS_NEGATIVE_RECT_LOWER_TRI_MULTIPLY_HPP
#define STAN_MATH_GPU_KERNELS_NEGATIVE_RECT_LOWER_TRI_MULTIPLY_HPP
#ifdef STAN_OPENCL
...
// \cond
const char* negative_rect_lower_tri_multiply_kernel_code = STRINGIFY(
    // \endcond
    /**
     ...
     *  negative_rect_lower_tri_multiply_kernel_code
     *  Used in math/gpu/lower_tri_inverse.hpp.
     *  This kernel uses the helper macros available in helpers.cl.
     */
    __kernel void negative_rect_lower_tri_multiply(
...
/**
 * See the docs
 * for \link kernels/negative_rect_lower_tri_multiply.hpp add() \endlink
 */
const local_range_kernel<cl::Buffer, cl::Buffer, int, int>
    negative_rect_lower_tri_multiply(
        "negative_rect_lower_tri_multiply",
        negative_rect_lower_tri_multiply_kernel_code,
