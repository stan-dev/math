...
#include <stan/math/gpu/kernels/diag_inv.hpp>
#include <stan/math/gpu/kernels/inv_lower_tri_multiply.hpp>
#include <stan/math/gpu/kernels/neg_rect_lower_tri_multiply.hpp>
