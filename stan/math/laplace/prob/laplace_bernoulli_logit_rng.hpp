 ...
 */
template <typename CovarFun, typename T_theta, typename T_x,
...
laplace_bernoulli_logit_rng(
  ...
  return laplace_base_rng(
      ...
      msgs, tolerance, max_num_steps, hessian_block_size, solver, do_line_search, max_steps_line_search, std::forward<Args>(args)...);
}
