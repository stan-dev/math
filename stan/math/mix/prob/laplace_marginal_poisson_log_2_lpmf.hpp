 ...
 * \msg_arg
 */
template <bool propto = false, typename YeVec, typename CovarFun,
          typename CovarArgs, require_eigen_vector_t<YeVec>* = nullptr>
inline auto laplace_marginal_poisson_2_log_lpmf(const std::vector<int>& y,
