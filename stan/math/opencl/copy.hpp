 ...
 * the destination OpenCL matrix
 *
 * @tparam T type of data in the Eigen matrix
 * @param dst destination OpenCL matrix
...
/**
 * Copies the source OpenCL matrix that is stored
 * to the destination Eigen matrix.
 *
 * @tparam T type of data in the Eigen matrix
 * @param dst destination Eigen matrix
 * @param src source OpenCL matrix
 *
 * @throw <code>std::invalid_argument</code> if the
 * matrices do not have matching dimensions
 */
...
/**
 * Copies the source OpenCL matrix to the
 * destination OpenCL matrix.
 *
