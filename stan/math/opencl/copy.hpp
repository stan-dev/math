 ...
 */
template <typename T, int R, int C, typename = ArithmeticTypeContainer<T>>
 ...
 */
template <typename T, typename = ArithmeticTypeContainer<T>>
...
template <matrix_cl_view matrix_view, typename T,
          typename = ArithmeticTypeContainer<T>>
