 ...
 */
template <typename T, int R, int C, typename = arithmetic_type_container<T>>
 ...
 */
template <typename T, typename = arithmetic_type_container<T>>
...
template <matrix_cl_view matrix_view, typename T,
          typename = arithmetic_type_container<T>>
