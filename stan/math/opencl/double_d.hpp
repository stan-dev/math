...
inline void split(double a, double& hi, double& lo) {
  ...
  static double const QD_SPLIT_THRESH
      = std::ldexp((std::numeric_limits<double>::max)(), -QD_BITS - 1);
...
inline double_d sub_d_dd(double a, double_d b) { return add_dd_d(neg(b), a); }
...
inline bool lt_d_dd(double a, double_d b) { return lt_dd_dd({a, 0}, b); }

inline bool lt_dd_d(double_d a, double b) { return lt_dd_dd(a, {b, 0}); }

inline bool gt_dd_dd(double_d a, double_d b) {
  return a.high > b.high || (a.high == b.high && a.low > b.low);
}

inline bool gt_d_dd(double a, double_d b) { return gt_dd_dd({a, 0}, b); }

inline bool gt_dd_d(double_d a, double b) { return gt_dd_dd(a, {b, 0}); }

inline bool le_dd_dd(double_d a, double_d b) { return !gt_dd_dd(a, b); }
inline bool le_d_dd(double a, double_d b) { return !gt_d_dd(a, b); }
inline bool le_dd_d(double_d a, double b) { return !gt_dd_d(a, b); }

inline bool ge_dd_dd(double_d a, double_d b) { return !lt_dd_dd(a, b); }
inline bool ge_d_dd(double a, double_d b) { return !lt_d_dd(a, b); }
