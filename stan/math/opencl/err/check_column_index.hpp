#ifndef STAN_MATH_OPENCL_ERR_CHECK_COLUMN_INDEX_HPP
#define STAN_MATH_OPENCL_ERR_CHECK_COLUMN_INDEX_HPP
...
template <typename T_y,
          require_all_prim_or_rev_kernel_expression_t<T_y>* = nullptr>
