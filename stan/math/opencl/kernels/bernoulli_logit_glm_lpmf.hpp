...
// \endcond
         ...
         * @param[out] logp_global partially summed log probability (1 value per work group)
         ...
         * @param need_theta_derivative_sum interpreted as boolean - whether theta_derivative_sum needs to be computed
         */
        __kernel void bernoulli_logit_glm(
            __global double* logp_global, __global double* theta_derivative_global, __global double* theta_derivative_sum,
