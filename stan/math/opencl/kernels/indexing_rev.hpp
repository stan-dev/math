...
// \cond
static constexpr const char* indexing_rev_global_atomic_kernel_code = STRINGIFY(
    // \endcond
...
// \cond
static constexpr const char* indexing_rev_local_atomic_kernel_code = STRINGIFY(
    // \endcond
    /** \ingroup opencl_kernels
     *
     * Increments adjoint of the indexing operation argument given the indices
