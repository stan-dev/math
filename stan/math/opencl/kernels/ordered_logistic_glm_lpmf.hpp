 ...
 * @param[out] location_sum partially summed location (1 value per work group)
 ...
 * @param[out] cuts_derivative partially summed derivative wrt cuts (1 column per work group)
 ...
 * @param need_location_derivative interpreted as boolean - whether location_derivative needs to be computed
 * @param need_cuts_derivative interpreted as boolean - whether cuts_derivative needs to be computed
 */
        __kernel void ordered_logistic_glm(
                                           __global double* location_sum, __global double* logp_global, __global double* location_derivative, __global double* cuts_derivative,
                                           const __global int* y_global, const __global double* x, const __global double* beta, const __global double* cuts,
                                          const int N_instances, const int N_attributes, const int N_classes, const int is_y_vector,
                                          const int need_location_derivative, const int need_cuts_derivative) {
...
/**
 * See the docs for \link kernels/ordered_logistic_glm.hpp ordered_logistic_glm() \endlink
 */
const kernel_cl<out_buffer, out_buffer, out_buffer, out_buffer, in_buffer, in_buffer, in_buffer, in_buffer, int, int, int, int, int, int>
        ordered_logistic_glm("ordered_logistic_glm", {log1p_exp_device_function, log1m_exp_device_function , ordered_logistic_glm_kernel_code},
