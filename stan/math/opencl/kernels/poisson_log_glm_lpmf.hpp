...
// \endcond
         ...
         * @param[out] theta_derivative_global derivative with respect to x * beta + alpha
         * @param[out] theta_derivative_sum partially summed theta_derivative_global (1 value per work group)
         * @param[out] logp_global partially summed part of log probability (1 value per work group)
         ...
         * @param need_logp1 interpreted as boolean - whether first part of logp_global needs to be computed
         * @param need_logp2 interpreted as boolean - whether second part of logp_global needs to be computed
         */
        __kernel void poisson_log_glm(
                                      __global double* theta_derivative_global, __global double* theta_derivative_sum, __global double* logp_global,
                                      const __global int* y_global, const __global double* x, const __global double* alpha, const __global double* beta,
 ...
 */
const kernel_cl<out_buffer, out_buffer, out_buffer, in_buffer, in_buffer, in_buffer, in_buffer, int, int, int, int, int>
