...
inline opencl::scalar_cl_return_t<T_y_cl, T_loc_cl, T_scale_cl> logistic_lccdf(
    const T_y_cl& y, const T_loc_cl& mu, const T_scale_cl& sigma) {
  static constexpr const char* function = "logistic_lccdf(OpenCL)";
  ...
  opencl::ScalarCl<double> P = sum(P_cl);
