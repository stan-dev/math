#ifndef STAN_MATH_OPENCL_PRIM_LOGNORMAL_LCDF_HPP
#define STAN_MATH_OPENCL_PRIM_LOGNORMAL_LCDF_HPP
#ifdef STAN_OPENCL
...
inline opencl::scalar_cl_return_t<T_y_cl, T_loc_cl, T_scale_cl> lognormal_lcdf(
  ...
  opencl::ScalarCl<double> lcdf = N * LOG_HALF + sum(lcdf_cl);
