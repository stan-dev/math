#ifndef STAN_MATH_PRIM_ARR_FUNCTOR_DECOUPLE_STATES_HPP
#define STAN_MATH_PRIM_ARR_FUNCTOR_DECOUPLE_STATES_HPP
...
namespace stan {
  ...
  namespace math {
    ...
    decouple_states(const std::vector<std::vector<double> >& y,
      ...
      const size_t S = (initial_var::value ? N : 0) + (theta_var::value ? M : 0);
