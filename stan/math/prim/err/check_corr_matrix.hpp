 ...
 * be equal to 1 or a \ref stan::math::var_value with the var's inner type
 * inheriting from `Eigen::MatrixBase` with neither rows or columns defined at
 * compile time to be equal to 1.
 * @param function Name of the function this was called from
 * @param name Name of the variable
 * @param y Matrix to test
 * @throw `std::invalid_argument` if the matrix is not square
