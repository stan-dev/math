 ...
 */
 ...
 template <typename T_y, typename T_high, require_stan_scalar_t<T_y>* = nullptr, require_matrix_t<T_high>* = nullptr>
 inline void check_less(const char* function, const char* name,
                                    const T_y& y, const T_high& high) {
 ...
 template <typename T_y, typename T_high, require_matrix_t<T_y>* = nullptr, require_stan_scalar_t<T_high>* = nullptr>
 inline void check_less(const char* function, const char* name,
                                    const T_y& y, const T_high& high) {
