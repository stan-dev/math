#ifndef STAN_MATH_PRIM_ERR_CHECK_OPENCL_HPP
#define STAN_MATH_PRIM_ERR_CHECK_OPENCL_HPP
#ifdef STAN_OPENCL
#define __CL_ENABLE_EXCEPTIONS

#include <stanh/prim/err/system_error.hpp>
#include <CL/cl.hpp>
#include <iostream>
#include <stdexcept>
#include <string>

/** @file stanh/prim/err/check_opencl.hpp
...
inline void check_opencl_error(const char *function, const cl::Error &e) {
  switch (e.err()) {
    ...
    case -9:
      system_error(function, e.what(), e.err(), "CL_IMAGE_FORMISMATCH");
    case -10:
      system_error(function, e.what(), e.err(),
                   "CL_IMAGE_FORNOT_SUPPORTED");
    case -11:
    ...
    case -39:
      system_error(function, e.what(), e.err(),
                   "CL_INVALID_IMAGE_FORDESCRIPTOR");
    case -40:
