#ifndef STAN_MATH_PRIM_ERR_IS_POSITIVE_INFINITY_HPP
#define STAN_MATH_PRIM_ERR_IS_POSITIVE_INFINITY_HPP
...
/**
 * Check if any matrix element is infinity.
 * @tparam T A matrix.
 * @param y a matrix.
 */
template <typename T, require_matrix_t<T>* = nullptr>
inline bool is_positive_infinity(const T& y) {
