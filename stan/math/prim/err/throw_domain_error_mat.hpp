...
inline void throw_domain_error_mat(const char* function, const char* name,
                                   const T& y, size_t i, size_t j, const char* msg1,
                                   const char* msg2) {
  ...
  if (is_col_vector<T>::value) {
    ...
    vec_name_stream << name << "[" << stan::error_index::value + i << ", " << stan::error_index::value + j << "]";
  }
...
template <typename T>
inline void throw_domain_error_mat(const char* function, const char* name,
                                   const T& y, size_t i, size_t j, const char* msg) {
