 ...
 */
template <typename Ta1, typename Ta2, typename Ta3, typename Tb1, typename Tb2, typename Tz>
return_type_t<Ta1, Ta2, Ta3, Tb1, Tb2, Tz> F32(const Ta1& a1, const Ta2& a2, const Ta3& a3, const Tb1& b1, const Tb2& b2,
  ...
  for (int k = 0; k <= max_steps; ++k) {
    T_return p = (a1 + k) * (a2 + k) * (a3 + k) / ((b1 + k) * (b2 + k) * (k + 1));
    if (p == 0.0) {
      return t_acc;
    }
