...
#include <stanh/prim/fun/dims.hpp>
#include <stanh/prim/fun/resize.hpp>
#include <stanh/prim/fun/assign.hpp>
#include <stanh/prim/meta/append_return_type.hpp>
#include <stanh/prim/err/check_matching_sizes.hpp>
