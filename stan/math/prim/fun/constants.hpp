 ...
 */
static constexpr double e() noexcept { return boost::math::constants::e<double>(); }
 ...
 * @return Pi.
 */
static constexpr double pi() noexcept { return boost::math::constants::pi<double>(); }
 ...
 * \f$ \log \pi \f$.
 */
constexpr double LOG_PI = 1.1447298858494001741434273513530587116472948;
 ...
 * \f$ \log 2 \f$.
 */
constexpr double LOG_TWO = boost::math::constants::ln_two<double>();

/**
 * The natural logarithm of 2 plus the natural logarithm of \f$ \pi \f$,
 * \f$ \log(2\pi) \f$.
 */
constexpr double LOG_TWO_PI = LOG_TWO + LOG_PI;

/**
 * The value of one quarter the natural logarithm of \f$ \pi \f$,
 * \f$ \log(\pi) / 4 \f$.
 */
constexpr double LOG_PI_OVER_FOUR = 0.25 * LOG_PI;
 ...
 * \f$ \log 10 \f$.
 */
constexpr double LOG_TEN = boost::math::constants::ln_ten<double>();

/**
 * The value of the square root of 2,
 * \f$ \sqrt{2} \f$.
 */
constexpr double SQRT_TWO = boost::math::constants::root_two<double>();

/**
 * The value of the square root of \f$ \pi \f$,
 * \f$ \sqrt{\pi} \f$.
 */
constexpr double SQRT_PI = boost::math::constants::root_pi<double>();

/**
 * The value of the square root of \f$ 2\pi \f$,
 * \f$ \sqrt{2\pi} \f$.
 */
constexpr double SQRT_TWO_PI = boost::math::constants::root_two_pi<double>();

/**
 * The square root of 2 divided by the square root of \f$ \pi \f$,
 * \f$ \sqrt{2} / \sqrt{\pi} \f$.
 */
constexpr double SQRT_TWO_OVER_SQRT_PI = SQRT_TWO / SQRT_PI;

/**
 * The value of 1 over the square root of 2,
 * \f$ 1 / \sqrt{2} \f$.
 */
constexpr double INV_SQRT_TWO = boost::math::constants::one_div_root_two<double>();

/**
 * The value of 1 over the square root of \f$ \pi \f$,
 * \f$ 1 / \sqrt{\pi} \f$.
 */
constexpr double INV_SQRT_PI = boost::math::constants::one_div_root_pi<double>();

/**
 * The value of 1 over the square root of \f$ 2\pi \f$,
 * \f$ 1 / \sqrt{2\pi} \f$.
 */
constexpr double INV_SQRT_TWO_PI = boost::math::constants::one_div_root_two_pi<double>();

/**
 * The value of 2 over the square root of \f$ \pi \f$,
 * \f$ 2 / \sqrt{\pi} \f$.
 */
constexpr double TWO_OVER_SQRT_PI = boost::math::constants::two_div_root_pi<double>();;

/**
 * The value of half the natural logarithm 2,
 * \f$ \log(2) / 2 \f$.
 */
constexpr double HALF_LOG_TWO = 0.5 * LOG_TWO;

/**
 * The value of half the natural logarithm \f$ 2\pi \f$,
 * \f$ \log(2\pi) / 2 \f$.
 */
constexpr double HALF_LOG_TWO_PI = 0.5 * LOG_TWO_PI;
