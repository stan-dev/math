...
template <typename EigMat1, typename EigMat2,
          ...
          require_all_same_t<double, value_type_t<EigMat1>, value_type_t<EigMat2>>* = nullptr>
...
template <typename Tt, typename EigMat1, typename EigMat2,
          require_all_eigen_t<EigMat1, EigMat2>* = nullptr,
          require_any_not_same_t<double, Tt, value_type_t<EigMat1>, value_type_t<EigMat2>>* = nullptr>
