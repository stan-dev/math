#ifndef STAN_MATH_PRIM_FUN_SET_SPACED_ROW_VECTOR_HPP
#define STAN_MATH_PRIM_FUN_SET_SPACED_ROW_VECTOR_HPP
 ...
 */
inline Eigen::RowVectorXd set_spaced_row_vector(int K, double low,
                                                double high) {
  static const char* function = "set_spaced_row_vector";
