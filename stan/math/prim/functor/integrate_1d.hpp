...
#include <boosth/quadrature/exp_sinh.hpp>
#include <boosth/quadrature/sinh_sinh.hpp>
#include <boosth/quadrature/tanh_sinh.hpp>
#include <functional>
#include <limits>
#include <ostream>
#include <vector>
...
inline double integrate(const F& f, double a, double b,
  ...
  if (std::isinf(a) && std::isinf(b)) {
     ...
     * implementation:
     * https://www.boost.org/doc/libs/1_66_0/libsh/doc/htmlh_toolkit/double_exponential/de_caveats.html)
     */
    if (b <= 0.0) {
      auto f_wrap = [&](double x) {
