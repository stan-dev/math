#ifndef STAN_MATH_PRIM_FUNCTOR_INTEGRATE_ODE_CKRK_HPP
#define STAN_MATH_PRIM_FUNCTOR_INTEGRATE_ODE_CKRK_HPP
...
inline auto integrate_ode_ckrk(
  ...
  auto y = ode_ckrk_tol_impl("integrate_ode_ckrk", f_adapted, to_vector(y0), t0,
