...
partially_forward_as_tuple(Types&&... args) noexcept(((std::is_rvalue_reference_v<Types&&> || (std::is_rvalue_reference_v<Types&&> && std::is_nothrow_constructible_v<std::decay_t<Types>, Types&&>)) && ...)) {
