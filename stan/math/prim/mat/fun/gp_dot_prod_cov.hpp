...
#include <vector>
// using enable if metaprogramming
...
// template <typename T>
// //  inline typename stan::return_type<T>::type
// typename enable_if_c<is_scalar<T>>
// dummy_fun(std::vector<T> &x){
//   return x[0];
// }
