 ...
 */
template <int R, int C, typename T1, typename T2, typename = enable_if_all_arithmetic<T1, T2>>
inline Eigen::Matrix<return_type_t<T1, T2>, R, C> multiply(const Eigen::Matrix<T1, R, C>& m, T2 c) {
  return c * m;
}
 ...
 */
template <int R, int C, typename T1, typename T2, typename = enable_if_all_arithmetic<T1, T2>>
inline Eigen::Matrix<return_type_t<T1, T2>, R, C> multiply(T1 c, const Eigen::Matrix<T2, R, C>& m) {
  return c * m;
}
 ...
 */
template <int R1, int C1, int R2, int C2, typename T1, typename T2, typename = enable_if_all_arithmetic<T1, T2>>
inline Eigen::Matrix<return_type_t<T1, T2>, R1, C2> multiply(
    const Eigen::Matrix<T1, R1, C1>& m1,
 ...
 */
template <int C1, int R2, typename T1, typename T2, typename = enable_if_all_arithmetic<T1, T2>>
