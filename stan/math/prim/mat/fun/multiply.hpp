...
template <
    ...
    enable_if_all_arithmetic<scalar_type_t<T1>, scalar_type_t<T2>>* = nullptr,
 ...
 */
template <typename T1, typename T2, enable_if_any_eigen<T1, T2>* = nullptr,
          enable_if_any_stan_scalar<T1, T2>* = nullptr,
          enable_if_any_not_contains_var<T1, T2>* = nullptr>
inline auto multiply(const T1& m1, const T2& m2) {
  return m1 * m2;
}
...
template <typename T1, typename T2, enable_if_all_not_eigen<T1, T2>* = nullptr,
          enable_if_all_stan_scalar<T1, T2>* = nullptr,
          enable_if_any_not_contains_var<T1, T2>* = nullptr>
inline auto multiply(const T1& m1, const T2& m2) {
  return m1 * m2;
}
...
template <typename T1, typename T2, enable_if_any_eigen<T1, T2>* = nullptr,
          ...
          enable_if_all_not_contains_var<T1, T2>* = nullptr>
inline auto multiply(const T1& m1, const T2& m2) {
