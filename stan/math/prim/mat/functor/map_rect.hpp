 ...
 * parallelism using MPI. The MPI version is only available if
 * STAN_MPI is defined. For the MPI version to work this function has
 * these special non-standard conventions:
 *
