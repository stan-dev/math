...
namespace stan {
  namespace math {
    ...
    class mpi_parallel_call {
      ...
      // initialized on root
      Eigen::Matrix<T_shared_param, Eigen::Dynamic, 1>* eta_;
      Eigen::Matrix<T_param, Eigen::Dynamic, Eigen::Dynamic>* theta_;
    ...
    public:
      ...
      typename CombineF::result_t reduce() {
    ...
    struct simple_combine {
      typedef result_t Eigen::VectorXd;
