...
template <typename... Types>
using enable_if_all_not_std_vector = enable_if_all_not<is_std_vector_decay<Types>...>;

template <typename... Types>
using enable_if_any_not_std_vector = enable_if_any_not<is_std_vector_decay<Types>...>;
...
template <typename T>
struct is_eigen_or_stan_scalar: std::integral_constant<bool, is_eigen_decay<T>::value || is_stan_scalar<T>::value> {};

template <typename T>
using enable_if_eigen_or_stan_scalar = std::enable_if_t<is_eigen_or_stan_scalar<T>::value>;

template <typename T>
using enable_if_not_eigen_or_stan_scalar = enable_if_not<is_eigen_or_stan_scalar<T>>;
...
template <typename... Types>
using enable_if_all_not_eigen_or_stan_scalar = enable_if_all_not<is_eigen_or_stan_scalar<Types>...>;

template <typename... Types>
using enable_if_any_not_eigen_or_stan_scalar = enable_if_any_not<is_eigen_or_stan_scalar<Types>...>;


// Checks if type is Eigen scalar type is arithmetic
template <typename T>
struct is_eigen_arithmetic: std::integral_constant<bool, is_eigen_decay<T>::value && is_contains_arithmetic<T>::value> {};
...
template <typename... Types>
using enable_if_all_not_eigen_arithmetic = enable_if_all_not<is_eigen_arithmetic<Types>...>;

template <typename... Types>
using enable_if_any_not_eigen_arithmetic = enable_if_any_not<is_eigen_arithmetic<Types>...>;
...
template <typename... Types>
using enable_if_all_not_eigen_col_vector = enable_if_all_not<is_eigen_col_vector<Types>...>;

template <typename... Types>
using enable_if_any_not_eigen_col_vector = enable_if_any_not<is_eigen_col_vector<Types>...>;
...
template <typename... Types>
using enable_if_all_not_eigen_row_vector = enable_if_all_not<is_eigen_row_vector<Types>...>;

template <typename... Types>
using enable_if_any_not_eigen_row_vector = enable_if_any_not<is_eigen_row_vector<Types>...>;
...
template <typename... Types>
using enable_if_all_not_eigen_vector = enable_if_all_not<is_eigen_vector<Types>...>;

template <typename... Types>
using enable_if_any_not_eigen_vector = enable_if_any_not<is_eigen_vector<Types>...>;

// Check whether Eigen types satisfy a dot product
template <typename T1, typename T2>
struct is_dot_product
    : std::integral_constant<bool,
                             is_eigen_row_vector<T1>::value &&
...
namespace internal {
    ...
    template<class T1, class T2, bool = is_eigen_decay<T1>::value && is_eigen_decay<T2>::value>
...
template <typename T1, typename T2>
using enable_if_not_eigen_rows_match = enable_if_not<is_eigen_rows_match<T1, T2>>;
...
template <typename T1, typename T2>
using enable_if_not_eigen_cols_match = enable_if_not<is_eigen_cols_match<T1, T2>>;

// primary template for checking if eigen matrix cols match
template<class T1, class T2>
struct is_eigen_dims_match : std::integral_constant<bool,
  is_eigen_cols_match<T1, T2>::value && is_eigen_rows_match<T1, T2>::value> {};

template <typename T1, typename T2>
using enable_if_eigen_dims_match = std::enable_if_t<is_eigen_dims_match<T1, T2>::value>;

template <typename T1, typename T2>
using enable_if_not_eigen_dims_match = enable_if_not<is_eigen_dims_match<T1, T2>>;
