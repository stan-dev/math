...
namespace internal {
    ...
    struct is_eigen_col_vector_impl : std::integral_constant<bool, T::ColsAtCompileTime == 1> {};
...
namespace internal {
    ...
    template<class T, bool = is_eigen_decay<T>::value>
    struct is_eigen_row_vector_impl : std::integral_constant<bool, T::RowsAtCompileTime == 1> {};
