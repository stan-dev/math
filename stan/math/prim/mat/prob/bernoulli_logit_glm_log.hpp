...
template <bool propto, typename T_n, typename T_x, typename T_beta,
          typename T_alpha>
typename return_type<T_x, T_beta, T_alpha>::type bernoulli_logit_glm_log(
    const T_n &n, const T_x &x, const T_beta &beta, const T_alpha &alpha) {
  return bernoulli_logit_glm_lpmf<propto, T_n, T_x, T_beta, T_alpha>(n, x, beta,
                                                                     alpha);
}
...
inline typename return_type<T_x, T_beta, T_alpha>::type bernoulli_logit_glm_log(
    const T_n &n, const T_x &x, const T_beta &beta, const T_alpha &alpha) {
