...
namespace stan {
  namespace math {
    ...
    typename return_type<T_x, T_beta, T_alpha>::type bernoulli_logit_glm_lpmf(
      ...
      typedef
          typename stan::partials_return_type<T_n, T_x, T_beta, T_alpha>::type
              T_partials_return;
      ...
      if (!include_summand<propto, T_x, T_beta, T_alpha>::value) return 0.0;
      ...
      if (!(is_constant_struct<T_x>::value &&
        ...
        if (!is_constant_struct<T_x>::value) {
          ops_partials.edge1_.partials_ =
              theta_derivative * beta_dbl.transpose();
        }
