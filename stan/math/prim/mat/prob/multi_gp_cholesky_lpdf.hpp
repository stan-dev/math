...
namespace stan {
  namespace math {
     ...
     * have a scaled kernel matrix with a different scale for each output
     * dimension. This distribution is equivalent to: for (i in 1:d) row(y, i) ~
     * multi_normal(0, (1/w[i])*LL').
     *
