#ifndef STAN_MATH_PRIM_MAT_PROB_NORMAL_LINEAR_GLM_LPDF_HPP
#define STAN_MATH_PRIM_MAT_PROB_NORMAL_LINEAR_GLM_LPDF_HPP
...
namespace stan {
  namespace math {
     ...
     * with Normal distribution and linear link function.
    ...
    normal_linear_glm_lpdf(const T_n &n, const T_x &x, const T_beta &beta,
                             const T_alpha &alpha, const T_scale& sigma) {
      static const std::string function = "normal_linear_glm_lpdf";
    ...
    inline
        ...
        normal_linear_glm_lpdf(const T_n &n, const T_x &x, const T_beta &beta,
                                 const T_alpha &alpha, const T_scale& sigma) {
      return normal_linear_glm_lpdf<false>(n, x, beta, alpha, sigma);
    }
  }  // namespace math
}  // namespace stan
#endif
