 ...
 */
template <bool propto, typename T_y, typename T_x_scalar, typename T_beta,
          typename T_cuts>
...
ordered_logistic_glm_lpmf(
  ...
  operands_and_partials<Matrix<T_x_scalar, Dynamic, Dynamic>, T_beta, T_cuts>
      ops_partials(x, beta, cuts);
  if (!is_constant_struct<T_x_scalar>::value
      || !is_constant_struct<T_beta>::value
      || !is_constant_struct<T_cuts>::value) {
...
typename stan::return_type<T_x, T_beta, T_cuts>::type ordered_logistic_glm_lpmf(
