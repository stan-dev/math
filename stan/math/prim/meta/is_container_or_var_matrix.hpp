...
// general_types);
template <typename T>
using require_container_or_var_matrix_t
    = require_t<is_container_or_var_matrix<std::decay_t<T>>>;
...
using require_container_or_var_matrix_vt
    = require_t<container_type_check_base<is_container_or_var_matrix,
                                          value_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_not_container_or_var_matrix_vt
    = require_not_t<container_type_check_base<
        is_container_or_var_matrix, value_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_any_container_or_var_matrix_vt
    = require_any_t<container_type_check_base<
        is_container_or_var_matrix, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_any_not_container_or_var_matrix_vt
    = require_any_not_t<container_type_check_base<
        is_container_or_var_matrix, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_container_or_var_matrix_vt
    = require_all_t<container_type_check_base<
        is_container_or_var_matrix, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_not_container_or_var_matrix_vt
    = require_all_not_t<container_type_check_base<
        is_container_or_var_matrix, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_container_or_var_matrix_st
    = require_t<container_type_check_base<is_container_or_var_matrix,
                                          scalar_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_not_container_or_var_matrix_st
    = require_not_t<container_type_check_base<
        is_container_or_var_matrix, scalar_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_any_container_or_var_matrix_st
    = require_any_t<container_type_check_base<
        is_container_or_var_matrix, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_any_not_container_or_var_matrix_st
    = require_any_not_t<container_type_check_base<
        is_container_or_var_matrix, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_container_or_var_matrix_st
    = require_all_t<container_type_check_base<
        is_container_or_var_matrix, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_not_container_or_var_matrix_st
    = require_all_not_t<container_type_check_base<
        is_container_or_var_matrix, scalar_type_t, TypeCheck, Check>...>;
