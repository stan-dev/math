...
using require_eigen_sparse_base_vt
    = require_t<container_type_check_base<is_eigen_sparse_base, value_type_t,
                                          TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_not_eigen_sparse_base_vt
    = require_not_t<container_type_check_base<
        is_eigen_sparse_base, value_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_any_eigen_sparse_base_vt
    = require_any_t<container_type_check_base<
        is_eigen_sparse_base, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_any_not_eigen_sparse_base_vt
    = require_any_not_t<container_type_check_base<
        is_eigen_sparse_base, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_eigen_sparse_base_vt
    = require_all_t<container_type_check_base<
        is_eigen_sparse_base, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_not_eigen_sparse_base_vt
    = require_all_not_t<container_type_check_base<
        is_eigen_sparse_base, value_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_eigen_sparse_base_st
    = require_t<container_type_check_base<is_eigen_sparse_base, scalar_type_t,
                                          TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_not_eigen_sparse_base_st
    = require_not_t<container_type_check_base<
        is_eigen_sparse_base, scalar_type_t, TypeCheck, Check...>>;

template <template <class...> class TypeCheck, class... Check>
using require_any_eigen_sparse_base_st
    = require_any_t<container_type_check_base<
        is_eigen_sparse_base, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_any_not_eigen_sparse_base_st
    = require_any_not_t<container_type_check_base<
        is_eigen_sparse_base, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_eigen_sparse_base_st
    = require_all_t<container_type_check_base<
        is_eigen_sparse_base, scalar_type_t, TypeCheck, Check>...>;

template <template <class...> class TypeCheck, class... Check>
using require_all_not_eigen_sparse_base_st
    = require_all_not_t<container_type_check_base<
        is_eigen_sparse_base, scalar_type_t, TypeCheck, Check>...>;
