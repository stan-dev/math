...
template <typename T>
using require_prim_or_rev_kernel_expression_t
    = require_t<is_prim_or_rev_kernel_expression<std::decay_t<T>>>;
...
template <typename... Types>
using require_all_not_prim_or_rev_kernel_expression_t = require_all_not_t<
    is_prim_or_rev_kernel_expression<std::decay_t<Types>>...>;

template <typename... Types>
using require_any_not_prim_or_rev_kernel_expression_t = require_any_not_t<
    is_prim_or_rev_kernel_expression<std::decay_t<Types>>...>;
