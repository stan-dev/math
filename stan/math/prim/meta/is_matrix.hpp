#ifndef STAN_MATH_PRIM_META_IS_MATRIX
#define STAN_MATH_PRIM_META_IS_MATRIX
...
namespace stan {
   ...
   */
  template <typename T>
  struct is_matrix : bool_constant<math::disjunction<is_rev_matrix<T>, is_eigen<T>>::value> {};
