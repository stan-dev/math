...
/*! @tparam Check The type to test @ref is_matrix_cl for and whose @ref value_type is checked with `TypeCheck` */  
...
/*! @tparam Check The type to test @ref is_matrix_cl for and whose @ref scalar_type is checked with `TypeCheck` */  
template <template <class...> class TypeCheck, class... Check>
