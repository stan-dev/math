...
template <typename... Types>
using require_all_not_vt_var_dense_dynamic = require_all_not_t<
    is_var_dense_dynamic<value_type_t<std::decay_t<Types>>>...>;

template <typename... Types>
using require_any_not_vt_var_dense_dynamic = require_any_not_t<
    is_var_dense_dynamic<value_type_t<std::decay_t<Types>>>...>;
...
template <typename... Types>
using require_all_st_var_dense_dynamic = require_all_t<
    is_var_dense_dynamic<scalar_type_t<std::decay_t<Types>>>...>;

template <typename... Types>
using require_any_st_var_dense_dynamic = require_any_t<
    is_var_dense_dynamic<scalar_type_t<std::decay_t<Types>>>...>;

template <typename... Types>
using require_all_not_st_var_dense_dynamic = require_all_not_t<
    is_var_dense_dynamic<scalar_type_t<std::decay_t<Types>>>...>;

template <typename... Types>
using require_any_not_st_var_dense_dynamic = require_any_not_t<
    is_var_dense_dynamic<scalar_type_t<std::decay_t<Types>>>...>;
