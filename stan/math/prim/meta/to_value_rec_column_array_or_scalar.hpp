#ifndef STAN_MATH_PRIM_META_TO_VALUE_REC_COLUMN_ARRAY_OR_SCALAR_HPP
#define STAN_MATH_PRIM_META_TO_VALUE_REC_COLUMN_ARRAY_OR_SCALAR_HPP
...
namespace math {
  ...
  inline auto to_value_rec_column_array_or_scalar(const T& a) {
    return value_of_rec(a);
  }
  ...
  inline auto to_value_rec_column_array_or_scalar(T&& a) {
    return value_of_rec(std::forward<T>(a).array());
  }
  ...
  inline auto to_value_rec_column_array_or_scalar(T&& a) {
    return make_holder([](auto&& x) { return value_of_rec(std::forward<decltype(x)>(x)).transpose().array(); }, std::forward<T>(a));
  }
  ...
  inline auto to_value_rec_column_array_or_scalar(T&& a) {
    ...
    return make_holder([](auto& x) { return value_of_rec(T_map(x.data(), x.size())); },
                       std::forward<T>(a));
  }
