#ifndef STAN_MATH_PRIM_PROB_DOUBLE_EXPONENTIAL_LOG_HPP
#define STAN_MATH_PRIM_PROB_DOUBLE_EXPONENTIAL_LOG_HPP

#include <stanh/prim/meta/return_type.hpp>
#include <stanh/prim/prob/double_exponential_lpdf.hpp>
