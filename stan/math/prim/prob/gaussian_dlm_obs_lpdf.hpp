...
#include <stanh/prim/err/check_cov_matrix.hpp>
#include <stanh/prim/err/check_size_match.hpp>
#include <stanh/prim/err/check_spsd_matrix.hpp>
...
#include <stanh/prim/fun/add.hpp>
#include <stanh/prim/fun/dot_product.hpp>
#include <stanh/prim/fun/inverse_spd.hpp>
#include <stanh/prim/fun/log.hpp>
#include <stanh/prim/fun/log_determinant_spd.hpp>
#include <stanh/prim/fun/multiply.hpp>
#include <stanh/prim/fun/quad_form.hpp>
#include <stanh/prim/fun/quad_form_sym.hpp>
#include <stanh/prim/fun/subtract.hpp>
#include <stanh/prim/fun/tcrossprod.hpp>
#include <stanh/prim/fun/trace_quad_form.hpp>
#include <stanh/prim/fun/transpose.hpp>
