...
#include <stanh/prim/err/check_ldlt_factor.hpp>
#include <stanh/prim/err/check_symmetric.hpp>
#include <stanh/prim/fun/columns_dot_product.hpp>
#include <stanh/prim/fun/columns_dot_self.hpp>
#include <stanh/prim/fun/dot_product.hpp>
#include <stanh/prim/fun/dot_self.hpp>
#include <stanh/prim/fun/log_determinant_ldlt.hpp>
#include <stanh/prim/fun/log.hpp>
#include <stanh/prim/fun/log_determinant.hpp>
#include <stanh/prim/fun/mdivide_left_spd.hpp>
#include <stanh/prim/fun/mdivide_left_tri_low.hpp>
#include <stanh/prim/fun/multiply.hpp>
#include <stanh/prim/fun/subtract.hpp>
#include <stanh/prim/fun/sum.hpp>
#include <stanh/prim/fun/trace_quad_form.hpp>
#include <stanh/prim/meta/vector_seq_view.hpp>
#include <stanh/prim/err/check_size_match.hpp>
...
#include <stanh/prim/meta/max_size_mvt.hpp>
