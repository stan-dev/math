#ifndef STAN_MATH_PRIM_PROB_ORDERED_LOGISTIC_LOG_HPP
#define STAN_MATH_PRIM_PROB_ORDERED_LOGISTIC_LOG_HPP

#include <stanh/prim/prob/ordered_logistic_lpmf.hpp>
