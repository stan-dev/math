...
#include <stanh/prim/fun/size.hpp>
...
#include <stanh/prim/fun/log_inv_logit_diff.hpp>
#include <stanh/prim/fun/is_integer.hpp>
#include <stanh/prim/err/domain_error_vec.hpp>
