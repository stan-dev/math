#ifndef STAN_MATH_PRIM_PROB_SCALED_INV_CHI_SQUARE_LOG_HPP
#define STAN_MATH_PRIM_PROB_SCALED_INV_CHI_SQUARE_LOG_HPP

#include <stanh/prim/meta/return_type.hpp>
#include <stanh/prim/probed_inv_chi_square_lpdf.hpp>
