#ifndef STAN_MATH_PRIM_PROB_SKEW_DOUBLE_EXPONENTIAL_CDF_LOG_HPP
#define STAN_MATH_PRIM_PROB_SKEW_DOUBLE_EXPONENTIAL_CDF_LOG_HPP
...
skew_double_exponential_cdf_log(const T_y& y, const T_loc& mu,
  ...
  return skew_double_exponential_lcdf<T_y, T_loc, T_scale, T_skewness>(
      y, mu, sigma, tau);
}
