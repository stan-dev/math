...
inline void check_consistent_sizes(const std::string& function,
                                   const std::string& name1, const T1& x1,
                                   const std::string& name2, const T2& x2) {
...
inline void check_consistent_sizes(const std::string& function,
                                   const std::string& name1, const T1& x1,
                                   const std::string& name2, const T2& x2,
                                   const std::string& name3, const T3& x3) {
  size_t max_size = std::max(is_vector<T1>::value * size_of(x1),
...
inline void check_consistent_sizes(const std::string& function,
                                   ...
                                   const std::string& name2, const T2& x2,
                                   const std::string& name3, const T3& x3,
                                   const std::string& name4, const T4& x4) {
  size_t max_size =
...
inline void check_consistent_sizes(const std::string& function,
                                   ...
                                   const std::string& name3, const T3& x3,
                                   const std::string& name4, const T4& x4,
                                   const std::string& name5, const T5& x5) {
