...
inline void check_consistent_sizes(const char* function, const char* name1,
                                   ...
                                   const T2& x2) {
  size_t max_size = std::max(is_vector<T1>::value * stan::size(x1),
                             is_vector<T2>::value * stan::size(x2));
...
inline void check_consistent_sizes(const char* function, const char* name1,
                                   ...
                                   const T3& x3) {
  size_t max_size = std::max(is_vector<T1>::value * stan::size(x1),
                             std::max(is_vector<T2>::value * stan::size(x2),
                                      is_vector<T3>::value * stan::size(x3)));
  check_consistent_size(function, name1, x1, max_size);
  check_consistent_size(function, name2, x2, max_size);
...
inline void check_consistent_sizes(const char* function, const char* name1,
                                   ...
                                   const T4& x4) {
  size_t max_size
      = std::max(is_vector<T1>::value * stan::size(x1),
                 std::max(is_vector<T2>::value * stan::size(x2),
                          std::max(is_vector<T3>::value * stan::size(x3),
                                   is_vector<T4>::value * stan::size(x4))));
  check_consistent_size(function, name1, x1, max_size);
  check_consistent_size(function, name2, x2, max_size);
  check_consistent_size(function, name3, x3, max_size);
...
inline void check_consistent_sizes(const char* function, const char* name1,
  ...
  size_t max_size = std::max(
      stan::size(x1),
      std::max(stan::size(x2), std::max(stan::size(x3), std::max(stan::size(x4), stan::size(x5)))));
  check_consistent_size(function, name1, x1, max_size);
  check_consistent_size(function, name2, x2, max_size);
  check_consistent_size(function, name3, x3, max_size);
  check_consistent_size(function, name4, x4, max_size);
