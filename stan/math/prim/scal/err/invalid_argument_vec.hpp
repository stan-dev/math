...
namespace stan {
  namespace math {
    ...
    /**
     * Throw an invalid argument exception with a consistently formatted
     * message.
     *
    ...
    inline void invalid_argument_vec(const std::string& function,
                                     const std::string& name, const T& y,
                                     size_t i, const std::string& msg1,
