 ...
 */
template <class R, class TH,
          class RT = typename stan::return_type<stan::rm_zeroing_t<R>,
                                                stan::rm_zeroing_t<TH>>::type,
          std::enable_if_t<!std::is_same<R, TH>::value>* = nullptr>
inline std::complex<RT> polar(R const& r, TH const& theta) {
