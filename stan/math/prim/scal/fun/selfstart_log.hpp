#ifndef STAN_MATH_PRIM_SCAL_FUN_SELFSTART_LOG_HPP
#define STAN_MATH_PRIM_SCAL_FUN_SELFSTART_LOG_HPP
...
namespace stan {
  ...
  namespace math {
    ...
    selfstart_log(const std::vector<T1>& x, const T2& Asym, const T3& xmid,
                  const T4& scal) {

      return selfstart_four_param_log(x, 0, Asym, xmid, scal);
