...
struct contains_nonconstant_struct {
  enum {
    value = !is_constant_struct<T1>::value || !is_constant_struct<T2>::value ||
            !is_constant_struct<T3>::value || !is_constant_struct<T4>::value ||
            !is_constant_struct<T5>::value || !is_constant_struct<T6>::value
  };
};
