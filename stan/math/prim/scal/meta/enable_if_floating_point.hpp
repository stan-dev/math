...
using enable_if_any_not_floating_point = std::enable_if_t<
    ...
    template <typename... Types>
    using all_floating_point_type = enable_if_all_floating_point<std::decay_t<Types>...>;

    template <typename... Types>
    using any_floating_point_type = enable_if_any_floating_point<std::decay_t<Types>...>;

    template <typename... Types>
    using not_all_floating_point_type = enable_if_all_not_floating_point<std::decay_t<Types>...>;

    template <typename... Types>
    using not_any_floating_point_type = enable_if_any_not_floating_point<std::decay_t<Types>...>;
