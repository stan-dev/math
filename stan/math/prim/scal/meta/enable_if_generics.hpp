...
using enable_if_all_not_arithmetic
    = enable_if_all_not<is_arithmetic_decay<Types>...>;

template <typename... Types>
using enable_if_any_not_arithmetic
    = enable_if_any_not<is_arithmetic_decay<Types>...>;
...
template <typename T>
using enable_if_not_contains_arithmetic
    = enable_if_not<is_contains_arithmetic<T>>;
...
template <typename... Types>
using enable_if_all_not_contains_arithmetic
    = enable_if_all_not<is_contains_arithmetic<Types>...>;

template <typename... Types>
using enable_if_any_not_contains_arithmetic
    = enable_if_any_not<is_contains_arithmetic<Types>...>;
...
template <typename... Types>
using enable_if_all_not_floating_point
    = enable_if_all_not<is_fp_decay<Types>...>;

template <typename... Types>
using enable_if_any_not_floating_point
    = enable_if_any_not<is_fp_decay<Types>...>;
...
template <typename T>
using enable_if_not_contains_floating_point
    = enable_if_not<is_contains_floating_point<T>>;
...
template <typename... Types>
using enable_if_all_not_contains_floating_point
    = enable_if_all_not<is_contains_floating_point<Types>...>;

template <typename... Types>
using enable_if_any_not_contains_floating_point
    = enable_if_any_not<is_contains_floating_point<Types>...>;
...
template <typename... Types>
using enable_if_all_not_contains_var
    = enable_if_all_not<is_contains_var<Types>...>;

template <typename... Types>
using enable_if_any_not_contains_var
    = enable_if_any_not<is_contains_var<Types>...>;
...
template <typename... Types>
using enable_if_all_not_contains_fvar
    = enable_if_all_not<is_contains_fvar<Types>...>;

template <typename... Types>
using enable_if_any_not_contains_fvar
...
template <typename T>
using enable_if_not_ad_type = enable_if_not<is_ad_type<std::decay<T>>>;
...
using enable_if_all_not_contains_ad_type
    = enable_if_all_not<is_contains_ad_type<Types>...>;
...
using enable_if_all_not_var_or_arithmetic
    = enable_if_all_not<is_var_or_arithmetic<Types>...>;

template <typename... Types>
using enable_if_any_not_var_or_arithmetic
    = enable_if_any_not<is_var_or_arithmetic<Types>...>;
...
template <typename T>
using enable_if_not_contains_var_or_arithmetic
    = enable_if_not<is_contains_var_or_arithmetic<T>>;
...
template <typename... Types>
using enable_if_all_not_contains_var_or_arithmetic
    = enable_if_all_not<is_contains_var_or_arithmetic<Types>...>;

template <typename... Types>
using enable_if_any_not_contains_var_or_arithmetic
    = enable_if_any_not<is_contains_var_or_arithmetic<Types>...>;
...
template <typename... Types>
using enable_if_all_not_stan_scalar
    = enable_if_all_not<is_stan_scalar<Types>...>;

template <typename... Types>
using enable_if_any_not_stan_stan_scalar
    = enable_if_any_not<is_stan_scalar<Types>...>;
...
template <typename... Types>
using enable_if_all_not_contains_stan_scalar
    = enable_if_all<is_contains_stan_scalar<Types>...>;

template <typename... Types>
using enable_if_any_not_stan_contains_stan_scalar
    = enable_if_any<is_contains_stan_scalar<Types>...>;
