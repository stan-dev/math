...
using enable_if_all_same = std::enable_if_t<math::conjunction<
    std::is_same<std::decay_t<T>, std::decay_t<Types>>...>::value>;

template <typename T, typename... Types>
using enable_if_all_not_same = std::enable_if_t<!math::conjunction<
    std::is_same<std::decay_t<T>, std::decay_t<Types>>...>::value>;
