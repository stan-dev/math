...
struct is_eigen_col_vector_impl : std::integral_constant<bool, T::RowsAtCompileTime == 1> {};

template <typename T>
struct is_eigen_col_vector_impl<T, false> : std::false_type {};

template <typename T, bool = is_eigen<T>::value>
struct is_eigen_row_vector_impl : std::integral_constant<bool, T::ColsAtCompileTime == 1> {};
...
template <typename T>
struct is_eigen_vector : std::integral_constant<bool, is_eigen_col_vector<T>::value || is_eigen_row_vector<T>::value> {};
