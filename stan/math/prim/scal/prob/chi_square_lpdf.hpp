...
namespace stan {
  namespace math {
    ...
    typename return_type<T_y, T_dof>::type chi_square_lpdf(const T_y& y,
      ...
      if (!include_summand<propto, T_y, T_dof>::value) return 0.0;
      ...
      for (size_t n = 0; n < N; n++) {
        ...
        if (include_summand<propto, T_y>::value) logp -= half_y;
    ...
    inline typename return_type<T_y, T_dof>::type chi_square_lpdf(
