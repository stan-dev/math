...
namespace stan {
  namespace math {
     ...
     * @throw std::domain_error if y is nan, mu is infinite, or sigma is
     * nonpositive
    ...
    typename return_type<T_y, T_loc, T_scale>::type double_exponential_lpdf(
      ...
      check_consistent_sizes(function, "Random variable", y,
                             "Location parameter", mu, "Shape parameter",
                             sigma);
      ...
      VectorBuilder<!is_constant_struct<T_scale>::value, T_partials_return,
                    T_scale>
      ...
      for (size_t n = 0; n < N; n++) {
        ...
        if (include_summand<propto>::value) logp += NEG_LOG_TWO;
