...
namespace stan {
  namespace math {
    ...
    pareto_type_2_lcdf(const T_y& y, const T_loc& mu,
      ...
      for (size_t n = 0; n < N; n++) {
        ...
        if (!is_constant_struct<T_y>::value)
          ops_partials.edge1_.partials[n] += grad_1_2;
        if (!is_constant_struct<T_loc>::value)
          ops_partials.edge2_.partials[n] -= grad_1_2;
        if (!is_constant_struct<T_scale>::value)
          ops_partials.edge3_.partials[n] += (mu_dbl - y_dbl) * grad_1_2
            / lambda_dbl;
        if (!is_constant_struct<T_shape>::value)
