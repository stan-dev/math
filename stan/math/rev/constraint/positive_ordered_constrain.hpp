#ifndef STAN_MATH_REV_CONSTRAINT_POSITIVE_ORDERED_CONSTRAIN_HPP
#define STAN_MATH_REV_CONSTRAINT_POSITIVE_ORDERED_CONSTRAIN_HPP
 ...
 */
template <typename T, require_rev_col_vector_t<T>* = nullptr, require_not_std_vector_t<T>* = nullptr>
