...
namespace stan {
  namespace math {
    ...
    protected:
      ...
      double dotval_;
      size_t length_;
      inline static double eval_gevv(const var* alpha, const var* v1,
                                     int stride1, const var* v2, int stride2,
    ...
    public:
      gevv_vvv_vari(const var* alpha, const var* v1, int stride1, const var* v2,
        ...
        v2_ = v1_ + length_;
        for (size_t i = 0; i < length_; i++) v1_[i] = v1[i * stride1].vi_;
        for (size_t i = 0; i < length_; i++) v2_[i] = v2[i * stride2].vi_;
      }
