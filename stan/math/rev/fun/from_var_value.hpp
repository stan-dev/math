...
/**
 * Converts \ref stan::math::var_value into an Eigen Matrix. Adjoint is
 * propagated back to argument in the reverse pass.
 *
...
/**
 * Convert the elements of the `std::vector` input to \ref stan::math::var_value
 * types if possible
 *
