 ...
 */
template <typename T, typename... Types, require_eigen_vt<std::is_arithmetic, T>* = nullptr, require_any_var_matrix_t<T, Types...>* = nullptr>
inline auto identity_constrain(T&& x, Types&&... args) {
  return var_value<plain_type_t<T>>(x);
}

template <typename T, typename... Types, require_eigen_vt<is_var, T>* = nullptr, require_any_var_matrix_t<T, Types...>* = nullptr>
inline auto identity_constrain(T&& x, Types&&... args) {
  return to_var_value(x);
}

template <typename T, typename... Types, require_var_matrix_t<T>* = nullptr, require_any_var_matrix_t<T, Types...>* = nullptr>
inline auto identity_constrain(T&& x, Types&&... args) {
  return x;
}
