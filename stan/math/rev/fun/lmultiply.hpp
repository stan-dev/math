...
inline auto lmultiply(const RevMat1& a, const RevMat2& b) {
...
inline auto lmultiply(const RevMat1& a, const Scalar2& b) {
  using std::log;
...
inline auto lmultiply(const Scalar1& a, const RevMat2& b) {
