#ifndef STAN_MATH_REV_FUN_LOG_RISING_FACTORIAL_HPP
#define STAN_MATH_REV_FUN_LOG_RISING_FACTORIAL_HPP
...
inline var log_rising_factorial(var a, double b) {
  return var(new internal::log_rising_factorial_vd_vari(a.vi_, b));
}

inline var log_rising_factorial(var a, var b) {
  return var(new internal::log_rising_factorial_vv_vari(a.vi_, b.vi_));
}

inline var log_rising_factorial(double a, var b) {
