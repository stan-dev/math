#ifndef STAN_MATH_REV_FUN_MODIFIED_BESSEL_SECOND_KIND_HPP
#define STAN_MATH_REV_FUN_MODIFIED_BESSEL_SECOND_KIND_HPP
...
inline var modified_bessel_second_kind(int v, var a) {
