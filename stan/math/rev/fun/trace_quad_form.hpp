...
class trace_quad_form_vari_alloc : public chainable_alloc {
 public:
  trace_quad_form_vari_alloc(EigMatL&& A,
                             EigMatR&& B)
...
class trace_quad_form_vari : public vari {
 protected:
  ...
  template <typename EigMatB, typename EigMatAd, typename EigMatBd,
   require_all_eigen_vt<std::is_arithmetic, EigMatB, EigMatAd, EigMatBd>* = nullptr>
  static inline void chainB(EigMatB&& B, EigMatAd&& Ad, EigMatBd&& Bd, double adjC) {}
  ...
  template <typename EigMatA, typename EigMatB, typename EigMatAd, typename EigMatBd,
    require_all_eigen_t<EigMatA, EigMatB>* = nullptr,
    require_all_eigen_vt<std::is_arithmetic, EigMatAd, EigMatBd>* = nullptr>
  inline void chainAB(EigMatA&& A, EigMatB&& B, EigMatAd&& Ad, EigMatBd&& Bd, double adjC) {
    chainA(A, Bd, adjC);
    chainB(B, Ad, Bd, adjC);
  }
...
inline auto trace_quad_form(EigMatL&& A, EigMatR& B) {
  ...
  auto* baseVari = new internal::trace_quad_form_vari_alloc<EigMatL, EigMatR>(std::forward<EigMatL>(A), std::forward<EigMatR>(B));
