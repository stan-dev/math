...
template <typename T>
vector<int> logical_eq(const vector<T>& vector, T scalar) {
...
template <typename T>
vector<int> logical_lt(const vector<T>& vector, T scalar) {
    vector<int> result(vec.size());
    for (size_t i = 0; i < vector.size(); i++) 
      {
        result[i] = (vector[i] < scalar);  
...
template <typename T>
vector<int> logical_gt(const vector<T>& vector, T scalar) {
    vector<int> result(vec.size());
    for (size_t i = 0; i < vector.size(); i++) 
      {
        result[i] = (vector[i] > scalar);  
...
template <typename T>
vector<int> logical_leq(const vector<T>& vector, T scalar) {
    vector<int> result(vec.size());
    for (size_t i = 0; i < vector.size(); i++) 
      {
        result[i] = (vector[i] <= scalar);  
...
template <typename T>
vector<int> logical_geq(const vector<T>& vector, T scalar) {
    vector<int> result(vec.size());
    for (size_t i = 0; i < vector.size(); i++) 
      {
        result[i] = (vector[i] >= scalar);  
...
template <typename T>
vector<int> logical_not(const vector<T>& vector) {
    vector<int> result(vector.size());
    for (size_t i = 0; i < vector.size(); i++) 
      {
        result[i] = (vector[i] == 0);
      }
