 ...
 */
template <typename F>
inline void gradient(const F& f, const Eigen::Matrix<double, Eigen::Dynamic, 1>& x,
...
inline void gradient(const F& f, const EigVec& x, double& fx, InputIt first_grad_fx,
