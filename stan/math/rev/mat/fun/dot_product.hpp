 ...
 */
template <typename T1, int R1, int C1, typename T2, int R2, int C2, typename = enable_if_any_var<T1, T2>>
...
inline return_type_t<T1, T2> dot_product(const T1* v1, const T2* v2, size_t length) {
 ...
 */
template <typename T1, typename T2, typename = enable_if_any_var<T1, T2>>
inline return_type_t<T1, T2> dot_product(const std::vector<T1>& v1, const std::vector<T2>& v2) {
  check_matching_sizes("dot_product", "v1", v1, "v2", v2);
