 ...
 public:
  ...
  gp_periodic_cov_vari(const std::vector<T_x> &x, const T_sigma &sigma,
      ...
      : vari(0.0),
        ...
        dist_(stack_mem.alloc_array<double>(
            size_ltri_)),
        sin_2_dist_(stack_mem.alloc_array<double>(
            size_ltri_)),
        sin_dist_sq_(stack_mem.alloc_array<double>(
            size_ltri_)),
        l_vari_(l.vi_),
        sigma_vari_(sigma.vi_),
        p_vari_(p.vi_),
        cov_lower_(stack_mem.alloc_array<vari *>(
            size_ltri_)),
        cov_diag_(
