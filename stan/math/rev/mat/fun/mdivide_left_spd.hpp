...
inline Eigen::Matrix<var, R1, C2> mdivide_left_spd(
  ...
  // arena allocator.
  auto *baseVari = new internal::mdivide_left_spd_vv_vari<R1, C1, R2, C2>(A, b);
...
inline Eigen::Matrix<var, R1, C2> mdivide_left_spd(
  ...
  // for the returned matrix.  Memory will be cleaned up with the
  // arena allocator.
  auto *baseVari = new internal::mdivide_left_spd_vd_vari<R1, C1, R2, C2>(A, b);
...
inline Eigen::Matrix<var, R1, C2> mdivide_left_spd(
  ...
  // for the returned matrix.  Memory will be cleaned up with the
  // arena allocator.
  auto *baseVari = new internal::mdivide_left_spd_dv_vari<R1, C1, R2, C2>(A, b);
