  ...
  namespace math {
    ...
    public:
      ...
      static int ode_rhs_sens(int Ns, realtype t, N_Vector y, N_Vector ydot,
        ...
        explicit_ode->rhs_sens(explicit_ode->y0_, explicit_ode->theta_, t,
                               y_vec, yS, ySdot);
        return 0;
      }
    ...
    private:
      ...
      /**
       * Calculate the sensitivity RHS for fixed initials and varying
       * parameters.
       *
      ...
      /**
       * Calculate the sensitivity RHS for varying initials and fixed
       * parameters.
       *
       * @param[in] initial var vector
