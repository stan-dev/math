#ifndef STAN_MATH_REV_MAT_FUNCTOR_INTEGRATE_ODE_BDF_ADJOINT_HPP
#define STAN_MATH_REV_MAT_FUNCTOR_INTEGRATE_ODE_BDF_ADJOINT_HPP
...
integrate_ode_bdf_adjoint(
    const F& f, const std::vector<T_initial>& y0, double t0,
  ...
  stan::math::cvodes_integrator<CV_BDF, 2> integrator;
