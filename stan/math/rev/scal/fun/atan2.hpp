...
namespace stan {
  namespace math {
     ...
     *
     * \f$ \frac{\partial}{\partial x} \arctan \frac{x}{y} = \frac{y}{x^2 +
     * y^2}\f$, and
     *
     ...
     *
     ...
     -\infty\leq y \leq \infty \\[6pt] \textrm{NaN} & \mbox{if } x = \textrm{NaN
     or } y = \textrm{NaN} \end{cases} \f]

       \f[
       \frac{\partial\, \mbox{atan2}(x, y)}{\partial x} =
       \begin{cases}
         \frac{y}{x^2+y^2} & \mbox{if } -\infty\leq x\leq \infty, -\infty\leq y
