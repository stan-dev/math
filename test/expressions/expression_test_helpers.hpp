...
template <typename T, require_arithmetic_t<T>* = nullptr>
void expect_eq(stan::math::complex<T> a, stan::math::complex<T> b, const char* msg) {
  expect_eq(a.real(), b.real(), msg);
  expect_eq(a.imag(), b.imag(), msg);
}

void expect_eq(stan::math::complex<math::var> a, stan::math::complex<math::var> b,
               const char* msg) {
  expect_eq(a.real(), b.real(), msg);
  expect_eq(a.imag(), b.imag(), msg);
}
...
template <typename T, require_arithmetic_t<T>* = nullptr>
void expect_eq(stan::math::complex<math::fvar<T>> a, stan::math::complex<math::fvar<T>> b,
               const char* msg) {
  expect_eq(a.real(), b.real(), msg);
  expect_eq(a.imag(), b.imag(), msg);
}
