...
typedef std::tuple<int, int, std::vector<double>, empty, empty, empty>
    type_v_int_int_real_1;
typedef std::tuple<int, int, Eigen::Matrix<double, Eigen::Dynamic, 1>, empty,
                   empty, empty>
    type_v_int_int_real_2;
