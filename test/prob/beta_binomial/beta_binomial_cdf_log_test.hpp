...
public:
  void valid_values(vector<vector<double>> &parameters,
    ...
    cdf_log.push_back(std::log(
        0.2680523296111902594541368047465042591108987357277389728827508022844102288442195709664943608618480998)); // expected cdf_log
  }
  ...
  cdf_log(const T_n &n, const T_N &N, const T_size1 &alpha, const T_size2 &beta,
          const T4 &, const T5 &) {
