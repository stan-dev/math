...
class AgradCdfBetaBinomial : public AgradCdfTest {
 public:
  void valid_values(vector<vector<double>> &parameters, vector<double> &cdf) {
    ...
    cdf.push_back(
        0.2680523296111902594541368047465042591108987357277389728827508022844102288442195709664943608618480998);  // expected cdf
  }
  ...
  typename stan::return_type<T_size1, T_size2>::type cdf(
