...
public:
  void valid_values(vector<vector<double>> &parameters,
    ...
    parameters.push_back(param);
    cdf_log.push_back(
        std::log(0.6922006275553463538654219)); // expected cdf_log
    ...
    parameters.push_back(param);
    cdf_log.push_back(
        std::log(0.000617978989331093498619521)); // expected cdf_log
    ...
    parameters.push_back(param);
    cdf_log.push_back(
        std::log(0.1203922620798295861862650)); // expected cdf_log
  }
  ...
  cdf_log(const T_y &y, const T_loc &mu, const T_scale &beta, const T3 &,
          const T4 &, const T5 &) {
