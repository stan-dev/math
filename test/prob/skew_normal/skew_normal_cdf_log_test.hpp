#ifndef TEST_PROB_SKEW_NORMAL_CDF_LOG_TEST
#define TEST_PROB_SKEW_NORMAL_CDF_LOG_TEST
 ...
 public:
  void valid_values(vector<vector<double> >& parameters,
    ...
    cdf_log.push_back(std::log(
        0.00005624443371187709415635692284235862134252368571012732206706451807484923689534924660749487716440408152));  // expected cdf_log
