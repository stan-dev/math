#ifndef TEST_PROB_STUDENT_T_CCDF_LOG_TEST
#define TEST_PROB_STUDENT_T_CCDF_LOG_TEST
...
class AgradCcdfLogStudentT : public AgradCcdfLogTest {
 public:
  void valid_values(vector<vector<double> >& parameters,
    ...
    ccdf_log.push_back(
        std::log(1.0 - 0.8646688779244795508561));  // expected CCDF_log
    ...
    parameters.push_back(param);
    ccdf_log.push_back(
        std::log(1.0 - 0.2372327883473262233327));  // expected CCDF_log
  }
