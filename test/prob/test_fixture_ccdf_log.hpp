...
class AgradCcdfLogTestFixture : public ::testing::Test {
 public:
  ...
  void test_multiple_gradient_values(
      const bool is_vec, const double single_ccdf_log,
    ...
    for (size_t n = 0; n < parameters.size(); n++) {
      ...
      if (!is_constant_all<T0>::value && !is_empty<T0>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 0);
      if (!is_constant_all<T1>::value && !is_empty<T1>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 1);
      if (!is_constant_all<T2>::value && !is_empty<T2>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 2);
      if (!is_constant_all<T3>::value && !is_empty<T3>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 3);
      if (!is_constant_all<T4>::value && !is_empty<T4>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 4);
      if (!is_constant_all<T5>::value && !is_empty<T5>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients2, pos_multiple, N_REPEAT, 5);
      ...
      if (!is_constant_all<T0>::value && !is_empty<T0>::value
        ...
        test_multiple_gradient_values(
            ...
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 0);
      if (!is_constant_all<T1>::value && !is_empty<T1>::value
          && std::is_same<Scalar1, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
            is_vector<T1>::value, single_ccdf_log, single_gradients3,
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 1);
      if (!is_constant_all<T2>::value && !is_empty<T2>::value
          && std::is_same<Scalar2, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
            is_vector<T2>::value, single_ccdf_log, single_gradients3,
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 2);
      if (!is_constant_all<T3>::value && !is_empty<T3>::value
          && std::is_same<Scalar3, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
            is_vector<T3>::value, single_ccdf_log, single_gradients3,
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 3);
      if (!is_constant_all<T4>::value && !is_empty<T4>::value
          && std::is_same<Scalar4, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
            is_vector<T4>::value, single_ccdf_log, single_gradients3,
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 4);
      if (!is_constant_all<T5>::value && !is_empty<T5>::value
          && std::is_same<Scalar5, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
            is_vector<T5>::value, single_ccdf_log, single_gradients3,
            pos_single, multiple_gradients3, pos_multiple, N_REPEAT, 5);
    }
  }
