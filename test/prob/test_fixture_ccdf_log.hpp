...
template <class T> class AgradCcdfLogTestFixture : public ::testing::Test {
public:
  ...
  void add_finite_diff_1storder(const vector<double> &params,
    ...
    double ccdf_log_plus =
        TestClass
            .template ccdf_log<double, double, double, double, double, double>(
                plus[0], plus[1], plus[2], plus[3], plus[4], plus[5]);
    double ccdf_log_minus =
        TestClass
            .template ccdf_log<double, double, double, double, double, double>(
