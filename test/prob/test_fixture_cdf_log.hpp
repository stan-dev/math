...
class AgradCdfLogTestFixture : public ::testing::Test {
 public:
  ...
  void test_valid_values() {
    ...
    for (size_t n = 0; n < parameters.size(); n++) {
      ...
      if (all_scalar<T0, T1, T2, T3, T4, T5>::value) {
        ...
        stream
            << "For all scalar inputs cdf_log should match the provided value. "
               "Failed at index: "
            << n << std::endl
            << "expected: " << expected_cdf_log[n] << std::endl
            << "actual:   " << cdf_log;

        stan::test::expect_near_rel(stream.str(), expected_cdf_log[n],
  ...
  void test_gradients_equal(const vector<double>& expected_gradients,
                            const vector<double>& gradients, double tol) {
    ...
    for (size_t i = 0; i < expected_gradients.size(); i++) {
      ...
      stan::test::expect_near_rel(stream.str(), expected_gradients[i],
                                  gradients[i], tol);
    }
  }
  ...
  void test_repeat_as_vector() {
    ...
    for (size_t n = 0; n < parameters.size(); n++) {
      ...
      stan::test::expect_near_rel(
          stream.str(), stan::math::value_of_rec(N_REPEAT * single_cdf_log),
      ...
      if (!is_constant_all<T0>::value && !is_empty<T0>::value
        ...
        test_multiple_gradient_values(
            is_vector<T0>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T1>::value && !is_empty<T1>::value
          && !std::is_same<Scalar1, fvar<double>>::value
          && !std::is_same<Scalar1, fvar<fvar<double>>>::value)
        test_multiple_gradient_values(
            is_vector<T1>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T2>::value && !is_empty<T2>::value
          ...
          && !std::is_same<Scalar2, fvar<fvar<double>>>::value)
        test_multiple_gradient_values(
            is_vector<T2>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T3>::value && !is_empty<T3>::value
          ...
          && !std::is_same<Scalar3, fvar<fvar<double>>>::value)
        test_multiple_gradient_values(
            is_vector<T3>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T4>::value && !is_empty<T4>::value
          ...
          && !std::is_same<Scalar4, fvar<fvar<double>>>::value)
        test_multiple_gradient_values(
            is_vector<T4>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T5>::value && !is_empty<T5>::value
          ...
          && !std::is_same<Scalar5, fvar<fvar<double>>>::value)
        test_multiple_gradient_values(
            is_vector<T5>::value, value_of_rec(single_cdf_log),
            single_gradients1, pos_single, multiple_gradients1, pos_multiple,
            N_REPEAT);
      ...
      if (!is_constant_all<T0>::value && !is_empty<T0>::value
        ...
        test_multiple_gradient_values(
            is_vector<T0>::value, value_of_rec(single_cdf_log),
            single_gradients2, pos_single, multiple_gradients2, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T1>::value && !is_empty<T1>::value
      ...
      if (!is_constant_all<T0>::value && !is_empty<T0>::value
        ...
        test_multiple_gradient_values(
            is_vector<T0>::value, value_of_rec(single_cdf_log),
            single_gradients3, pos_single, multiple_gradients3, pos_multiple,
            N_REPEAT);
      if (!is_constant_all<T1>::value && !is_empty<T1>::value
          && std::is_same<Scalar1, fvar<fvar<var>>>::value)
        test_multiple_gradient_values(
  ...
  void test_as_scalars_vs_as_vector() {
    ...
    for (size_t n = 1; n < parameters.size(); n++) {
      ...
      single_cdf_log += TestClass.template cdf_log<Scalar0, Scalar1, Scalar2,
                                                   Scalar3, Scalar4, Scalar5>(
...
REGISTER_TYPED_TEST_CASE_P(AgradCdfLogTestFixture, CallAllVersions, ValidValues,
                           ...
                           AsScalarsVsAsVector, LowerBound, UpperBound,
                           Length0Vector);
