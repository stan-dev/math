...
public:
  void valid_values(vector<vector<double>> &parameters,
    ...
    ccdf_log.push_back(
        std::log(1.0 - 0.8646647167633872976822)); // expected ccdf_log
    ...
    parameters.push_back(param);
    ccdf_log.push_back(
        std::log(1.0 - 0.00325857114906742380625)); // expected ccdf_log
  ...
  ccdf_log(const T_y &y, const T_shape &alpha, const T_scale &sigma, const T3 &,
           const T4 &, const T5 &) {
