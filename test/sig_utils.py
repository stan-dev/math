...
arg_types = {
    ...
    "real": "SCALAR",
    "scalar_return_t" : "scalar_return_t",
...
internal_signatures = [
    ...
    "vector unit_vector_constrain(vector, scalar_return_t)",
    "vector unit_vector_free(vector)",
    "vector positive_ordered_constrain(vector)",
    "vector positive_ordered_constrain(vector, scalar_return_t)",
    "vector positive_ordered_free(vector)",
    "vector ordered_constrain(vector)",
    "vector ordered_constrain(vector, scalar_return_t)",
    "vector ordered_free(vector)",
    "vector simplex_constrain(vector)",
    "vector simplex_constrain(vector, scalar_return_t)",
