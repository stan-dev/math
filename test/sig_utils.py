...
arg_types = {
    ...
    "real": "SCALAR",
    "complex": "stan::math::complex<SCALAR>",
    ...
    "complex_vector": "Eigen::Matrix<stan::math::complex<SCALAR>, Eigen::Dynamic, 1>",
    "array[] complex_vector": "std::vector<Eigen::Matrix<stan::math::complex<SCALAR>, Eigen::Dynamic, 1>>",
    "complex_row_vector": "Eigen::Matrix<stan::math::complex<SCALAR>, 1, Eigen::Dynamic>",
    "array[] complex_row_vector": "std::vector<Eigen::Matrix<stan::math::complex<SCALAR>, 1, Eigen::Dynamic>>",
    "complex_matrix": "Eigen::Matrix<stan::math::complex<SCALAR>, Eigen::Dynamic, Eigen::Dynamic>",
}
