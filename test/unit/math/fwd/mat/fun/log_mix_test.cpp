...
TEST(AgradFwdMatrixLogMix, ffdValues) {
  ...
  fvarfvar_vec_test(vecd_prob, vecd_dens);
  fvarfvar_vec_test(vecd_prob, row_vecd_dens);
  fvarfvar_vec_test(row_vecd_prob, vecd_dens);
  fvarfvar_vec_test(row_vecd_prob, row_vecd_dens);
}
