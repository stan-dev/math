...
void expect_fwd_binary_errors() {
  ...
  expect_binary_matrix_error<F, fvar<double> >(model_matrix);
  expect_binary_matrix_error<F, fvar<fvar<double> > >(model_matrix);
  expect_binary_matrix_error<F, fvar<double> >(model_vector);
  expect_binary_matrix_error<F, fvar<fvar<double> > >(model_vector);
  expect_binary_matrix_error<F, fvar<double> >(model_row_vector);
  expect_binary_matrix_error<F, fvar<fvar<double> > >(model_row_vector);
}
