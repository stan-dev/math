#ifndef TEST_UNIT_MATH_FWD_MAT_VECTORIZE_EXPECT_FWD_BINARY_SCALAR_STD_VECTOR_MATRIX_ALL_EQ
#define TEST_UNIT_MATH_FWD_MAT_VECTORIZE_EXPECT_FWD_BINARY_SCALAR_STD_VECTOR_MATRIX_ALL_EQ
...
void expect_fwd_binary_scalar_std_vector_matrix_all_eq(const
std::vector<int>& int_template_v, const std::vector<double>& d_template_v,
const std::vector<FV> fvar_template_v, const Eigen::Matrix<double, R, C>&
