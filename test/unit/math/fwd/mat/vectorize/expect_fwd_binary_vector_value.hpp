...
void expect_fwd_binary_vector_value() {
  ...
  expect_fwd_binary_scalar_matrix_all_eq<F, FV>(int_template_sv,
  d_template_sv, fvar_template_sv, d_template_mv, fvar_scalar_template_mv); 
  ...
  expect_fwd_binary_scalar_std_vector_matrix_all_eq<F, FV>(int_template_sv,
  d_template_sv, fvar_template_sv, d_template_mv, fvar_scalar_template_mv); 
