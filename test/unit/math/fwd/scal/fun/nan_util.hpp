...
void test_nan_fd(const F& f,
  ...
  fail_msg2
    << "Failed for fvar<double>, double version with first argument "
    << arg1_v
    << " and second argument " << arg2;
  fail_msg3
    << "Failed for double, fvar<double> version with first argument "
    << arg1
    << " and second argument " << arg2_v;
...
void test_nan_ffd(const F& f,
  ...
  std::ostringstream fail_msg3;
  fail_msg1
    << "Failed for fvar<fvar<double>>, fvar<fvar<double>> "
    << "version with first argument "
    << arg1_v << " and second argument " << arg2_v;
  fail_msg2
    << "Failed for fvar<fvar<double>>, double  "
    << "version with first argument "
    << arg1_v << " and second argument " << arg2;
  fail_msg3
    << "Failed for double, fvar<fvar<double>> "
    << "version with first argument "
