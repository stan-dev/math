...
void test_nan_fd(const F& f, const double& arg1, const bool& throws) {
  ...
  if (throws) {
    ...
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v).d_));
  }
}
...
void test_nan_ffd(const F& f, const double& arg1, const bool& throws) {
  ...
  if (throws) {
    ...
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v).val_.d_));
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v).d_.val_));
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v).d_.d_));
  }
}
...
void test_nan_fd(const F& f, const double& arg1, const double& arg2,
  ...
  fail_msg1
      << "Failed for fvar<double>, fvar<double> version with first argument "
      << arg1_v << " and second argument " << arg2_v;
  fail_msg2 << "Failed for fvar<double>, double version with first argument "
            << arg1_v << " and second argument " << arg2;
  fail_msg3 << "Failed for double, fvar<double> version with first argument "
            << arg1 << " and second argument " << arg2_v;
  ...
  if (throws) {
    ...
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2_v).d_)) << fail_msg1.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2).d_)) << fail_msg2.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1, arg2_v).d_)) << fail_msg3.str();
  }
}
...
void test_nan_ffd(const F& f, const double& arg1, const double& arg2,
  ...
  std::ostringstream fail_msg2;
  std::ostringstream fail_msg3;
  fail_msg1 << "Failed for fvar<fvar<double>>, fvar<fvar<double>> "
            << "version with first argument " << arg1_v
            << " and second argument " << arg2_v;
  fail_msg2 << "Failed for fvar<fvar<double>>, double  "
            << "version with first argument " << arg1_v
            << " and second argument " << arg2;
  fail_msg3 << "Failed for double, fvar<fvar<double>> "
            << "version with first argument " << arg1 << " and second argument "
            << arg2_v;
  ...
  if (throws) {
    ...
    EXPECT_TRUE(stan::math::is_nan(f(arg1, arg2_v).val_.val_))
        << fail_msg3.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2_v).val_.d_))
        << fail_msg1.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2).val_.d_)) << fail_msg2.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1, arg2_v).val_.d_)) << fail_msg3.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2_v).d_.val_))
        << fail_msg1.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2).d_.val_)) << fail_msg2.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1, arg2_v).d_.val_)) << fail_msg3.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2_v).d_.d_)) << fail_msg1.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1_v, arg2).d_.d_)) << fail_msg2.str();
    EXPECT_TRUE(stan::math::is_nan(f(arg1, arg2_v).d_.d_)) << fail_msg3.str();
  }
}
