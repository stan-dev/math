...
TEST(MathMatrixGPU, copy_triangular_m_exception_pass) {
  ...
  EXPECT_NO_THROW(
      stan::math::copy_triangular<stan::math::TriangularViewGPU::Upper>(m0));
  EXPECT_NO_THROW(
      stan::math::copy_triangular<stan::math::TriangularViewGPU::Lower>(m0));

  stan::math::matrix_gpu m1(1, 1);

  EXPECT_NO_THROW(
      stan::math::copy_triangular<stan::math::TriangularViewGPU::Upper>(m1));
  EXPECT_NO_THROW(
      stan::math::copy_triangular<stan::math::TriangularViewGPU::Lower>(m1));
}
