...
TEST(MathMatrixGPU, copy_triangular_m_exception_pass) {
  ...
  EXPECT_NO_THROW(stan::math::copy_triangular<stan::math::TriangularViewGPU::Upper>(m0));
  EXPECT_NO_THROW(stan::math::copy_triangular<stan::math::TriangularViewGPU::Lower>(m0));

  stan::math::matrix_gpu m1(1, 1);

  EXPECT_NO_THROW(stan::math::copy_triangular<stan::math::TriangularViewGPU::Upper>(m1));
  EXPECT_NO_THROW(stan::math::copy_triangular<stan::math::TriangularViewGPU::Lower>(m1));
}
...
TEST(MathMatrixGPU, copy_triangular_m_pass) {
  ...
  EXPECT_NO_THROW(m00_dst
                  = stan::math::copy_triangular<stan::math::TriangularViewGPU::Upper>(m00));
  ...
  EXPECT_NO_THROW(m00_dst
                  = stan::math::copy_triangular<stan::math::TriangularViewGPU::Lower>(m00));
  EXPECT_NO_THROW(stan::math::copy(m0_dst, m00_dst));
  EXPECT_EQ(1, m0_dst(0, 0));
