...
TEST(MathMatrixGPU, copy_triangular_transposed_m_exception_pass) {
  ...
  EXPECT_NO_THROW(m0.copy_triangular_transposed<stan::math::LowerToUpper>());
  EXPECT_NO_THROW(m0.copy_triangular_transposed<stan::math::UpperToLower>());
  EXPECT_NO_THROW(m1.copy_triangular_transposed<stan::math::LowerToUpper>());
  EXPECT_NO_THROW(m1.copy_triangular_transposed<stan::math::UpperToLower>());
}
...
TEST(MathMatrixGPU, copy_triangular_transposed_m_pass) {
  ...
  EXPECT_NO_THROW(m00.copy_triangular_transposed<stan::math::LowerToUpper>());
  ...
  EXPECT_NO_THROW(m11.copy_triangular_transposed<stan::math::UpperToLower>());
