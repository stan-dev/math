...
TEST(MathMatrix, multiply_m_exception_pass_diagonal_mul) {
  stan::math::matrix_d m0 = stan::math::matrix_d::Ones(3, 2);
  stan::math::matrix_d m1 = stan::math::matrix_d::Ones(1, 3);
...
TEST(MathMatrix, diagonal_multiply_value_check) {
  ...
  stan::math::matrix_d m2_dst(1, 3);
  stan::math::matrix_d m2 = stan::math::matrix_d::Ones(1, 3) * 2;
  ...
  stan::math::matrix_d m3_dst(3, 3);
  stan::math::matrix_d m3 = stan::math::matrix_d::Ones(3, 3) * 2;
