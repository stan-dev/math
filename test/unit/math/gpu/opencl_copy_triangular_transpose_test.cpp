...
TEST(MathMatrixGPU, copy_triangular_transposed_m_exception_pass) {
  ...
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m0, stan::math::LOWER_TO_UPPER_TRIANGULAR));
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m0, stan::math::LOWER_TO_UPPER_TRIANGULAR));
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m1, stan::math::LOWER_TO_UPPER_TRIANGULAR));
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m1, stan::math::UPPER_TO_LOWER_TRIANGULAR));
}
...
TEST(MathMatrixGPU, copy_triangular_transposed_m_pass) {
  ...
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m00, stan::math::LOWER_TO_UPPER_TRIANGULAR));
  ...
  EXPECT_NO_THROW(stan::math::copy_triangular_transposed(
      m11, stan::math::UPPER_TO_LOWER_TRIANGULAR));
