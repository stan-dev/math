...
TEST(AgradMixNumericLimits, All_Fvar) {
  ...
  EXPECT_FLOAT_EQ(2.22507e-308,
                  std::numeric_limits<fvar<fvar<var> > >::min().val_.val_
                                                                    .val());

  EXPECT_FLOAT_EQ(1.79769e+308,
                  std::numeric_limits<fvar<var> >::max().val_.val());
  EXPECT_FLOAT_EQ(1.79769e+308,
                  std::numeric_limits<fvar<fvar<var> > >::max().val_.val_
                                                                    .val());
  ...
  EXPECT_FLOAT_EQ(2.220446e-16,
                  std::numeric_limits<fvar<fvar<var> > >::epsilon().val_.val_
                                                                        .val());

  EXPECT_FLOAT_EQ(0.5,
                  std::numeric_limits<fvar<var> >::round_error().val_.val());
  EXPECT_FLOAT_EQ(0.5,
                  std::numeric_limits<fvar<fvar<var> > >::round_error().val_
                                                                       .val_
                                                                      .val());
  ...
  EXPECT_FLOAT_EQ(INFTY,
                  std::numeric_limits<fvar<fvar<var> > >::infinity().val_.val_
                                                                    .val());
  ...
  EXPECT_FLOAT_EQ(4.94066e-324,
                  std::numeric_limits<fvar<fvar<var> > >::denorm_min().val_
                                                                      .val_
                                                                      .val());
