...
TEST(mathMixMatFun, log1mInvLogit) {
  ...
  stan::test::expect_common_nonzero_unary_vectorized<stan::test::PromoteToComplex::No>(f);
  stan::test::expect_unary_vectorized<stan::test::PromoteToComplex::No>(f, -2.6, -2, -1, -0.5, -0.2, 0.5, 1, 1.3,
                                      3, 5);
}
