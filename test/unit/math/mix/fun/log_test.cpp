...
TEST(mathMixMatFun, log) {
  ...
  stan::test::expect_ad(f, stan::math::complex<double>{0, 2.1});
  stan::test::expect_ad(f, stan::math::complex<double>{0, -2.1});
  stan::test::expect_ad(f, stan::math::complex<double>{2.1, 0});
  stan::test::expect_ad(f, stan::math::complex<double>{-0.0, 2.1});
  stan::test::expect_ad(f, stan::math::complex<double>{-0.0, -2.1});
  stan::test::expect_ad(f, stan::math::complex<double>{2.1, -0.0});
