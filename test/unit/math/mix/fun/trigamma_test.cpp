...
TEST(mathMixMatFun, trigamma) {
  ...
  expect_unary_vectorized<stan::test::PromoteToComplex::No>(tols, f, -103.52, -0.9, -0.5, 0, 0.5, 1.3, 5.1, 19.2);
  ...
  expect_unary_vectorized<stan::test::PromoteToComplex::No>(tols2, f, -20, 1, 5);
}
