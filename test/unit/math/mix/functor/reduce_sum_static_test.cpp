...
TEST(MathMix_reduce_sum_static, grainsize) {
  auto f1 = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 0, msgs);
  };
  auto f2 = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, -1, msgs);
  };
  auto f3 = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
  auto f4 = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 20, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_row_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_matrix_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_std_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_row_vector_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_matrix_double_slice) {
  auto f = [](auto&& data) {
    return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs);
  };
...
TEST(StanMath_reduce_sum_static, start_end_slice) {
  auto start_end = [](auto&& arg) {
    return stan::math::reduce_sum_static<start_end_lpdf>(arg, 1, msgs, arg);
  };
...
auto fi = [](auto&&... args) {
  return stan::math::reduce_sum_static<sum_lpdf>(std::vector<int>(2, 10.0), 1, msgs,
                                          args...);
};

auto fd = [](auto&& data, auto&&... args) {
  return stan::math::reduce_sum_static<sum_lpdf>(data, 1, msgs, args...);
};

TEST(MathMix_reduce_sum_static, int_arg) {
...
TEST(MathMix_reduce_sum_static, double_arg) {
...
TEST(MathMix_reduce_sum_static, std_vector_int_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_double_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, eigen_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, eigen_row_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, eigen_matrix_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_double_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_row_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_eigen_matrix_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_std_vector_double_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_row_vector_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, std_vector_std_vector_eigen_matrix_arg) {
  std::vector<double> data(2, 10.0);
...
TEST(MathMix_reduce_sum_static, eigen_three_args1) {
...
TEST(MathMix_reduce_sum_static, eigen_three_args2) {
  double arg1 = 1.0;
...
TEST(MathMix_reduce_sum_static, eigen_three_args3) {
  double arg1 = 1.0;
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_ints1) {
  Eigen::VectorXd arg1 = Eigen::VectorXd::Ones(2);
  Eigen::RowVectorXd arg2 = Eigen::RowVectorXd::Ones(2);
  Eigen::MatrixXd arg3 = Eigen::MatrixXd::Ones(2, 2);
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_ints2) {
  double arg1 = 1.0;
  std::vector<double> arg2(2, 1.0);
  Eigen::MatrixXd arg3 = Eigen::MatrixXd::Ones(2, 2);
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_ints3) {
  double arg1 = 1.0;
  std::vector<std::vector<double>> arg2(2, std::vector<double>(2, 1.0));
  std::vector<Eigen::MatrixXd> arg3(2, Eigen::MatrixXd::Ones(2, 2));
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_doubles1) {
  Eigen::VectorXd arg1 = Eigen::VectorXd::Ones(2);
  Eigen::RowVectorXd arg2 = Eigen::RowVectorXd::Ones(2);
  Eigen::MatrixXd arg3 = Eigen::MatrixXd::Ones(2, 2);
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_doubles2) {
  double arg1 = 1.0;
  std::vector<double> arg2(2, 1.0);
  Eigen::MatrixXd arg3 = Eigen::MatrixXd::Ones(2, 2);
...
TEST(MathMix_reduce_sum_static, eigen_three_args_with_doubles3) {
  double arg1 = 1.0;
  std::vector<std::vector<double>> arg2(2, std::vector<double>(2, 1.0));
  std::vector<Eigen::MatrixXd> arg3(2, Eigen::MatrixXd::Ones(2, 2));
...
struct static_check_lpdf {
  ...
  inline auto operator()(std::size_t start, std::size_t end,
    ...
    T sum = 0;
    //std::cout << "start: " << start << ", end: " << end << ", grainsize: " << grainsize << std::endl;
...
TEST(StanMathPrim_reduce_sum_static, static_check) {
  ...
  for(auto size : { 1, 3, 6, 11 }) {
    ...
    auto fi1 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<1>>(data, 1, msgs, args...);
    };

    auto fi2 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<2>>(data, 2, msgs, args...);
    };

    auto fi3 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<3>>(data, 3, msgs, args...);
    };
