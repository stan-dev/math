...
TEST(StanMath_reduce_sum_static, start_end_slice) {
  ...
  auto start_end_static = [](auto&& arg) {
    return stan::math::reduce_sum_static<start_end_lpdf>(arg, 1, get_new_msg(), arg);
  };
...
TEST(MathMix_reduce_sum, int_arg) {
  ...
  stan::test::expect_ad([&](auto&& data) { return reduce_sum_static_sum_lpdf(data, arg); }, data);
  stan::test::expect_ad([&](auto&& data) { return reduce_sum_sum_lpdf(data, arg); }, data);
...
TEST(MathMix_reduce_sum, double_arg) {
  stan::math::test::expect_ad_reduce_sum_lpdf(std::vector<double>(2, 10.0), 5.0);
}

TEST(MathMix_reduce_sum, std_vector_double_arg) {
  stan::math::test::expect_ad_reduce_sum_lpdf(std::vector<double>(2, 10.0), std::vector<double>(2, 10.0));
}
...
TEST(MathMix_reduce_sum, eigen_three_args_with_ints1) {
  ...
  stan::test::expect_ad(
      [&](auto&& arg1, auto&& arg2, auto&& arg3) {
        return reduce_sum_static_int_sum_lpdf(1, arg1, std::vector<int>{1, 2, 3}, arg2, 3, arg3);
      },
      arg1, arg2, arg3);

  stan::test::expect_ad(
      [&](auto&& arg1, auto&& arg2, auto&& arg3) {
        return reduce_sum_int_sum_lpdf(1, arg1, std::vector<int>{1, 2, 3}, arg2, 3, arg3);
      },
      arg1, arg2, arg3);
}
...
TEST(MathMix_reduce_sum, eigen_three_args_with_doubles1) {
  ...
  stan::test::expect_ad(
      [&](auto&& arg1, auto&& arg2, auto&& arg3) {
        return reduce_sum_static_sum_lpdf(std::vector<double>{1.0, 2.0, 3.0}, arg1, 3.0, arg2,
                  std::vector<double>{1.0, 2.0, 3.0}, arg3);
      },
      arg1, arg2, arg3);
  stan::test::expect_ad(
      [&](auto&& arg1, auto&& arg2, auto&& arg3) {
        return reduce_sum_sum_lpdf(std::vector<double>{1.0, 2.0, 3.0}, arg1, 3.0, arg2,
                  std::vector<double>{1.0, 2.0, 3.0}, arg3);
      },
      arg1, arg2, arg3);
}
...
TEST(MathMix_reduce_sum, static_check) {
  ...
  for (auto size : {1, 3, 6, 11}) {
    ...
    auto fi1 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<1>>(data, 1, get_new_msg(),
                                                                 args...);
    };

    auto fi2 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<2>>(data, 2, get_new_msg(),
                                                                 args...);
    };

    auto fi3 = [&](auto&&... args) {
      return stan::math::reduce_sum_static<static_check_lpdf<3>>(data, 3, get_new_msg(),
                                                                 args...);
    };
