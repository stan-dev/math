...
/**
 * This is the structure for testing mock function abs (defined in the
...
INSTANTIATE_TYPED_TEST_CASE_P(, prim_scalar_unary_test, abs_test);
INSTANTIATE_TYPED_TEST_CASE_P(, rev_scalar_unary_test, abs_test);
INSTANTIATE_TYPED_TEST_CASE_P(, fwd_scalar_unary_test, abs_test);
INSTANTIATE_TYPED_TEST_CASE_P(, mix_scalar_unary_test, abs_test);
