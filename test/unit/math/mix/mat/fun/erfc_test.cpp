...
INSTANTIATE_TYPED_TEST_CASE_P(, prim_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(, rev_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(, fwd_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(, mix_scalar_unary_test, erfc_test);
