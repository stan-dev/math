...
TEST(AgradMixMatrixGetBase1, get_base1_matrix_fv) {
  ...
  for (size_t i = 0; i < 4; ++i) {
    for (size_t j = 0; j < 3; ++j) {
      ...
      Matrix<fvar<var>, 1, Dynamic> xi = get_base1<fvar<var>>(x, i + 1, "x", 1);
...
TEST(AgradMixMatrixGetBase1, get_base1_8_fv) {
  ...
  vector<vector<vector<vector<vector<vector<vector<vector<fvar<var>>>>>>>>> x8(
      2, x7);
...
TEST(AgradMixMatrixGetBase1, get_base1_8_ffv) {
  ...
  vector<vector<vector<vector<vector<vector<vector<fvar<fvar<var>>>>>>>>> x7(
      3, x6);
  vector<
      vector<vector<vector<vector<vector<vector<vector<fvar<fvar<var>>>>>>>>>>
      x8(2, x7);
