...
static inline void expect_binary_val_deriv_eq(
  ...
  expect_binary_val_deriv_eq(exp_var.d_, base_exp_var1.d_, base_exp_var2.d_,
                             test_var.d_, base_test_var1.d_, base_test_var2.d_);
}
...
static inline void expect_binary_val_deriv_eq(
  ...
  expect_binary_val_deriv_eq(exp_var.val(), base_exp_var1.val(), base_exp_var2,
                             test_var.val(), base_test_var1.val(),
                             base_test_var2);
  expect_binary_val_deriv_eq(exp_var.d_, base_exp_var1.d_, base_exp_var2,
                             test_var.d_, base_test_var1.d_, base_test_var2);
}
...
static inline void expect_binary_val_deriv_eq(
  ...
  expect_binary_val_deriv_eq(exp_var.val(), base_exp_var1, base_exp_var2.val(),
                             test_var.val(), base_test_var1,
                             base_test_var2.val());
  expect_binary_val_deriv_eq(exp_var.d_, base_exp_var1, base_exp_var2.d_,
                             test_var.d_, base_test_var1, base_test_var2.d_);
}
