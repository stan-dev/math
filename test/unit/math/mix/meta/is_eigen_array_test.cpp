...
TEST(MathMetaPrim, is_eigen_array_tests) {
  ...
  all_eigen_dense_matrix<false, false, false, false, false, is_eigen_array, -1,
                         -1>();
  all_eigen_dense_array<false, true, true, true, true, is_eigen_array, -1,
                        -1>();
