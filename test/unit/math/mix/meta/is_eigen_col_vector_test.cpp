...
TEST(MathMetaPrim, is_eigen_col_vector_tests) {
  ...
  all_eigen_dense_matrix<false, false, false, false, false, is_eigen_col_vector,
                         -1, -1>();
  all_eigen_dense_matrix<false, false, false, false, false, is_eigen_col_vector,
                         1, -1>();
  all_eigen_dense_matrix<false, true, true, true, true, is_eigen_col_vector, -1,
                         1>();
  all_eigen_dense_array<false, false, false, false, false, is_eigen_col_vector,
                        -1, -1>();
  all_eigen_dense_array<false, false, false, false, false, is_eigen_col_vector,
                        1, -1>();
