...
TEST(MathMetaPrim, is_eigen_contiguous_map_tests) {
  ...
  all_eigen_dense_matrix<false, false, false, false, true,
                         is_eigen_contiguous_map, -1, -1>();
  all_eigen_dense_matrix<false, false, false, false, true,
                         is_eigen_contiguous_map, 1, -1>();
  all_eigen_dense_matrix<false, false, false, false, true,
                         is_eigen_contiguous_map, -1, 1>();
  all_eigen_dense_array<false, false, false, false, true,
                        is_eigen_contiguous_map, -1, -1>();
  all_eigen_dense_array<false, false, false, false, true,
                        is_eigen_contiguous_map, 1, -1>();
  all_eigen_dense_array<false, false, false, false, true,
