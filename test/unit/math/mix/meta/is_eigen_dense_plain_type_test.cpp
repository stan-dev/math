...
TEST(MathMetaPrim, is_eigen_dense_plain_type_hierarchy_tests) {
  ...
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Matrix,
                  -1, -1>();
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Matrix,
                  1, -1>();
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Matrix,
                  -1, 1>();
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Array,
                  -1, -1>();
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Array,
                  1, -1>();
  all_eigen_dense<false, false, false, false, false, is_eigen_dense_plain_type, Array,
...
TEST(MathMetaPrim, is_eigen_dense_plain_type_expr_tests) {
  ...
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Matrix,
                        -1, -1>();
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Matrix, 1,
                        -1>();
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Matrix,
                        -1, 1>();
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Array,
                        -1, -1>();
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Array,
                        1, -1>();
  all_eigen_dense_exprs<true, false, false, false, is_eigen_dense_plain_type, Array,
