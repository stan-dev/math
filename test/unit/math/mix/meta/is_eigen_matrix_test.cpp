...
TEST(MathMetaPrim, is_eigen_matrix_tests) {
  ...
  all_eigen_dense_matrix<false, true, true, true, true, is_eigen_matrix, -1,
                         -1>();
  all_eigen_dense_matrix<false, false, false, false, false, is_eigen_matrix, 1,
                         -1>();
  all_eigen_dense_matrix<false, false, false, false, false, is_eigen_matrix, -1,
                         1>();
  all_eigen_dense_array<false, false, false, false, false, is_eigen_matrix, -1,
                        -1>();
  all_eigen_dense_array<false, false, false, false, false, is_eigen_matrix, 1,
                        -1>();
  all_eigen_dense_array<false, false, false, false, false, is_eigen_matrix, -1,
