...
TEST(ProbDistributionsLkjCorrCholesky, hessian) {
  ...
  using stan::math::internal::finite_diff_of_grads_hessian;
  ...
  finite_diff_of_grads_hessian(test_func_3, x3, fx_hess_3, grad_hess_3, hess_3);
  ...
  finite_diff_of_grads_hessian(test_func_2, x2, fx_hess_2, grad_hess_2, hess_2);
  ...
  finite_diff_of_grads_hessian(test_func_1, x1, fx_hess_1, grad_hess_1, hess_1);
