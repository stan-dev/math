...
TEST(mathMixScalFun_y_w_v, wiener4_lccdf) {
...
TEST(mathMixScalFun_a_t0_w, wiener4_lccdf) {
...
TEST(mathMixScalFun_a_t0_v, wiener4_lccdf) {
...
TEST(mathMixScalFun_a_w_v, wiener4_lccdf) {
...
TEST(mathMixScalFun_t0_w_v, wiener4_lccdf) {
