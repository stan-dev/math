...
TEST(mathMixScalFun_a, wiener4_lcdf) {
auto f_a = [](const auto& y, const auto& t0, const auto& w, const auto& v) {
     return [&y, &t0, &w, &v](const auto& a) {
      ...
      stan::test::expect_ad(f_a(y, t0, w, v), a);
    }


TEST(mathMixScalFun_y_a_t0, wiener4_lcdf) {
...
TEST(mathMixScalFun_y_a_w, wiener4_lcdf) {
...
TEST(mathMixScalFun_y_a_v, wiener4_lcdf) {
...
TEST(mathMixScalFun_y_t0_w, wiener4_lcdf) {
...
TEST(mathMixScalFun_y_t0_v, wiener4_lcdf) {
