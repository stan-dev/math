...
TEST_F(Wiener7MixArgs, wiener_lccdf_w_sw_st0) {
...
TEST_F(Wiener7MixArgs, wiener_lccdf_v_sv_sw) {
...
TEST_F(Wiener7MixArgs, wiener_lccdf_v_sv_st0) {
...
TEST_F(Wiener7MixArgs, wiener_lccdf_v_sw_st0) {
...
TEST_F(Wiener7MixArgs, wiener_lccdf_sv_sw_st0) {
