...
TEST(mathMixScalFun_y_a_w, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_a_v, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_a_sv, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_a_sw, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_a_st0, wiener_full_lccdf) {
