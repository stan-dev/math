...
TEST(mathMixScalFun_y_w_v, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_w_sv, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_w_sw, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_w_st0, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_v_sv, wiener_full_lccdf) {
