...
TEST(mathMixScalFun_y_v_sw, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_v_st0, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_sv_sw, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_sv_st0, wiener_full_lccdf) {
...
TEST(mathMixScalFun_y_sw_st0, wiener_full_lccdf) {
