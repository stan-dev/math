...
TEST(mathMixDouble, wiener_lcdf) {
  double y = 1.0;
  double a = 2.0;
  double t0 = 0.2;
  double w = 0.5;
  ...
  double sw = 0.2;
  double st0 = 0.2;
  stan::math::wiener_lcdf(y, a, t0, w, v, sv, sw, st0, 1e-4);
}

TEST(mathMixVar, wiener_lcdf) {
  using stan::math::var;
  var y = 1.0;
  var a = 2.0;
  var t0 = 0.2;
  ...
  var sw = 0;
  var st0 = 0.2;
  stan::math::wiener_lcdf(y, a, t0, w, v, sv, sw, st0);
}

TEST(mathMixFVar, wiener_lcdf) {
...
TEST_F(Wiener7MixArgs, wiener_lcdf_y_a_t0) {
