...
TEST(MathMatrix, matrix_vector_tri_small) {
  ...
  m_cl.triangular_view(stan::math::PartialViewCL::Entire);
  v_cl.triangular_view(stan::math::PartialViewCL::Lower);
  m0_cl = m_cl * v_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);

  m0 = m.triangularView<Eigen::Lower>() * v;
  m_cl.triangular_view(stan::math::PartialViewCL::Lower);
  v_cl.triangular_view(stan::math::PartialViewCL::Entire);
  m0_cl = m_cl * v_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);
  ...
  m_cl.triangular_view(stan::math::PartialViewCL::Entire);
  v_cl.triangular_view(stan::math::PartialViewCL::Upper);
  m0_cl = m_cl * v_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);

  m0 = m.triangularView<Eigen::Upper>() * v;
  m_cl.triangular_view(stan::math::PartialViewCL::Upper);
  v_cl.triangular_view(stan::math::PartialViewCL::Entire);
  m0_cl = m_cl * v_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);
...
TEST(MathMatrix, row_vector_matrix_tri_small) {
  ...
  rv_cl.triangular_view(stan::math::PartialViewCL::Entire);
  m_cl.triangular_view(stan::math::PartialViewCL::Lower);
  m0_cl = rv_cl * m_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);
  ...
  rv_cl.triangular_view(stan::math::PartialViewCL::Lower);
  m_cl.triangular_view(stan::math::PartialViewCL::Entire);
  m0_cl = rv_cl * m_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);
  ...
  rv_cl.triangular_view(stan::math::PartialViewCL::Upper);
  m_cl.triangular_view(stan::math::PartialViewCL::Entire);
  m0_cl = rv_cl * m_cl;
  m0_cl_res = stan::math::from_matrix_cl(m0_cl);
  EXPECT_MATRIX_NEAR(m0, m0_cl_res, 1e-10);
...
TEST(MathMatrix, lower_tri_rect_multiply_small) {
  ...
  stan::math::matrix_cl<double> m11(m1, stan::math::PartialViewCL::Lower);
  stan::math::matrix_cl<double> m22(m2);
...
TEST(MathMatrix, upper_tri_rect_multiply_small) {
  ...
  stan::math::matrix_cl<double> m11(m1, stan::math::PartialViewCL::Upper);
  stan::math::matrix_cl<double> m22(m2);
...
TEST(MathMatrix, rect_lower_tri_multiply_small) {
  ...
  stan::math::matrix_cl<double> m11(m1);
  stan::math::matrix_cl<double> m22(m2, stan::math::PartialViewCL::Lower);
...
TEST(MathMatrix, rect_upper_tri_multiply_small) {
  ...
  stan::math::matrix_cl<double> m11(m1);
  stan::math::matrix_cl<double> m22(m2, stan::math::PartialViewCL::Upper);
