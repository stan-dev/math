...
TEST(MathMatrix, multiply_scalar) {
  ...
  stan::math::matrix_cl v_cl(v);
  v_cl = v_cl * 2.0;
  v_cl_res = from_matrix_cl(v_cl);

  stan::math::matrix_cl rv_cl(rv);
  rv_cl = rv_cl * 2.0;
  rv_cl_res = from_matrix_cl(rv_cl);

  stan::math::matrix_cl m_cl(m);
  m_cl = m_cl * 2.0;
  m_cl_res = from_matrix_cl(m_cl);
...
TEST(MathMatrix, row_vector_vector) {
  ...
  m0_cl = rv_cl * v_cl;
  m1_cl = v_cl * rv_cl;
  m0_cl_res = from_matrix_cl(m0_cl);
  m1_cl_res = from_matrix_cl(m1_cl);
