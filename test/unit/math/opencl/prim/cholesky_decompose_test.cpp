...
TEST(MathMatrix, cholesky_decompose_non_inplace_cpu_vs_cl_small) {
  ...
  stan::math::matrix_cl<double> m0_cl_res = stan::math::cholesky_decompose(m0_cl);
  stan::math::matrix_cl<double> m1_cl_res = stan::math::cholesky_decompose(m1_cl);
...
void cholesky_decompose_test(int size) {
    ...
    stan::math::matrix_cl<double> m1_pos_def_cl_result = stan::math::cholesky_decompose(m1_pos_def_cl);
    stan::math::matrix_d m1_cl_cpu = stan::math::from_matrix_cl(m1_pos_def_cl_result);
    double max_error = 0;
