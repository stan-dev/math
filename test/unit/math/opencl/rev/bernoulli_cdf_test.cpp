...
TEST_F(OpenCLRevTests, prob_distributions_BernoulliCdf_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_BernoulliCdf_opencl_broadcast_n) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_BernoulliCdf_opencl_broadcast_theta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_BernoulliCdf_opencl_matches_cpu_big) {
  int N = 153;
