...
TEST(ProbDistributionsBernoulliLogitGLM, gpu_matches_cpu_small_simple) {
  ...
  var res1
      = stan::math::bernoulli_logit_glm_lpmf(y_cl, x_cl, alpha_var1, beta_var1_cl);
...
TEST(ProbDistributionsBernoulliLogitGLM, gpu_broadcast_y) {
  ...
  expect_near_rel(
      ...
      stan::math::bernoulli_logit_glm_lpmf<true>(y_vec_cl, x_cl, alpha, beta_cl));
  ...
  var res1
      = stan::math::bernoulli_logit_glm_lpmf(y, x_cl, alpha_var1, beta_var1_cl);
...
TEST(ProbDistributionsBernoulliLogitGLM, gpu_matches_cpu_small_vector_alpha) {
  ...
  var res1
      = stan::math::bernoulli_logit_glm_lpmf(y_cl, x_var1_cl, alpha_var1_cl, beta_var1_cl);
...
TEST(ProbDistributionsBernoulliLogitGLM, gpu_matches_cpu_big) {
  ...
  var res1 = stan::math::bernoulli_logit_glm_lpmf<true>(y_cl, x_var1_cl, alpha_var1_cl,
                                                        beta_var1_cl);
  var res2
      = stan::math::bernoulli_logit_glm_lpmf<true>(y, x_var2, alpha_var2, beta_var2);
