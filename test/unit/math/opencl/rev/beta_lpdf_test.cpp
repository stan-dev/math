...
TEST_F(OpenCLRevTests, prob_distributions_Beta_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_broadcast_alpha) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_broadcast_beta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_y_alpha_scalar) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_y_beta_scalar) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Beta_opencl_matches_cpu_big) {
  int N = 153;
