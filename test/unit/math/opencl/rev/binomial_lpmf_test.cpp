...
TEST_F(OpenCLRevTests, probdistBinomial_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistBinomial_opencl_matches_cpu_small) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistBinomial_opencl_broadcast_n) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistBinomial_opencl_broadcast_theta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistBinomial_opencl_matches_cpu_big) {
  int N = 153;
...
TEST_F(OpenCLRevTests, probdistBinomial_opencl_n_N_scalar) {
  int N = 3;
