...
TEST_F(OpenCLRevTests, probdistributionsChiSquare_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistributionsChiSquare_opencl_matches_cpu_small) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistributionsChiSquare_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistributionsChiSquare_opencl_matches_cpu_big) {
  int N = 153;
