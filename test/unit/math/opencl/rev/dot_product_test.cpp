...
TEST_F(OpenCLRevTests, DotProduct_errors) {
  Eigen::VectorXd a(3);
  Eigen::VectorXd b(8);
...
TEST_F(OpenCLRevTests, DotProduct_prim_rev_small_vector) {
  Eigen::VectorXd a(8);
...
TEST_F(OpenCLRevTests, DotProduct_prim_rev_small_row_vector) {
...
TEST_F(OpenCLRevTests, DotProduct_prim_rev_size_0) {
  int N = 0;
...
TEST_F(OpenCLRevTests, DotProduct_prim_rev_values_large) {
  int N = 71;
