...
TEST_F(OpenCLRevTests, prob_distributions_DoubleExponentialCdf_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_DoubleExponentialCdf_opencl_broadcast_sigma) {
  int N = 3;
