...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_matches_cpu_small) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_broadcast_sigma) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_matches_cpu_big) {
  int N = 153;
...
TEST_F(OpenCLRevTests,
       prob_distributions_DoubleExponential_opencl_y_mu_scalar) {
  int N = 3;
