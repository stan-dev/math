...
TEST_F(OpenCLRevTests, probdistExponentialCdf_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistExponentialCdf_opencl_broadcast_beta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistExponentialCdf_opencl_matches_cpu_big) {
  int N = 153;
