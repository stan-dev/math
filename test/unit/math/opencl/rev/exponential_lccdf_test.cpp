...
TEST_F(OpenCLRevTests,
       prob_distributions_ExponentialLccdf_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests,
       prob_distributions_ExponentialLccdf_opencl_broadcast_beta) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       prob_distributions_ExponentialLccdf_opencl_matches_cpu_big) {
  int N = 153;
