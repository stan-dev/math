...
TEST_F(OpenCLRevTests, prob_distributions_FrechetLccdf_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_FrechetLccdf_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_FrechetLccdf_opencl_broadcast_alpha) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_FrechetLccdf_opencl_matches_cpu_big) {
  int N = 153;
