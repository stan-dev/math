...
TEST_F(OpenCLRevTests, probdistGumbelLcdf_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbelLcdf_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests, probdistGumbelLcdf_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbelLcdf_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbelLcdf_opencl_matches_cpu_big) {
  int N = 153;
