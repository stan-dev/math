...
TEST_F(OpenCLRevTests, probdistGumbel_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbel_opencl_matches_cpu_small) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbel_opencl_broadcast_beta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistGumbel_opencl_matches_cpu_big) {
  int N = 153;
