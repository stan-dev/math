...
auto log_inv_logit_diff_functor
    = [](const auto& a, const auto& b) { return stan::math::log_inv_logit_diff(a, b); };
...
TEST(OpenCLMatrix_log_inv_logit_diff, prim_rev_values_small) {
  ...
  b << 12, 11, 10, 9, 8, 7;
  stan::math::test::compare_cpu_opencl_prim_rev(log_inv_logit_diff_functor, a, b);
}
...
TEST(OpenCLMatrix_log_inv_logit_diff, prim_rev_values_M_0) {
  ...
  stan::math::test::compare_cpu_opencl_prim_rev(log_inv_logit_diff_functor, c, d);
}
