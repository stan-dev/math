...
TEST_F(OpenCLRevTests, probdistLogistic_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistLogistic_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistLogistic_opencl_broadcast_sigma) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistLogistic_opencl_matches_cpu_big) {
  int N = 153;
...
TEST_F(OpenCLRevTests, probdistLogistic_opencl_sigma_mu_scalar) {
  int N = 3;
  int M = 2;
