...
TEST_F(OpenCLRevTests, MatrixPower_prim_rev_values_small) {
  Eigen::MatrixXd a(3, 3);
  a << -2.2, -0.8, 0.5, 1, 1.5, 3, 3.4, 4, 0.4;
  stan::math::test::compare_cpu_opencl_prim_rev(matrix_power_functor, a, 7);
}

TEST_F(OpenCLRevTests, MatrixPower_prim_rev_size_0) {
  int N = 0;
...
TEST_F(OpenCLRevTests, MatrixPower_prim_rev_values_large) {
  int N = 71;
