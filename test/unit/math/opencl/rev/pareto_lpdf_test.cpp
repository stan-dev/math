...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_opencl_broadcast_y_min) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_opencl_broadcast_alpha) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Pareto_opencl_matches_cpu_big) {
  int N = 153;
