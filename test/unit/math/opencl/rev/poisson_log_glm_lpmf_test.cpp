...
TEST_F(OpenCLRevTests, probdistPoissonLogGLM_error_checking) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests, probdistPoissonLogGLM_opencl_broadcast_y) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests,
       probdistPoissonLogGLM_opencl_matches_cpu_zero_instances) {
  int N = 0;
  int M = 2;
...
TEST_F(OpenCLRevTests,
       probdistPoissonLogGLM_opencl_matches_cpu_zero_attributes) {
  int N = 3;
  int M = 0;
...
TEST_F(OpenCLRevTests, probdistPoissonLogGLM_opencl_matches_cpu_big) {
  int N = 153;
  int M = 71;
