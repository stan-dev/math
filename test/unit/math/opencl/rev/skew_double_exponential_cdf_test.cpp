...
TEST_F(OpenCLRevTests, prob_distributions_SkewDoubleExponentialCdf_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_SkewDoubleExponentialCdf_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests, prob_distributions_SkewDoubleExponentialCdf_opencl_matches_cpu_small_y_neg_inf) {
  int N = 3;
  int M = 2;
