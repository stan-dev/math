...
TEST_F(OpenCLRevTests,
       probdistributionsSkewDoubleExponentialLccdf_opencl_matches_cpu_small) {
  int N = 3;
  int M = 2;
...
TEST_F(
    OpenCLRevTests,
    probdistributionsSkewDoubleExponentialLccdf_opencl_matches_cpu_small_y_neg_inf) {
  int N = 3;
  int M = 2;
...
TEST_F(OpenCLRevTests,
       probdistributionsSkewDoubleExponentialLccdf_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       probdistributionsSkewDoubleExponentialLccdf_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests,
       probdistributionsSkewDoubleExponentialLccdf_opencl_matches_cpu_big) {
  int N = 153;
