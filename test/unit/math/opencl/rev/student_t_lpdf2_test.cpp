...
TEST_F(OpenCLRevTests, prob_distributions_StudentT_opencl_broadcast_nu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_StudentT_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_StudentT_opencl_broadcast_sigma) {
  int N = 3;
