...
TEST_F(OpenCLRevTests, probdistributionsStudentT_opencl_broadcast_nu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistributionsStudentT_opencl_broadcast_mu) {
  int N = 3;
...
TEST_F(OpenCLRevTests, probdistributionsStudentT_opencl_broadcast_sigma) {
  int N = 3;
