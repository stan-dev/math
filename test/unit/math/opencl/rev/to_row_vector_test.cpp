...
TEST_F(OpenCLRevTests, ToRowVector_prim_rev_values_small) {
  Eigen::VectorXd a(6);
...
TEST_F(OpenCLRevTests, ToRowVector_prim_rev_size_0) {
  Eigen::VectorXd a(0);
  Eigen::RowVectorXd b = a;
...
TEST_F(OpenCLRevTests, ToRowVector_prim_rev_values_large) {
  int N = 71;
  int M = 87;
