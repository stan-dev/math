...
TEST(OpenCLToVector, prim_rev_values_small) {
  ...
  stan::math::test::compare_cpu_opencl_prim_rev(to_vector_functor, a);
  stan::math::test::compare_cpu_opencl_prim_rev(to_vector_functor, b);
  stan::math::test::compare_cpu_opencl_prim_rev(to_vector_functor, c);
