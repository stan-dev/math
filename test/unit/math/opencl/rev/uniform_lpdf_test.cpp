...
TEST_F(OpenCLRevTests, prob_distributions_Uniform_opencl_matches_cpu_small) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Uniform_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Uniform_opencl_broadcast_alpha) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Uniform_opencl_broadcast_beta) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Uniform_opencl_matches_cpu_big) {
  int N = 153;
