...
TEST_F(OpenCLRevTests, prob_distributions_Weibull_error_checking) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Weibull_opencl_broadcast_y) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Weibull_opencl_broadcast_alpha) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Weibull_opencl_broadcast_sigma) {
  int N = 3;
...
TEST_F(OpenCLRevTests, prob_distributions_Weibull_opencl_matches_cpu_big) {
  int N = 153;
