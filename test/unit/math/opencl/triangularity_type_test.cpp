...
TEST(PartialViewCL, operator_add) {
  ...
  EXPECT_EQ(PartialViewCL::Lower,
     PartialViewCL::Lower + PartialViewCL::Lower);
  ...
  EXPECT_EQ(PartialViewCL::Upper,
     PartialViewCL::Upper + PartialViewCL::Upper);
  EXPECT_EQ(PartialViewCL::Upper,
...
TEST(PartialViewCL, is_not_diagonal) {
  ...
  EXPECT_EQ(false,
     is_not_diagonal(PartialViewCL::Lower, PartialViewCL::Upper));

  EXPECT_EQ(true,
     is_not_diagonal(PartialViewCL::Lower, PartialViewCL::Lower));
  EXPECT_EQ(true,
     is_not_diagonal(PartialViewCL::Entire, PartialViewCL::Lower));

  EXPECT_EQ(true,
     is_not_diagonal(PartialViewCL::Upper, PartialViewCL::Upper));
  EXPECT_EQ(true,
     is_not_diagonal(PartialViewCL::Entire, PartialViewCL::Upper));
  EXPECT_EQ(true,
...
TEST(PartialViewCL, from_eigen_triangular_type) {
  ...
  EXPECT_EQ(PartialViewCL::Entire, from_eigen_triangular_type(Eigen::SelfAdjoint));
