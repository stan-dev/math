...
public:
  ...
  solve(const std::vector<double>& theta) const {
    ...
    const char *mesh_file = "./escher.mesh";
    int order = 1;
    bool visualization = 1;

    char arg0[] = "mfem_setup";
    char *argv[] = {arg0, NULL};
    ...
    // only one QoI: the norm error between numerical sol and exact sol
    return {{err_u}};
  }
};
