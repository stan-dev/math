...
TEST(ErrorHandlingScalar_mat, CheckLessOrEqual_Matrix) {
  const char* function = "check_less_or_equal";
  double x;
  double high;
...
TEST(ErrorHandlingScalar_mat, CheckLessOrEqual_Matrix_one_indexed_message) {
...
TEST(ErrorHandlingScalar_mat, CheckLessOrEqual_nan) {
  const char* function = "check_less_or_equal";
  double nan = std::numeric_limits<double>::quiet_NaN();
