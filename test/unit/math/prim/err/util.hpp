...
#define STAN_EXPECT_THROW_MSG(statement, err_type, message) EXPECT_NO_THROW(statement)
#else
#define STAN_EXPECT_THROW(statement, err_type) EXPECT_THROW(statement, err_type)
#define STAN_EXPECT_THROW_MSG(statement, err_type, message) EXPECT_THROW_MSG(statement, err_type, message)
#endif
