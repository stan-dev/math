...
TEST(MathMatrix_mat, distance_vector_vector) {
...
TEST(MathMatrix_mat, distance_rowvector_vector) {
...
TEST(MathMatrix_mat, distance_vector_rowvector) {
  Eigen::Matrix<double, Eigen::Dynamic, 1> v;
  Eigen::Matrix<double, 1, Eigen::Dynamic> rv;
...
TEST(MathMatrix_mat, distance_special_values) {
  Eigen::Matrix<double, Eigen::Dynamic, 1> v1, v2;
  v1.resize(1);
  v2.resize(1);
