...
TEST(MathFunctions, Equal) {
  ...
  constexpr std::array p_tails{0.000000001, 0.0000001, 0.99999, 0.9999999,
                               0.999999999};
  constexpr std::array p{0.00001, 0.001, 0.05, 0.15, 0.25, 0.35, 0.45,
                         0.55,    0.65,  0.75, 0.85, 0.95, 0.999};
