...
TEST(MathFunctionsPromoteScalar_arr, VectorMatch) {
  using stan::math::promote_scalar;
  std::vector<int> x;
  x.push_back(13);
  x.push_back(27);
...
TEST(MathFunctionsPromoteScalar_arr, Vector2Mismatch) {
  using stan::math::promote_scalar;
  using std::vector;
...
TEST(MathFunctionsPromoteScalar_arr, Vector2Match) {
  using stan::math::promote_scalar;
  using std::vector;
...
TEST(MathMatrixPromoteScalar_mat, MatrixMatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
...
TEST(MathMatrixPromoteScalar_mat, VectorMatrixMismatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
  using std::vector;
...
TEST(MathMatrixPromoteScalar_mat, ColVectorMismatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
...
TEST(MathMatrixPromoteScalar_mat, ColVectorMatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
...
TEST(MathMatrixPromoteScalar_mat, VectorColVectorMismatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
  using std::vector;
...
TEST(MathMatrixPromoteScalar_mat, RowVectorMismatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
...
TEST(MathMatrixPromoteScalar_mat, RowVectorMatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
...
TEST(MathMatrixPromoteScalar_mat, VectorRowVectorMismatch) {
  using Eigen::Dynamic;
  using Eigen::Matrix;
  using stan::math::promote_scalar;
  using std::vector;
