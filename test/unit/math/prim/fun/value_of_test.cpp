...
TEST(MathFunctions_arr, value_of_int_return_type_short_circuit) {
...
TEST(MathFunctions_arr, value_of_double_return_type_short_circuit) {
...
TEST(MathFunctions_mat, value_of_return_type_short_circuit_vector_xd) {
...
TEST(MathFunctions_mat, value_of_return_type_short_circuit_row_vector_xd) {
...
TEST(MathFunctions_mat, value_of_return_type_short_circuit_matrix_xd) {
