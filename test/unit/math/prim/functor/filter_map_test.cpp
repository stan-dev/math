...
TEST(MathFunctions, filter_map_inner_tuple_mix_value_type) {
  ...
  static_assert(!stan::test::is_ref_element_v<0, decltype(args)>,
                "0th should not be a reference!");
  static_assert(is_same_tuple_element_v<0, decltype(args), double>,
                "0th should be a double!");
  static_assert(is_lvalue_ref_element_v<1, decltype(args)>,
                "1st should be an lvalue!");
  static_assert(is_same_tuple_element_v<1, decltype(args), std::vector<int>>,
                "0th should be an std::vector<int>!");
  static_assert(is_lvalue_ref_element_v<2, decltype(args)>,
                "2nd should be an lvalue!");
  static_assert(is_same_tuple_element_v<2, decltype(args), double>,
                "0th should be a double!");
  static_assert(!stan::test::is_ref_element_v<3, decltype(args)>,
                "3rd should not be a reference!");
  static_assert(is_same_tuple_element_v<3, decltype(args), std::vector<int>>,
                "0th should be an std::vector<int>!");
  ...
  static_assert(is_same_tuple_element_v<1, inner_tuple_t, std::vector<int>>,
                "0th should be an std::vector<int>!");
  static_assert(is_lvalue_ref_element_v<5, decltype(args)>,
                "5th should be an lvalue!");
  static_assert(is_same_tuple_element_v<5, decltype(args), std::vector<int>>,
                "0th should be an std::vector<int>!");
  static_assert(!stan::test::is_ref_element_v<6, decltype(args)>,
                "6th should not be a reference!");
  static_assert(is_same_tuple_element_v<6, decltype(args), double>,
                "0th should be a double!");
}
