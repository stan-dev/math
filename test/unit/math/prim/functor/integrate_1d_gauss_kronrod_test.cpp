...
TEST(StanMath_integrate_1d_gk_prim, test_integer_arguments) {
  ...
  EXPECT_NO_THROW(stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0, 1, std::vector<double>{0.5}, {}, {},
      integrate_1d_gk_test::msgs, 1e-6));
  EXPECT_NO_THROW(stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0.0, 1, std::vector<double>{0.5}, {}, {},
      integrate_1d_gk_test::msgs, 1e-6));
  EXPECT_NO_THROW(stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0, 1.0, std::vector<double>{0.5}, {}, {},
      integrate_1d_gk_test::msgs, 1e-6));
}
...
TEST(StanMath_integrate_1d_gk_prim, test1_smooth) {
  ...
  test_integration(integrate_1d_gk_test::f4{}, 0.0, 0.0, {0.5}, {}, {}, 0.0);
...
TEST(StanMath_integrate_1d_gk_prim, max_depth_argument) {
  ...
  double Q = stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0.2, 0.7, std::vector<double>{0.5},
      std::vector<double>{}, std::vector<int>{}, integrate_1d_gk_test::msgs,
      1e-8, 0.0, 20);
...
TEST(StanMath_integrate_1d_gk_prim, abs_tol_suppresses_throw) {
  ...
  double Q = 0.0;
  EXPECT_NO_THROW(Q = stan::math::integrate_1d_gauss_kronrod(
                      integrate_1d_gk_test::f10{}, 0.0, 1.0,
                      std::vector<double>{0.1, 0.1}, {}, {},
                      integrate_1d_gk_test::msgs, 1e-6, 1e6));
  EXPECT_GT(Q, 1.0);
  EXPECT_LT(Q, 1000.0);
}
...
TEST(StanMath_integrate_1d_gk_prim, abs_tol_argument_smoke) {
  ...
  double Q0 = stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0.2, 0.7, std::vector<double>{0.5},
      std::vector<double>{}, std::vector<int>{}, integrate_1d_gk_test::msgs,
      1e-8, 0.0);
  double Q1 = stan::math::integrate_1d_gauss_kronrod(
      integrate_1d_gk_test::f4{}, 0.2, 0.7, std::vector<double>{0.5},
      std::vector<double>{}, std::vector<int>{}, integrate_1d_gk_test::msgs,
      1e-8, 1e-12);
