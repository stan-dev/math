...
TEST(MathFunctions, multi_expression_many_expressions) {
  ...
  RowMat f, g;
  stan::math::eigen_results(d, e.block(2, 1, 2, 3), f, g) = stan::math::eigen_expressions(
      a * 2, b.block(0, 1, 3, 2).transpose() + a,
      c.block(2, 1, 2, 3) + a, b.block(0, 1, 3, 2).transpose().array() - 2);
...
TEST(MathFunctions, multi_expression_many_expressions2) {
  ...
  Eigen::MatrixXd d, e(c);
  RowMat f, g;
  stan::math::eigen_results(d, e.block(2, 1, 2, 2), f, g) = stan::math::eigen_expressions(
