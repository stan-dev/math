...
TEST(MathMatrix, multiply_opencl) {
  int multiply_result_size_worth_transfer_temp =  stan::math::opencl_context.tuning_opts().multiply_result_size_worth_transfer;
  int multiply_common_dim_worth_transfer_temp = stan::math::opencl_context.tuning_opts().multiply_common_dim_worth_transfer;
  ...
  stan::math::opencl_context.tuning_opts().multiply_result_size_worth_transfer = INT_MAX;
  stan::math::opencl_context.tuning_opts().multiply_common_dim_worth_transfer = INT_MAX;

  stan::math::matrix_d m3 = multiply(m1, m2);

  EXPECT_MATRIX_NEAR(m3_cl, m3, 1e-10);
  stan::math::opencl_context.tuning_opts().multiply_result_size_worth_transfer = multiply_result_size_worth_transfer_temp;
  stan::math::opencl_context.tuning_opts().multiply_common_dim_worth_transfer = multiply_common_dim_worth_transfer_temp;
