...
struct double_exponential_rng_wrapper {
...
TEST(ProbDistributionsDoubleExponential, errorCheck) {
  check_dist_throws_all_types(double_exponential_rng_wrapper{},
...
TEST(ProbDistributionsDoubleExponential, chiSquareGoodnessFitTest) {
  ...
  check_quantiles_all_types(N, M, double_exponential_rng_wrapper{}, build_quantiles,
                            {-2.5, -1.7, -0.1, 0.0, 2.0, 5.8},
                            {0.1, 1.0, 2.5, 4.0},
                            {});
}
