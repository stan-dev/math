...
TEST(ProbLkjCorr, log_matches_lpmf) {
  ...
  EXPECT_FLOAT_EQ((stan::math::lkj_corr_lpdf<true, double, double>
                                                                (Sigma, eta)),
                  (stan::math::lkj_corr_log<true, double, double>
                                                                (Sigma, eta)));
  EXPECT_FLOAT_EQ((stan::math::lkj_corr_lpdf<false, double, double>
                                                                (Sigma, eta)),
                  (stan::math::lkj_corr_log<false, double, double>
                                                                (Sigma, eta)));
}
