...
TEST(ProbMultiGpCholesky, log_matches_lpmf) {
  ...
  EXPECT_FLOAT_EQ(
    (stan::math::multi_gp_cholesky_lpdf<true, double, double, double>
                                                                  (y, L, w)),
    (stan::math::multi_gp_cholesky_log<true, double, double, double>
                                                                  (y, L, w)));
  EXPECT_FLOAT_EQ(
    (stan::math::multi_gp_cholesky_lpdf<false, double, double, double>
                                                                  (y, L, w)),
    (stan::math::multi_gp_cholesky_log<false, double, double, double>
                                                                  (y, L, w)));
  EXPECT_FLOAT_EQ(
