...
TEST(ProbWishart, log_matches_lpmf) {
  ...
  EXPECT_FLOAT_EQ(
      (stan::math::wishart_lpdf<true, double, double, double>(Y, dof, Sigma)),
      (stan::math::wishart_log<true, double, double, double>(Y, dof, Sigma)));
  EXPECT_FLOAT_EQ(
      (stan::math::wishart_lpdf<false, double, double, double>(Y, dof, Sigma)),
      (stan::math::wishart_log<false, double, double, double>(Y, dof, Sigma)));
  EXPECT_FLOAT_EQ(
      (stan::math::wishart_lpdf<double, double, double>(Y, dof, Sigma)),
