...
build_binary_vector1(std::vector<int> template_v) {
  return F::int_valid_inputs1();
}

template <typename F>
static inline std::vector<int>
build_binary_vector2(std::vector<int> template_v) {
  return F::int_valid_inputs2();
}

template <typename F>
static inline std::vector<double>
build_binary_vector1(std::vector<double> template_v) {
  return F::valid_inputs1();
}

template <typename F>
static inline std::vector<double>
build_binary_vector2(std::vector<double> template_v) {
