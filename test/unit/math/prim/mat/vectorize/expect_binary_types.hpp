...
void expect_int_binary_types() {
  ...
  expect_binary_match_return_t<F, vector<double>, vector<int>, vector<int> >();
  expect_binary_match_return_t<F, vector<vector<double> >, vector<vector<int> >,
                               vector<vector<int> > >();
}
...
void expect_binary_types() {
  ...
  expect_binary_match_return_t<F, vector<result_t>, vector<T1>, vector<T2> >();
  expect_binary_match_return_t<F, vector<vector<result_t> >,
                               vector<vector<T1> >, vector<vector<T2> > >();
  expect_binary_match_return_t<F, result_matrix_t, matrix_t1, matrix_t2>();
  expect_binary_match_return_t<F, vector<result_matrix_t>, vector<matrix_t1>,
                               vector<matrix_t2> >();
  expect_binary_match_return_t<F, result_vector_t, vector_t1, vector_t2>();
  expect_binary_match_return_t<F, vector<result_vector_t>, vector<vector_t1>,
                               vector<vector_t2> >();
  ...
  expect_binary_match_return_t<F, vector<result_row_vector_t>,
                               vector<row_vector_t1>, vector<row_vector_t2> >();
}
