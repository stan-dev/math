...
TEST(MetaTraits_arr, contains_vector_true) {
  using stan::contains_std_vector;
  using std::vector;
...
TEST(MetaTraits_arr, contains_std_vector_false) {
  using stan::contains_std_vector;
...
TEST(MetaTraits_mat, contains_vector_true) {
  using stan::contains_std_vector;
  using std::vector;
...
TEST(MetaTraits_mat, contains_vector_false) {
  using stan::contains_std_vector;
