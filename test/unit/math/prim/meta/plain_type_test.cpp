...
TEST(MetaTraitsPrimMat, plain_type_non_eigen) {
  ...
  test::expect_same_type<stan::math::var, stan::plain_type_t<stan::math::var>>();
...
TEST(MetaTraitsPrimMat, plain_type_eigen) {
  test::expect_same_type<Eigen::MatrixXd, stan::plain_type_t<Eigen::MatrixXd>>();
  test::expect_same_type<Eigen::VectorXd, stan::plain_type_t<Eigen::VectorXd>>();
  test::expect_same_type<Eigen::ArrayXXd, stan::plain_type_t<Eigen::ArrayXXd>>();
  ...
  test::expect_same_type<Eigen::MatrixXd, stan::plain_type_t<decltype(m1 - m2)>>();
  test::expect_same_type<Eigen::VectorXd, stan::plain_type_t<decltype(v1 + v2)>>();
