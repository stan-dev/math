...
TEST(requires_prim_mat, eigen_row_and_col) {
  ...
  using stan::test::require_variadic_checker;
  EXPECT_TRUE((require_variadic_checker<require_eigen_row_and_col_t, RowVectorXd,
                                        VectorXd>::value));
  ...
  EXPECT_TRUE((require_variadic_checker<require_not_eigen_row_and_col_t,
                                        VectorXd, VectorXd>::value));
  EXPECT_FALSE((require_variadic_checker<require_eigen_row_and_col_t, RowVectorXd,
                                         RowVectorXd>::value));
  EXPECT_TRUE((require_variadic_checker<require_not_eigen_row_and_col_t,
