...
TEST(matrixTest_mat, seq_view_double_stdvector) {
...
TEST(matrixTest_mat, seq_view_double_vector) {
  vector_d y(2);
  y[0] = 1.0;
  y[1] = 2.0;
...
TEST(matrixTest_mat, seq_view_double_row_vector) {
  row_vector_d y(2);
  y[0] = 1.0;
  y[1] = 2.0;
...
TEST(matrixTest_mat, seq_view_double_double) {
  double x = 2.0;
...
TEST(matrixTest_mat, seq_view_double_matrix) {
...
TEST(matrixTest_mat, seq_view_vec_vec_double) {
...
TEST(matrixTest_mat, seq_view_double_int) {
  std::vector<int> x(3);
  x[0] = 0;
  x[1] = 1;
  x[2] = 4;
