...
TEST(ProbDistributionsPoissonBinomial, check_error_theta_is_not_prob) {
  ...
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(1, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(1, theta2), std::domain_error);
}
...
TEST(ProbDistributionsPoissonBinomial, check_error_vectorial_y_oob) {
  ...
  EXPECT_THROW(stan::math::poisson_binomial_lpmf(ys1, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lpmf(ys2, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lcdf(ys1, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lcdf(ys2, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(ys1, theta), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(ys2, theta), std::domain_error);
}
...
TEST(ProbDistributionsPoissonBinomial, check_error_vectorial_theta_is_not_prob) {
  ...
  EXPECT_THROW(stan::math::poisson_binomial_lpmf(ys, thetas), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lcdf(ys, thetas), std::domain_error);
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(ys, thetas), std::domain_error);
}
...
TEST(ProbDistributionsPoissonBinomial, check_error_vectorial_y_and_theta_inconsistent_sizes) {
  ...
  EXPECT_THROW(stan::math::poisson_binomial_lpmf(ys, thetas), std::invalid_argument);
  EXPECT_THROW(stan::math::poisson_binomial_lcdf(ys, thetas), std::invalid_argument);
  EXPECT_THROW(stan::math::poisson_binomial_lccdf(ys, thetas), std::invalid_argument);
}
