...
TEST(MathFunctions, distance_nan) {
  ...
  EXPECT_THROW(stan::math::distance(x, nan),
               std::domain_error);
  EXPECT_THROW(stan::math::distance(nan, x),
               std::domain_error);
  EXPECT_THROW(stan::math::distance(nan, nan),
               std::domain_error);
}
...
TEST(MathFunctions, distance_inf) {
  ...
  EXPECT_THROW(stan::math::distance(x, inf),
               std::domain_error);
  EXPECT_THROW(stan::math::distance(inf, x),
               std::domain_error);
  EXPECT_THROW(stan::math::distance(inf, inf),
               std::domain_error);
}
