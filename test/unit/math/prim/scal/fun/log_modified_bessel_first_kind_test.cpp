...
TEST(MathFunctions, log_modified_bessel_first_kind) {
  ...
  EXPECT_FLOAT_EQ(log_modified_bessel_first_kind(0, 100),
                  log_modified_bessel_first_kind(0, 100 + 1e-16));
...
TEST(MathFunctions, log_modified_bessel_first_kind_throw) {
  ...
  EXPECT_THROW(log_modified_bessel_first_kind(0.5, -2),  std::domain_error);
}
