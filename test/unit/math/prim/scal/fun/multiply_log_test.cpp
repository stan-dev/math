...
TEST(MathFunctions, multiply_log_nan) {
  ...
  EXPECT_PRED1(boost::math::isnan<double>, stan::math::multiply_log(2.0, nan));
  EXPECT_PRED1(boost::math::isnan<double>, stan::math::multiply_log(nan, 3.0));
  EXPECT_PRED1(boost::math::isnan<double>, stan::math::multiply_log(nan, nan));
}
