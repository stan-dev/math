...
TEST(ProbBeta, log_matches_lpdf) {
  ...
  EXPECT_FLOAT_EQ(
      (stan::math::beta_lpdf<true, double, double, double>(y, alpha, beta)),
      (stan::math::beta_log<true, double, double, double>(y, alpha, beta)));
  EXPECT_FLOAT_EQ(
      (stan::math::beta_lpdf<false, double, double, double>(y, alpha, beta)),
      (stan::math::beta_log<false, double, double, double>(y, alpha, beta)));
  EXPECT_FLOAT_EQ(
      (stan::math::beta_lpdf<double, double, double>(y, alpha, beta)),
