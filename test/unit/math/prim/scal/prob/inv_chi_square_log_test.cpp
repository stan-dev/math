...
TEST(ProbInvChiSquare, log_matches_lpdf) {
  ...
  EXPECT_FLOAT_EQ((stan::math::inv_chi_square_lpdf<true,
                                                   double, double>(y, nu)),
                  (stan::math::inv_chi_square_log<true,
                                                   double, double>(y, nu)));
  EXPECT_FLOAT_EQ((stan::math::inv_chi_square_lpdf<false,
                                                   double, double>(y, nu)),
                  (stan::math::inv_chi_square_log<false,
                                                  double, double>(y, nu)));
