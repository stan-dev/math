...
TEST(ProbInvGamma, log_matches_lpdf) {
  ...
  EXPECT_FLOAT_EQ((stan::math::inv_gamma_lpdf<true, double, double, double>(y, alpha, beta)),
                  (stan::math::inv_gamma_log<true, double, double, double>(y, alpha, beta)));
  EXPECT_FLOAT_EQ((stan::math::inv_gamma_lpdf<false, double, double, double>(y, alpha, beta)),
                  (stan::math::inv_gamma_log<false, double, double, double>(y, alpha, beta)));
  EXPECT_FLOAT_EQ((stan::math::inv_gamma_lpdf<double, double, double>(y, alpha, beta)),
