...
TEST(ProbScaledInvChiSquare, log_matches_lpdf) {
  ...
  EXPECT_FLOAT_EQ((stan::math::scaled_inv_chi_square_lpdf<false>(y, nu,
                                                                    sigma)),
                  (stan::math::scaled_inv_chi_square_log<false>(y, nu,
                                                                    sigma)));
  EXPECT_FLOAT_EQ((stan::math::scaled_inv_chi_square_lpdf<true,
                                                          double,
                                                          double,
                                                          double>(y, nu,
                                                                    sigma)),
                  (stan::math::scaled_inv_chi_square_log<true,
                                                         ...
                                                         double>(y, nu,
                                                                    sigma)));
  EXPECT_FLOAT_EQ((stan::math::scaled_inv_chi_square_lpdf<false,
                                                          double,
                                                          double,
                                                          double>(y, nu,
                                                                     sigma)),
                  (stan::math::scaled_inv_chi_square_log<false,
                                                         ...
                                                         double>(y, nu,
                                                                    sigma)));
  EXPECT_FLOAT_EQ((stan::math::scaled_inv_chi_square_lpdf<double,
                                                          double,
                                                          double>(y, nu,
                                                                     sigma)),
                  (stan::math::scaled_inv_chi_square_log<double,
                                                         double,
                                                         double>(y, nu,
                                                                    sigma)));
}
