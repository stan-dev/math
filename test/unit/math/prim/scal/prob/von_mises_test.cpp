...
TEST(ProbDistributionsVonMises, error_check) {
  ...
  EXPECT_THROW(stan::math::von_mises_rng(1, stan::math::positive_infinity(),
                                          rng),
               std::domain_error);
...
TEST(ProbDistributionsVonMises, chiSquareGoodnessFitTest2) {
  ...
  double loc[]
    = {1.5890, 1.8351, 1.9771, 2.0788, 2.1590, 2.2258, 2.2833, 2.3343,
...
TEST(ProbDistributionsVonMises, chiSquareGoodnessFitTest3) {
  ...
  double loc[]
    = {-0.552560, -0.306511, -0.164502, -0.062786,  0.017401,  0.084166,
        0.141753, 0.192668,  0.238514,  0.280381, 0.319043, 0.355071,
        0.388899, 0.420864, 0.451235,  0.480226,  0.508016,  0.534753,
        0.560560,  0.585545, 0.609796, 0.633395,  0.656409,  0.678900,
        0.700922,  0.722523,  0.743748, 0.764635, 0.785221,  0.805540,
        0.825622,  0.845496,  0.865190,  0.884728, 0.904136, 0.923435,
        0.942650,  0.961802,  0.980911,  1.000000,  1.019089, 1.038198,
        1.057350,  1.076565,  1.095864,  1.115272,  1.134810,  1.154504,
        1.174378, 1.194460,  1.214779,  1.235365,  1.256252,  1.277477,
        1.299078, 1.321100, 1.343591,  1.366605,  1.390204,  1.414455,
        1.439440,  1.465247, 1.491984, 1.519774,  1.548765,  1.579136,
        1.611101,  1.644929,  1.680957, 1.719619, 1.761486,  1.807332,
        1.858247,  1.915834,  1.982599,  2.062786, 2.164502, 2.306511,
        2.552560};
  int count = 0;
  int bin[K];
  double expect[K];
