...
#include <test/unit/math/prim/vectorize/expect_prim_scalar_value.hpp>
#include <test/unit/math/prim/vectorize/expect_prim_std_vector_value.hpp>
#include <test/unit/math/prim/vectorize/expect_prim_matrix_value.hpp>
#include <test/unit/math/prim/vectorize/expect_prim_vector_value.hpp>
#include <test/unit/math/prim/vectorize/expect_prim_row_vector_value.hpp>
