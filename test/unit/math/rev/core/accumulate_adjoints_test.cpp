...
TEST_F(AgradRev, accumulate_adjoints_int_arg) {
  int arg = 5;
  Eigen::VectorXd storage = Eigen::VectorXd::Zero(1000);
...
TEST_F(AgradRev, accumulate_adjoints_double_arg) {
  double arg = 5.0;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_int) {
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_double_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_eigen_vector_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_rowvector_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_matrix_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_std_vector_double_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_vector_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_row_vector_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_matrix_arg) {
...
TEST_F(AgradRev, accumulate_adjoints_var_arg) {
  using stan::math::var;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_eigen_vector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_eigen_rowvector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_eigen_matrix_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_std_vector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_vector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_row_vector_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_std_vector_eigen_matrix_var_arg) {
  using stan::math::var;
  using stan::math::vari;
...
TEST_F(AgradRev, accumulate_adjoints_sum) {
  using stan::math::var;
  using stan::math::vari;
  int arg1 = 1;
  double arg2 = 1.0;
