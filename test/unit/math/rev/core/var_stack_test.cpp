...
TEST_F(AgradRev, RevStack_varStackRecoverNestedSegFaultFix) {
...
TEST_F(AgradRev, RevStack_varStack) {
  stan::math::var a = 2.0;
  stan::math::var b = -3.0;
  stan::math::var f = a * b;
...
TEST_F(AgradRev, RevStack_recoverMemoryLogicError) {
  stan::math::start_nested();
...
TEST_F(AgradRev, RevStack_recoverMemoryNestedLogicError) {
