...
TEST_F(AgradRev, insertion_operator) {
  stan::math::vari v(5);
  std::stringstream ss;
  ss << &v;
...
TEST_F(AgradRev, long_double_test) {
...
TEST_F(AgradRev, dense_matrix_vari) {
...
TEST_F(AgradRev, dense_vector_vari) {
  using stan::math::vari_value;
...
TEST_F(AgradRev, dense_row_vector_vari) {
  using stan::math::vari_value;
