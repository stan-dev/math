...
TEST_F(AgradRev, if_else_nan) {
  ...
  EXPECT_TRUE(std::isnan(if_else(false, 1.2, nan_v).val()));
  ...
  EXPECT_TRUE(std::isnan(if_else(true, nan_v, nan).val()));
  EXPECT_TRUE(std::isnan(if_else(true, nan, nan_v).val()));
  EXPECT_TRUE(std::isnan(if_else(true, nan_v, nan_v).val()));
  EXPECT_TRUE(std::isnan(if_else(false, nan, nan_v).val()));
  EXPECT_TRUE(std::isnan(if_else(false, nan_v, nan).val()));
