 ...
 */
using chemical_kinetics_test_types = boost::mp11::mp_product<
    ode_test_tuple,
...
TYPED_TEST_P(chemical_kinetics_test, value_1) {
  this -> test_value(0.0);
}
TYPED_TEST_P(chemical_kinetics_test, value_2) {
  this -> test_value(1.0);
}
TYPED_TEST_P(chemical_kinetics_test, value_3) {
  this -> test_value(-1.0);
}

TYPED_TEST_P(chemical_kinetics_test, error) {
  this -> test_bad();
}

REGISTER_TYPED_TEST_SUITE_P(chemical_kinetics_test,
                            value_1, value_2, value_3, error,
...
TYPED_TEST_P(chemical_kinetics_data_test, value_1) {
  this -> test_value(0.0);
}
TYPED_TEST_P(chemical_kinetics_data_test, value_2) {
  this -> test_value(1.0);
}
TYPED_TEST_P(chemical_kinetics_data_test, value_3) {
  this -> test_value(-1.0);
}
...
REGISTER_TYPED_TEST_SUITE_P(chemical_kinetics_data_test,
