...
using degenerated_dae_test_types
...
TYPED_TEST_P(degenerated_dae_test, y0_sens) {
  this -> test_ode_sens_y0();
}
TYPED_TEST_P(degenerated_dae_test, theta_sens) {
  this -> test_ode_sens_theta();
}
