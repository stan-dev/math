...
inline void test_derivatives(const F &f, double a, double b,
  ...
  for (auto tolerance : tolerances) {
    ...
    var integral = stan::math::integrate_1d_double_exponential_tol(
        f, a_, b_, tolerance, 0.0, 15, msgs, thetas_, x_r, x_i);
    integral.grad();
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_test_integer_arguments) {
  ...
  EXPECT_NO_THROW(v = stan::math::integrate_1d_double_exponential_tol(
                      f2{}, 0, 1, 1e-6, 0.0, 15, msgs, theta,
                      std::vector<double>{}, std::vector<int>{}));
  EXPECT_NO_THROW(v = stan::math::integrate_1d_double_exponential_tol(
                      f2{}, 0.0, 1, 1e-6, 0.0, 15, msgs, theta,
                      std::vector<double>{}, std::vector<int>{}));
  EXPECT_NO_THROW(v = stan::math::integrate_1d_double_exponential_tol(
                      f2{}, 0, 1.0, 1e-6, 0.0, 15, msgs, theta,
                      std::vector<double>{}, std::vector<int>{}));
}
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_easy) {
  ...
  test_derivatives<double, double, var>(
      f1{}, 0.2, 0.7, {0.75}, std::vector<double>{}, std::vector<int>{},
      0.7923499493102901 + 0.5 * 0.75, {0.5});
  test_derivatives<var, var, var>(f2{}, 0.0, 1.0, {0.5}, std::vector<double>{},
                                  std::vector<int>{}, 1.56348343527304,
                                  {1.25789445875152}, -2.148721270700128,
                                  2.14872127069993);
  test_derivatives<var, var, double>(
      f2{}, 0.0, 1.0, {0.5}, std::vector<double>{}, std::vector<int>{},
      1.56348343527304, {}, -2.148721270700128, 2.14872127069993);
  test_derivatives<double, double, var>(f1{}, 0.0, 0.0, {0.75},
                                        std::vector<double>{},
                                        std::vector<int>{}, 0.0, {0.0});
  test_derivatives<double, double, var>(f2{}, 1.0, 1.0, {0.5},
                                        std::vector<double>{},
                                        std::vector<int>{}, 0.0, {0.0});
}

TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_zero_crossing) {
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_no_param_vars) {
  // No param vars
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_left_limit_var) {
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_right_limit_var) {
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_tricky1) {
  // Tricky integral from Boost docs + limit at infinity + no gradients
  using stan::math::var;
  test_derivatives<double, double, var>(
      f4{}, 0.0, std::numeric_limits<double>::infinity(), {},
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_tricky3) {
  // Tricky integral from Boost docs
  using stan::math::var;
  test_derivatives<double, double, var>(
      f6{}, 0.0, 1.0, {0.75}, std::vector<double>{}, std::vector<int>{},
      0.851926727945904, {0.4814066053874294});
}
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_zero_crossing2) {
  ...
  test_derivatives<var, double, var>(
      ...
      std::vector<double>{}, std::vector<int>{}, 1205.361609637375,
      {5223.23364176196}, -1808.042414456063,
      std::numeric_limits<double>::quiet_NaN());
}

TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_zero_crossing3) {
  // Zero crossing integral + limit at negative infinity + var at right limit
  using stan::math::var;
  test_derivatives<double, var, var>(
      f8{}, -std::numeric_limits<double>::infinity(), 5.0, {1.5},
      std::vector<double>{}, std::vector<int>{}, 1205.361609637375,
      {5223.23364176196}, std::numeric_limits<double>::quiet_NaN(),
      1808.042414456063);
}

TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_indefinite) {
...
TEST_F(AgradRev,
  ...
  using stan::math::var;
  test_derivatives<double, double, var>(
      f11{}, 0.0, 1.0, {0.1, 0.1}, std::vector<double>{}, std::vector<int>{},
      19.71463948905016, {-101.229055967892, -101.229055967892});
  test_derivatives<double, double, var>(
      f11{}, 0.0, 1.0, {0.5, 0.51}, std::vector<double>{}, std::vector<int>{},
      3.098843783331868, {-4.346514423368675, -4.196150770134913});
  test_derivatives<double, double, var>(
      f11{}, 0.0, 1.0, {0.51, 0.5}, std::vector<double>{}, std::vector<int>{},
      3.098843783331868, {-4.196150770134913, -4.346514423368675});
  test_derivatives<double, double, var>(
      f11{}, 0.0, 1.0, {5.0, 3.0}, std::vector<double>{}, std::vector<int>{},
      0.00952380952380952, {-0.004852607709750566, -0.01040816326530613});
  test_derivatives<double, double, var>(
      f11{}, 0.0, 1.0, {3.0, 5.0}, std::vector<double>{}, std::vector<int>{},
      0.00952380952380952, {-0.01040816326530613, -0.004852607709750566});
}

TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDerivatives_gaussian) {
  // Check Gaussian integrates to 1.0 always
  using stan::math::var;
  test_derivatives<double, double, var>(
      f12{}, -std::numeric_limits<double>::infinity(),
      std::numeric_limits<double>::infinity(), {5.7, 1}, std::vector<double>{},
...
TEST_F(
  ...
  var integral = stan::math::integrate_1d_double_exponential_tol(
      f13{}, a, b, 1e-8, 0.0, 15, msgs, thetas, std::vector<double>{},
      std::vector<int>{});
  integral.grad();
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestBeta) {
  using stan::math::exp;
  ...
  auto pdf = [](auto x, auto xc, std::ostream *msgs, auto theta, auto x_r,
                auto x_i) {
    return exp(stan::math::beta_lpdf(x, theta[0], theta[1]));
  };
  var I = integrate_1d_double_exponential_tol(
      pdf, 0.0, 1.0, 1e-8, 0.0, 15, msgs, theta, std::vector<double>{},
      std::vector<int>{});
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestCauchy) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
  ...
  var I = integrate_1d_double_exponential_tol(pdf, a, b, 1e-8, 0.0, 15, msgs,
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestChiSquare) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
  ...
  double a = 0;
  auto pdf
      = [](auto x, auto xc, std::ostream *msgs, auto theta, auto x_r,
           auto x_i) { return exp(stan::math::chi_square_lpdf(x, theta[0])); };
  var I = integrate_1d_double_exponential_tol(pdf, a, b, 1e-8, 0.0, 15, msgs,
                                              theta, std::vector<double>{},
                                              std::vector<int>{});
  EXPECT_FLOAT_EQ(1, I.val());
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestDoubleExponential) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
  ...
  var I = integrate_1d_double_exponential_tol(pdf, a, b, 1e-8, 0.0, 15, msgs,
                                              theta, std::vector<double>{},
                                              std::vector<int>{})
          + integrate_1d_double_exponential_tol(pdf, b, -a, 1e-8, 0.0, 15, msgs,
                                                theta, std::vector<double>{},
                                                std::vector<int>{});
  EXPECT_FLOAT_EQ(1, I.val());
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestExponential) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
  ...
  auto pdf
      = [](auto x, auto xc, std::ostream *msgs, auto theta, auto x_r,
           auto x_i) { return exp(stan::math::exponential_lpdf(x, theta[0])); };
  var I = integrate_1d_double_exponential_tol(pdf, a, b, 1e-8, 0.0, 15, msgs,
                                              theta, std::vector<double>{},
                                              std::vector<int>{});
  EXPECT_FLOAT_EQ(1, I.val());
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestFrechet) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestGamma) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestGumbel) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestInvChiSquared) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestLogistic) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestLogNormal) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestNormal) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestPareto) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestPareto2) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestRayleigh) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
  ...
  auto pdf
      = [](auto x, auto xc, std::ostream *msgs, auto theta, auto x_r,
           auto x_i) { return exp(stan::math::rayleigh_lpdf(x, theta[0])); };
  var I = integrate_1d_double_exponential_tol(pdf, a, b, 1e-8, 0.0, 15, msgs,
                                              theta, std::vector<double>{},
                                              std::vector<int>{});
  EXPECT_FLOAT_EQ(1, I.val());
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestScaledInvChiSquare) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestStudentT) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestUniform) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestVonMises) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
...
TEST_F(AgradRev, StanMath_integrate_1d_de_rev_TestWeibull) {
  using stan::math::exp;
  using stan::math::integrate_1d_double_exponential;
  using stan::math::var;
