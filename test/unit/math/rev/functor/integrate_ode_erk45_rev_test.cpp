...
#include <test/unit/math/rev/functor/util_erk45.hpp>
...
void sho_value_test(F harm_osc, std::vector<double>& y0, double t0,
  ...
  std::vector<std::vector<var>> ode_res_vd = stan::math::integrate_ode_erk45(
...
TEST(StanAgradRevOde_integrate_ode_erk45, harmonic_oscillator_finite_diff) {
...
TEST(StanAgradRevOde_integrate_ode_erk45, lorenz_finite_diff) {
...
TEST(StanAgradRevOde_integrate_ode_erk45, time_steps_as_param) {
  using stan::math::integrate_ode_erk45;
  ...
  std::vector<std::vector<double>> res_d
      = integrate_ode_erk45(ode, y0, t0, value_of(ts), theta, x, x_int);
  ...
  res = integrate_ode_erk45(ode, y0, t0, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0v, t0, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0, t0, ts, thetav, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0v, t0, ts, thetav, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0, t0v, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0v, t0v, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0, t0v, ts, thetav, x, x_int);
  test_val();
  res = integrate_ode_erk45(ode, y0v, t0v, ts, thetav, x, x_int);
  test_val();
}

TEST(StanAgradRevOde_integrate_ode_erk45, time_steps_as_param_AD) {
  using stan::math::integrate_ode_erk45;
  using stan::math::to_var;
  using stan::math::value_of;
  using stan::math::var;
...
TEST(StanAgradRevOde_integrate_ode_erk45, t0_as_param_AD) {
  using stan::math::integrate_ode_erk45;
  using stan::math::to_var;
  using stan::math::value_of;
  using stan::math::var;
