...
void sho_value_test(F harm_osc, std::vector<double>& y0, double t0,
  ...
  std::vector<std::vector<var>> ode_res_vd
      = stan::math::integrate_ode_rk45<std::vector<T_theta>,
...
TEST(StanAgradRevOde_integrate_ode_rk45, time_steps_as_param) {
  ...
  std::vector<std::vector<double>> res_d
      = integrate_ode_rk45<std::vector<double>, std::vector<double>,
                           std::vector<int>>(ode, y0, t0, value_of(ts), theta,
                                             x, x_int);
  ...
  res = integrate_ode_rk45<std::vector<double>, std::vector<double>,
                           std::vector<int>>(ode, y0, t0, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<double>, std::vector<double>,
                           std::vector<int>>(ode, y0v, t0, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<stan::math::var>, std::vector<double>,
                           std::vector<int>>(ode, y0, t0, ts, thetav, x, x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<stan::math::var>, std::vector<double>,
                           std::vector<int>>(ode, y0v, t0, ts, thetav, x,
                                             x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<double>, std::vector<double>,
                           std::vector<int>>(ode, y0, t0v, ts, theta, x, x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<double>, std::vector<double>,
                           std::vector<int>>(ode, y0v, t0v, ts, theta, x,
                                             x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<stan::math::var>, std::vector<double>,
                           std::vector<int>>(ode, y0, t0v, ts, thetav, x,
                                             x_int);
  test_val();
  res = integrate_ode_rk45<std::vector<stan::math::var>, std::vector<double>,
                           std::vector<int>>(ode, y0v, t0v, ts, thetav, x,
                                             x_int);
  test_val();
}
