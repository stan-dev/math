...
TEST(StanMathRev, vd) {
  ...
  stan::math::internal::integrate_ode_std_vector_interface_adapter<harm_osc_ode_data_fun>
  ...
  Eigen::Matrix<var, Eigen::Dynamic, 1> out1 = stan::math::to_vector(harm_osc(t, y, nullptr, theta, x, x_int));
  Eigen::Matrix<var, Eigen::Dynamic, 1> out2 = harm_osc_adapted(t, stan::math::to_vector(y), nullptr, theta, x, x_int);
