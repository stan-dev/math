...
struct map_rect2 : public ::testing::Test {
...
TEST_F(map_rect2, concurrent_eval_ok_vd) {
...
TEST_F(map_rect2, concurrent_eval_ok_dv) {
...
TEST_F(map_rect2, concurrent_eval_ok_vv) {
  stan::math::vector_v shared_params_v = stan::math::to_var(shared_params_d);
  std::vector<stan::math::vector_v> job_params_v;
