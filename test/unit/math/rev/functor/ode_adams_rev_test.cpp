...
TEST(StanMathOde_ode_adams, scalar_arg) {
  ...
  var output = stan::math::ode_adams(stan::test::CosArg1(), y0, t0, ts, nullptr, a)[0][0];
...
TEST(StanMathOde_ode_adams, scalar_std_vector_args) {
  ...
  var output
    = stan::math::ode_adams(stan::test::Cos2Arg(), y0, t0, ts, nullptr, a0, a1)[0][0];
...
TEST(StanMathOde_ode_adams, std_vector_std_vector_args) {
  ...
  var output = stan::math::ode_adams(stan::test::CosArg1(), y0, t0, ts, nullptr, a2)[0][0];
...
TEST(StanMathOde_ode_adams, arg_combos_test) {
  ...
  double yT1 = stan::math::ode_adams(stan::test::ayt(), y0d, t0d, tsd, nullptr, ad)[0](0);
  check_yT(yT1);

  var yT2 = stan::math::ode_adams(stan::test::ayt(), y0d, t0d, tsd, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT2.grad();
  check_yT(yT2);
  check_a(a);

  var yT3 = stan::math::ode_adams(stan::test::ayt(), y0d, t0d, ts, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT3.grad();
  check_yT(yT3);
  check_ts(ts);

  var yT4 = stan::math::ode_adams(stan::test::ayt(), y0d, t0d, ts, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT4.grad();
  check_yT(yT4);
  check_ts(ts);
  ...
  var yT5 = stan::math::ode_adams(stan::test::ayt(), y0d, t0, tsd, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT5.grad();
  check_yT(yT5);
  check_t0(t0);

  var yT6 = stan::math::ode_adams(stan::test::ayt(), y0d, t0, tsd, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT6.grad();
  check_yT(yT6);
  check_t0(t0);
  ...
  var yT7 = stan::math::ode_adams(stan::test::ayt(), y0d, t0, ts, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT7.grad();
  check_yT(yT7);
  check_t0(t0);
  ...
  var yT8 = stan::math::ode_adams(stan::test::ayt(), y0d, t0, ts, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT8.grad();
  check_yT(yT8);
  check_t0(t0);
  ...
  var yT9 = stan::math::ode_adams(stan::test::ayt(), y0, t0d, tsd, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT9.grad();
  check_yT(yT9);
  check_y0(y0);

  var yT10 = stan::math::ode_adams(stan::test::ayt(), y0, t0d, tsd, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT10.grad();
  check_yT(yT10);
  check_y0(y0);
  ...
  var yT11 = stan::math::ode_adams(stan::test::ayt(), y0, t0d, ts, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT11.grad();
  check_yT(yT11);
  check_y0(y0);
  ...
  var yT12 = stan::math::ode_adams(stan::test::ayt(), y0, t0d, ts, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT12.grad();
  check_yT(yT12);
  check_y0(y0);
  ...
  var yT13 = stan::math::ode_adams(stan::test::ayt(), y0, t0, tsd, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT13.grad();
  check_yT(yT13);
  check_y0(y0);
  ...
  var yT14 = stan::math::ode_adams(stan::test::ayt(), y0, t0, tsd, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT14.grad();
  check_yT(yT14);
  check_y0(y0);
  ...
  var yT15 = stan::math::ode_adams(stan::test::ayt(), y0, t0, ts, nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT15.grad();
  check_yT(yT15);
  check_y0(y0);
  ...
  var yT16 = stan::math::ode_adams(stan::test::ayt(), y0, t0, ts, nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT16.grad();
  check_yT(yT16);
  check_y0(y0);
