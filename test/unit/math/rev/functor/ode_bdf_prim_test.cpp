...
struct CosArg1 {
  ...
  inline std::vector<stan::return_type_t<T1, T_Args...>> operator()(
      const T0& t, const std::vector<T1>& y, const T_Args&... a,
...
struct Cos2Arg {
  ...
  inline std::vector<typename stan::return_type<T1, T2, T3>::type> operator()(
      const T0& t, const std::vector<T1>& y, const T2& a, const T3& b,
      std::ostream* msgs) const {
...
TEST(StanMathOde_ode_bdf, t0) {
  ...
  std::vector<std::vector<var>> output = stan::math::ode_bdf(
...
TEST(StanMathOde_ode_bdf, scalar_arg) {
  ...
  var output = stan::math::ode_bdf(CosArg1(), y0, t0, ts, 1e-8, 1e-10, 1e6,
                                   nullptr, a)[0][0];
...
TEST(StanMathOde_ode_bdf, scalar_std_vector_args) {
  ...
  var output = stan::math::ode_bdf(Cos2Arg(), y0, t0, ts, 1e-8, 1e-10, 1e6,
                                   nullptr, a0, a1)[0][0];
