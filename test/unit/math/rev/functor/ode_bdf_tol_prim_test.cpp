...
TEST(ode_bdf_tol_prim, y0_errors) {
  ...
  EXPECT_NO_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts,
                                          1e-10, 1e-10, 1e6, nullptr, a));

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0inf, t0, ts,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0NaN, t0, ts,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0_empty, t0, ts,
                                       1e-10, 1e-10, 1e6, nullptr, a),
...
TEST(ode_bdf_tol_prim, t0_errors) {
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0inf, ts,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0NaN, ts,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);
}
...
TEST(ode_bdf_tol_prim, ts_errors) {
  ...
  EXPECT_NO_THROW(out = stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0,
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts_empty,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::invalid_argument);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts_early,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);

  EXPECT_THROW(
      stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts_decreasing,
                              1e-10, 1e-10, 1e6, nullptr, a),
      std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, tsinf,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, tsNaN,
                                       1e-10, 1e-10, 1e6, nullptr, a),
               std::domain_error);
}
...
TEST(ode_bdf_tol_prim, one_arg_errors) {
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, ainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, aNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, vainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, vaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, eainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, eaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, vvainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, vvaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, veainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, veaNaN),
               std::domain_error);
}
...
TEST(ode_bdf_tol_prim, two_arg_errors) {
  ...
  EXPECT_NO_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts,
                                          1e-10, 1e-10, 1e6, nullptr, a, a));

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, ainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, aNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, vainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, vaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, eainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, eaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, vvainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, vvaNaN),
               std::domain_error);
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, veainf),
               std::domain_error);

  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-10,
                                       1e-10, 1e6, nullptr, a, veaNaN),
               std::domain_error);
}
...
TEST(ode_bdf_tol_prim, rtol_errors) {
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts,
...
TEST(ode_bdf_tol_prim, max_num_steps_errors) {
  ...
  EXPECT_THROW(
      stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts, 1e-6, 1e-6,
...
TEST(ode_bdf_tol_prim, rhs_wrong_size_errors) {
  ...
  EXPECT_THROW(stan::math::ode_bdf_tol(stan::test::CosArgWrongSize(), y0, t0,
...
TEST(ode_bdf_tol_prim, error_name) {
  ...
  EXPECT_THROW_MSG(stan::math::ode_bdf_tol(stan::test::CosArg1(), y0, t0, ts,
