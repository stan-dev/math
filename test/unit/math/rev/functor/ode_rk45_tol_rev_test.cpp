...
TEST(StanMathOde_ode_rk45_tol, int_t0) {
  ...
  std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1>> output
      = stan::math::ode_rk45_tol(stan::test::CosArg1(), y0, t0, ts, 1e-10, 1e-10, 1e6,
                                 nullptr, a);
...
TEST(StanMathOde_ode_rk45_tol, scalar_arg) {
  ...
  var output = stan::math::ode_rk45_tol(stan::test::CosArg1(), y0, t0, ts, 1e-8, 1e-10, 1e6,
                                        nullptr, a)[0][0];
...
TEST(StanMathOde_ode_rk45_tol, scalar_std_vector_args) {
  ...
  var output = stan::math::ode_rk45_tol(stan::test::Cos2Arg(), y0, t0, ts, 1e-8, 1e-10, 1e6,
                                        nullptr, a0, a1)[0][0];
...
TEST(StanMathOde_ode_rk45_tol, arg_combos_test) {
  ...
  double yT1 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0d, tsd, 1e-10, 1e-10, 1e6,
                                        nullptr, ad)[0](0);
  check_yT(yT1);

  var yT2 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0d, tsd, 1e-10, 1e-10, 1e6,
                                     nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT2.grad();
  check_yT(yT2);
  ...
  var yT3 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0d, ts, 1e-10, 1e-10, 1e6,
                                     nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT3.grad();
  check_yT(yT3);
  ...
  var yT4 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0d, ts, 1e-10, 1e-10, 1e6,
                                     nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT4.grad();
  check_yT(yT4);
  ...
  var yT5 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0, tsd, 1e-10, 1e-10, 1e6,
                                     nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT5.grad();
  check_yT(yT5);
  ...
  var yT6 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0, tsd, 1e-10, 1e-10, 1e6,
                                     nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT6.grad();
  check_yT(yT6);
  ...
  var yT7 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0, ts, 1e-10, 1e-10, 1e6,
                                     nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT7.grad();
  check_yT(yT7);
  ...
  var yT8 = stan::math::ode_rk45_tol(stan::test::ayt(), y0d, t0, ts, 1e-10, 1e-10, 1e6,
                                     nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT8.grad();
  check_yT(yT8);
  ...
  var yT9 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0d, tsd, 1e-10, 1e-10, 1e6,
                                     nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT9.grad();
  check_yT(yT9);
  ...
  var yT10 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0d, tsd, 1e-10, 1e-10, 1e6,
                                      nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT10.grad();
  check_yT(yT10);
  ...
  var yT11 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0d, ts, 1e-10, 1e-10, 1e6,
                                      nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT11.grad();
  check_yT(yT11);
  ...
  var yT12 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0d, ts, 1e-10, 1e-10, 1e6,
                                      nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT12.grad();
  check_yT(yT12);
  ...
  var yT13 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0, tsd, 1e-10, 1e-10, 1e6,
                                      nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT13.grad();
  check_yT(yT13);
  ...
  var yT14 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0, tsd, 1e-10, 1e-10, 1e6,
                                      nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT14.grad();
  check_yT(yT14);
  ...
  var yT15 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0, ts, 1e-10, 1e-10, 1e6,
                                      nullptr, ad)[0](0);
  stan::math::set_zero_all_adjoints();
  yT15.grad();
  check_yT(yT15);
  ...
  var yT16 = stan::math::ode_rk45_tol(stan::test::ayt(), y0, t0, ts, 1e-10, 1e-10, 1e6,
                                      nullptr, a)[0](0);
  stan::math::set_zero_all_adjoints();
  yT16.grad();
  check_yT(yT16);
