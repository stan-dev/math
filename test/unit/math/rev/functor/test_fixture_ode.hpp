...
// template<typename ode_solver_t>
struct OdeTestProblem {
  virtual void test_good() {
    throw std::runtime_error("test_good() not implemented");    
  }

  virtual void test_bad() {
    throw std::runtime_error("test_bad() not implemented");    
  }

  virtual void apply_solver() {
    throw std::runtime_error("apply_solver() not implemented");    
  }

  virtual void apply_solver_tol() {
    throw std::runtime_error("apply_solver_tol() not implemented");    
  }

  virtual void test_value() {
    throw std::runtime_error("test_value() not implemented");        
  }
};
...
struct ODETestFixture : public ::testing::Test {
  auto apply_solver() {
    return static_cast<ode_problem_type*>(this)->apply_solver(); 
  }

  auto apply_solver_tol() {
    return static_cast<ode_problem_type*>(this)->apply_solver_tol(); 
  }
};
