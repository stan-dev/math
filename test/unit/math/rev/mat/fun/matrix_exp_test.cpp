...
TEST(MathMatrixRevMat, matrix_exp_1x1) {
...
TEST(MathMatrixRevMat, matrix_exp_2x2_2) {
...
TEST(MathMatrixRevMat, matrix_exp_3x3) {
  using stan::math::matrix_v;
...
TEST(MathMatrixRevMat, matrix_exp_exceptions) {
