...
TEST(AgradRevMatrix, promote_double_to_T_int) {
  int x = 3;
  auto y = stan::math::promote_double_to_T<stan::math::var>(std::make_tuple(x));
  EXPECT_EQ(0, std::tuple_size<decltype(y)>::value);
  EXPECT_TRUE((std::is_same<std::tuple<>, decltype(y)>::value));
}

TEST(AgradRevMatrix, promote_double_to_T_double) {
  double x = 3.0;
  auto y = stan::math::promote_double_to_T<stan::math::var>(std::make_tuple(x));
...
TEST(AgradRevMatrix, promote_double_to_T_mix) {
  auto y1 = stan::math::promote_double_to_T<stan::math::var>(
      std::make_tuple(1.0, 2, 3.0));
  auto y2 = stan::math::promote_double_to_T<stan::math::var>(
...
TEST(AgradRevMatrix, promote_double_to_T_std_vector_int) {
  std::vector<int> x(3);
  auto y = stan::math::promote_double_to_T<stan::math::var>(std::make_tuple(x));
...
TEST(AgradRevMatrix, promote_double_to_T_std_vector_double) {
...
TEST(AgradRevMatrix, promote_double_to_T_std_vector_mix) {
...
TEST(AgradRevMatrix, promote_double_to_T_VectorXf) {
  Eigen::VectorXf x(1);
  x << 3.0;
  auto y = stan::math::promote_double_to_T<stan::math::var>(std::make_tuple(x));
  EXPECT_EQ(0, std::tuple_size<decltype(y)>::value);
...
TEST(AgradRevMatrix, promote_double_to_T_RowVectorXf) {
...
TEST(AgradRevMatrix, promote_double_to_T_MatrixXf) {
...
TEST(AgradRevMatrix, promote_double_to_T_VectorXd) {
  Eigen::VectorXd x(1);
  x << 3.0;
  auto y = stan::math::promote_double_to_T<stan::math::var>(std::make_tuple(x));
  EXPECT_EQ(1, std::tuple_size<decltype(y)>::value);
...
TEST(AgradRevMatrix, promote_double_to_T_RowVectorXd) {
...
TEST(AgradRevMatrix, promote_double_to_T_MatrixXd) {
...
TEST(AgradRevMatrix, promote_double_to_T_Eigen_Mix) {
  Eigen::VectorXf x0(1);
  ...
  auto y = stan::math::promote_double_to_T<stan::math::var>(
