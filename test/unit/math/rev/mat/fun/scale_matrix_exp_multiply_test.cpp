...
inline void test_scale_matrix_exp_multiply_dv() {
  ...
  // matrix_exp_multiply
  const double t = 1.0;
  Eigen::Matrix<var, N, M> res_dv = scale_matrix_exp_multiply(t, A, Bv);
...
inline void test_scale_matrix_exp_multiply_vd() {
  ...
  // matrix_exp_multiply
  const double t = 1.0;
  Eigen::Matrix<var, N, M> res_vd = scale_matrix_exp_multiply(t, Av, B);
...
inline void test_scale_matrix_exp_multiply_vv() {
  ...
  // matrix_exp_multiply
  const double t = 1.0;
  Eigen::Matrix<var, N, M> res_vv = scale_matrix_exp_multiply(t, Av, Bv);
...
TEST(MathMatrix, scale_matrix_exp_multiply_vv) {
  ...
  test_scale_matrix_exp_multiply_vv<10, 2>();
}

// TEST(MathMatrix, scale_matrix_exp_multiply_clock) {
