...
TEST_F(StanMathRevOdeCVode, cvodes_integrator_dv) {
  ...
  */
  ...
  cvodes_integrator<harm_osc_ode_fun>
    integrator(harm_ode, y0, t0, false, true, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, decouple_ode_states_dv) {
  using stan::math::cvodes_integrator;
  using stan::math::var;
  ...
  stan::math::ode_model<mock_ode_functor> mock_ode(mock_ode_functor(), theta_dbl, x, x_int, &msgs);
  
  cvodes_integrator<mock_ode_functor>
    integrator(mock_ode, y0, t0, false, true, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, initial_state_dv) {
  ...
  stan::math::ode_model<mock_ode_functor> mock_ode(mock_ode_functor(), theta, x, x_int, &msgs);
  
  cvodes_integrator<mock_ode_functor>
    integrator_dv(mock_ode, y0_d, t0, false, true, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, cvodes_integrator_vd) {
  ...
  cvodes_integrator<harm_osc_ode_fun>
    integrator(harm_ode, y0_d, t0, true, false, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, decouple_ode_states_vd) {
  using stan::math::cvodes_integrator;
  using stan::math::var;
  ...
  cvodes_integrator<mock_ode_functor>
    integrator(mock_ode, y0_d, t0, true, false, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, initial_state_vd) {
  ...
  cvodes_integrator<mock_ode_functor>
    integrator_vd(mock_ode, y0_d, t0, true, false, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, cvodes_integrator_vv) {
  ...
  stan::math::ode_model<harm_osc_ode_fun> harm_ode(harm_osc_ode_fun(), theta_d, x, x_int, &msgs);

  cvodes_integrator<harm_osc_ode_fun>
    integrator(harm_ode, y0_d, t0, true, true, 1e-8, 1e-10, 1e6, 1);
...
TEST_F(StanMathRevOdeCVode, decouple_ode_states_vv) {
  using stan::math::cvodes_integrator;
...
TEST_F(StanMathRevOdeCVode, initial_state_vv) {
  ...
  cvodes_integrator<mock_ode_functor>
    integrator_vv(mock_ode, y0_d, t0, true, true, 1e-8, 1e-10, 1e6, 1);
