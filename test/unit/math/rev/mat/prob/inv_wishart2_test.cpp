...
TEST(InvWishart, check_varis_on_stack) {
  ...
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(to_var(W),
                                                                to_var(nu),
                                                                to_var(S)));
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(to_var(W),
                                                                to_var(nu),
  ...
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(to_var(W),
                                                                nu, S));
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(W, to_var(nu),
                                                                to_var(S)));
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(W, to_var(nu),
                                                                S));
  test::check_varis_on_stack(stan::math::inv_wishart_log<false>(W, nu,
                                                                to_var(S)));

  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(to_var(W),
                                                               to_var(nu),
                                                               to_var(S)));
  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(to_var(W),
                                                               to_var(nu),
  ...
  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(to_var(W),
                                                               nu, S));
  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(W, to_var(nu),
                                                               to_var(S)));
  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(W, to_var(nu),
                                                               S));
  test::check_varis_on_stack(stan::math::inv_wishart_log<true>(W, nu,
                                                               to_var(S)));
}
