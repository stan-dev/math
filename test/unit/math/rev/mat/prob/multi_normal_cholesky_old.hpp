...
typename return_type<T_y, T_loc, T_covar>::type multi_normal_cholesky_old_lpdf(
...
multi_normal_cholesky_old_lpdf(const T_y& y, const T_loc& mu,
                               const T_covar& L) {
  return multi_normal_cholesky_old_lpdf<false>(y, mu, L);
}
