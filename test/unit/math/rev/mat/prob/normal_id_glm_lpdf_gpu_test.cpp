...
TEST(ProbDistributionsNormalIdGLM, error_checking) {
  ...
  EXPECT_NO_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta, sigma));

  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_size_cl, x_cl, alpha, beta, sigma), std::invalid_argument);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_size1_cl, alpha, beta, sigma), std::invalid_argument);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_size2_cl, alpha, beta, sigma), std::invalid_argument);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha_size, beta, sigma), std::invalid_argument);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta_size, sigma), std::invalid_argument);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta, sigma_size), std::invalid_argument);

  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_value_cl, x_cl, alpha, beta, sigma), std::domain_error);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_value_cl, alpha, beta, sigma), std::domain_error);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha_value, beta, sigma), std::domain_error);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta_value, sigma), std::domain_error);
  EXPECT_THROW(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta, sigma_value), std::domain_error);
}
...
TEST(ProbDistributionsNormalIdGLM, gpu_matches_cpu_small_simple) {
  ...
  EXPECT_FLOAT_EQ(stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha, beta, sigma),
                  stan::math::normal_id_glm_lpdf(y, x, alpha, beta, sigma));
  EXPECT_FLOAT_EQ(stan::math::normal_id_glm_lpdf<true>(y_cl, x_cl, alpha, beta, sigma),
  ...
  var res1 = stan::math::normal_id_glm_lpdf(y_cl, x_cl, alpha_var1, beta_var1, sigma_var1);
  var res2 = stan::math::normal_id_glm_lpdf(y, x, alpha_var2, beta_var2, sigma_var2);
...
TEST(ProbDistributionsNormalIdGLM, gpu_matches_cpu_big) {
  ...
  Matrix<double, Dynamic, Dynamic> x = Matrix<double, Dynamic, Dynamic>::Random(N, M);
  ...
  Matrix<double, Dynamic, 1> sigma = Array<double, Dynamic, 1>::Random(N, 1) + 1.1;
  ...
  var res1 = stan::math::normal_id_glm_lpdf<true>(y_cl, x_cl, alpha_var1, beta_var1, sigma_var1);
  var res2 = stan::math::normal_id_glm_lpdf<true>(y, x, alpha_var2, beta_var2, sigma_var2);
