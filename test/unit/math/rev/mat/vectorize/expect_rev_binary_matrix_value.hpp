...
void expect_rev_binary_matrix_value(Eigen::Matrix<double, R, C> template_m) {
  using stan::math::var;
  using std::vector;
  ...
  var_template_m
      = build_template_matrix(var_template_m, F::valid_inputs1().size(), 3);
  ...
  expect_rev_binary_std_vector_matrix_std_vector_matrix_eq<F>(var_template_m,
                                                              d_template_m);
  expect_rev_binary_std_vector_matrix_std_vector_matrix_eq<F>(d_template_m,
                                                              var_template_m);
  expect_rev_binary_std_vector_matrix_std_vector_matrix_eq<F>(var_template_m,
                                                              var_template_m);
}
