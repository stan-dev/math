...
TEST(MetaTraitsRevArr, VectorBuilder_false_true) {
  ...
  VectorBuilder<false, double, std::vector<var> >
...
TEST(MetaTraitsRevArr, VectorBuilder_true_true) {
  ...
  VectorBuilder<true, double, std::vector<var> >
    dvv2(stan::math::size(a_std_vector));
  dvv2[0] = 0.0;
  dvv2[1] = 1.0;
  dvv2[2] = 2.0;
...
TEST(MetaTraitsRevMat, VectorBuilder_true_true) {
  ...
  VectorBuilder<true, double, Matrix<var, Dynamic, 1> >
    dvv3(stan::math::size(a_vector));
  dvv3[0] = 0.0;
  dvv3[1] = 1.0;
  dvv3[2] = 2.0;
