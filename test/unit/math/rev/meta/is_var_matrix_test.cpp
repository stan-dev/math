...
TEST(MetaTraitsRevScal, is_var_col_vector_test) {
  ...
  using stan::math::vari;
  using stan::math::vari_value;
  EXPECT_TRUE((is_var_col_vector<var_value<Eigen::Matrix<double, -1, 1>>>::value));
  EXPECT_FALSE((is_var_col_vector<var_value<Eigen::Matrix<double, 1, -1>>>::value));
  EXPECT_FALSE((is_var_col_vector<var_value<Eigen::Matrix<double, -1, -1>>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var, -1, 1>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var_value<float>, -1, 1>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var, -1, -1>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var, 1, -1>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var_value<float>, -1, -1>>::value));
  EXPECT_FALSE((is_var_col_vector<Eigen::Matrix<var_value<float>, 1, -1>>::value));
  EXPECT_FALSE((is_var_col_vector<var_value<Eigen::SparseMatrix<double>>>::value));
...
TEST(MetaTraitsRevScal, is_var_row_vector_test) {
  ...
  using stan::math::vari;
  using stan::math::vari_value;
  EXPECT_FALSE((is_var_row_vector<var_value<Eigen::Matrix<double, -1, 1>>>::value));
  EXPECT_TRUE((is_var_row_vector<var_value<Eigen::Matrix<double, 1, -1>>>::value));
  EXPECT_FALSE((is_var_row_vector<var_value<Eigen::Matrix<double, -1, -1>>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var, 1, -1>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var_value<float>, 1, -1>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var, -1, 1>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var, -1, -1>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var_value<float>, -1, 1>>::value));
  EXPECT_FALSE((is_var_row_vector<Eigen::Matrix<var_value<float>, -1, -1>>::value));
  EXPECT_FALSE((is_var_row_vector<var_value<Eigen::SparseMatrix<double>>>::value));
...
TEST(MetaTraitsRevScal, is_var_vector_test) {
  ...
  EXPECT_TRUE((is_var_vector<var_value<Eigen::Matrix<double, 1, -1>>>::value));
  EXPECT_FALSE((is_var_vector<var_value<Eigen::Matrix<double, -1, -1>>>::value));
