...
inline void expect_propto_wishart_cholesky_lpdf(T_y L_Y1, T_dof nu1, T_scale L_S1,
  ...
  expect_eq_diffs(stan::math::wishart_cholesky_lpdf<false>(L_Y1, nu1, L_S1),
                  ...
                  stan::math::wishart_cholesky_lpdf<true>(L_Y2, nu2, L_S2),
                  message);
}
...
TEST_F(AgradDistributionsWishartCholesky, Propto) {
  ...
  expect_propto_wishart_cholesky_lpdf(to_var(L_Y1), to_var(nu1), to_var(L_S1),
...
TEST_F(AgradDistributionsWishartCholesky, ProptoY) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(to_var(L_Y1), nu1, L_S1, to_var(L_Y2),
                                      nu1, L_S1, "var: L_Y");
...
TEST_F(AgradDistributionsWishartCholesky, ProptoYNu) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(to_var(L_Y1), to_var(nu1), L_S1,
...
TEST_F(AgradDistributionsWishartCholesky, ProptoYLSigma) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(to_var(L_Y1), nu1, to_var(L_S1),
...
TEST_F(AgradDistributionsWishartCholesky, ProptoNu) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(L_Y1, to_var(nu1), L_S1, L_Y1,
...
TEST_F(AgradDistributionsWishartCholesky, ProptoNuL_S) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(L_Y1, to_var(nu1), to_var(L_S1), L_Y1,
...
TEST_F(AgradDistributionsWishartCholesky, ProptoL_S) {
  using stan::math::to_var;
  expect_propto_wishart_cholesky_lpdf(L_Y1, nu1, to_var(L_S1), L_Y1, nu1,
                                      to_var(L_S2), "var: L_S");
...
TEST(WishartCholesky, check_varis_on_stack) {
  ...
  test::check_varis_on_stack(stan::math::wishart_cholesky_lpdf<false>(
  ...
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<false>(to_var(L_Y), nu, L_S));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<false>(L_Y, to_var(nu), to_var(L_S)));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<false>(L_Y, to_var(nu), L_S));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<false>(L_Y, nu, to_var(L_S)));

  test::check_varis_on_stack(stan::math::wishart_cholesky_lpdf<true>(
      to_var(L_Y), to_var(nu), to_var(L_S)));
  test::check_varis_on_stack(
  ...
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<true>(to_var(L_Y), nu, L_S));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<true>(L_Y, to_var(nu), to_var(L_S)));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<true>(L_Y, to_var(nu), L_S));
  test::check_varis_on_stack(
      stan::math::wishart_cholesky_lpdf<true>(L_Y, nu, to_var(L_S)));
