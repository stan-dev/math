...
TEST(MathMeta, is_var_or_arithmetic_simple) {
  ...
  bool temp
      = is_var_or_arithmetic<stan::math::var, std::vector<stan::math::var>, stan::math::var, stan::math::var, stan::math::var, stan::math::var>::value;
  EXPECT_TRUE(temp);
    temp
      = is_var_or_arithmetic<std::vector<stan::math::var>, stan::math::var, std::vector<stan::math::var&>>::value;
  EXPECT_FALSE(temp);
