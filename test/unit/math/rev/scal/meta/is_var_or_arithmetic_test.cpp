...
TEST(MathMeta, is_var_or_arithmetic_simple) {
  ...
  bool temp
      = is_var_or_arithmetic<stan::math::var, stan::math::var, stan::math::var, stan::math::var, stan::math::var, stan::math::var>::value;
  EXPECT_TRUE(temp);
    temp
      = is_var_or_arithmetic<stan::math::var, stan::math::var, stan::math::var&>::value;
  EXPECT_FALSE(temp);
