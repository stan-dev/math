...
TEST(requires, not_all_var_test) {
  using stan::math::var;
  EXPECT_TRUE((require_not_all_var_tester<var, std::string, double>::value));
  EXPECT_TRUE((require_not_all_var_tester<double, var, double>::value));
  EXPECT_TRUE((require_not_all_var_tester<int, int, var>::value));
  EXPECT_FALSE((require_not_all_var_tester<var, var, var>::value));
}
